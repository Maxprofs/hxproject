...
function initMap() {
    ...
    var a = new BMap.Point(104.072331, 30.662284);
        ...
        onSearchComplete: function(w) {
            ...
            if (b.getStatus() == BMAP_STATUS_SUCCESS) {
                ...
                if (l == 1 && typeof w.getPoi(0).city == "undefined") {
                    var f = 4;
                    if (b && b.Fa && b.Fa.content && b.Fa.content.length == 2) {
                        f = b.Fa.content[1];
                        p = '<b style="font-size:14px;">' + w.keyword + "</b>"
                    } else {
                        if (b && b.Fa && b.Fa.current_city && b.Fa.current_city.name && typeof b.Fa.current_city.level != "undefined") {
                            f = b.Fa.current_city.level;
                            if (b.Fa.current_city.name == "全国") {
                                f = 4
                            }
                            p = '<span style="color:#00c">已切换至' + b.Fa.current_city.name + "</span>";
                    ...
                    var o = _res_sta_i = b.Fa.content.length - k;
                    p = '<ul class="local_s">';
                    for (var z = 0; z < l; z++) {
                        var h = w.getPoi(z);
                        var q = h.title;
