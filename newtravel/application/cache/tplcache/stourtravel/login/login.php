...
<head>
    <meta charset="utf-8">
    <title>笛卡CMS<?php echo $coreVersion;?>-网站登陆</title>
...
<div class="login-box">
    <div class="head-box">
        ...
        <a href="http://www.deccatech.cn" target="_blank"><img class="fl" src="<?php echo $GLOBALS['cfg_public_url'];?>images/gw-blank-ico.png" /></a>
    </div>
