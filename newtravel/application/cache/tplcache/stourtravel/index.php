    ...
    <div class="top-page" >
        ...
        <div class="top-operate">
            <ul class="fl">
                ...
                <li class="manager">
                    <a href="http://www.deccatech.cn/help" target="_blank">帮助中心</a>
                    <div class="top-help-list">
                        <a class="ico_1" target="_blank" href="http://www.deccatech.cn/peixun/yingxiao-19">使用帮助</a>
                        <a class="ico_2" target="_blank" href="javascript:;">视频教程</a>
                        <a class="ico_3" target="_blank" href="http://www.deccatech.cn/Member/login">意见反馈</a>
                        <a class="ico_4"  target="_blank" href="http://www.deccatech.cn">笛卡官网</a>
                        <a class="ico_5" target="_blank" href="http://www.deccatech.cn/cms/jieshao">关于系统</a>
                    </div>
                </li>
