...
<head>
    <meta charset="utf-8">
    <title>12笛卡旅游CMS<?php echo $coreVersion;?></title>
    ...
    <div class="cms-content-box">
        ...
        <div class="copyright-content un_authorright_msg" style="display: none">
            <div class="copyright-block clearfix">
                ...
                <div class="gm-txt">请您购买正版系统，享受专业服务。<a class="now-gm-btn" href="http://www.deccatech.cn" target="_blank">立即购买</a></div>
            </div>
        </div>
        <!-- 管理员 -->
        <div class="cms-msg-box">
            ...
            <div class="txt-msg authorright_msg"  style="display: none">
                <div class="contact-btn">
                    ...
                    <a class="fk-btn" href="http://www.deccatech.cn/user/myfeedback/commitlist" target="_blank">工单反馈</a>
                    <a class="kf-btn" href="javascript:;">联系笛卡</a>
                </div>
            ...
            <div class="txt-msg un_authorright_msg" style="display: none">
                <div class="contact-btn">
                    <a class="lx-btn" href="http://www.deccatech.cn" target="_blank">笛卡官网</a>
...
><?php echo $sub['title'];?></a>
    ...
    <div class="kefu-box" style="display: none">
        ...
        <div class="kf-con-list">
            <div class="con-list-tit">感谢购买笛卡产品！您可以通过以下几个途径联系到笛卡。</div>
            <ul class="list-kf-name">
                <li>1、通过<a href="http://www.deccatech.cn/help/" target="_blank">官方帮助中心</a>自助查询需要的帮助内容。<span>（对于操作性等问题，请到帮助中心自助查询）</span></li>
                <li>2、通过<a href="http://www.deccatech.cn/user/myfeedback/commitlist" target="_blank">提交工单</a>反馈问题或建议。<span>（针对BUG性问题，我们会在24小时以内相应处理。建议性问题会进行评估排期后根据客户需求量进行选择开发）</span></li>
    ...
    <div class="remind-box" style="display: none">
        ...
        <div class="rem-con-list">
            <div class="txt">请及时绑定，以获得笛卡CMS终生免费升级服务<br>授权后您将获得：免费系统升级 短信通知功能 官方帮助系统 工单反馈系统 等更多增值服务</div>
            <div class="btn_box"><a href="javascript:;" class="btn_bind">立即绑定</a><a href="javascript:;"
                                                                                    class="btn_showkefu">咨询客服，获取授权</a></div>
            <div class="txt">笛卡CMS每周四更新，发布全新功能、全新页面以及安全修复等。让您的网站永不过时！</div>
        </div>
    </div>
</div>
<script>
