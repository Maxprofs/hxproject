...
<table class="content-tab">
    <tr>
        ...
        <td valign="top" class="content-rt-td">
            <form id="configfrm">
                <div class="w-set-tit bom-arrow"><span class="on"><s></s>笛卡CMS授权绑定</span> <a href="javascript:;" class="refresh-btn" onclick="window.location.reload()">刷新</a></div>
                <div class="empower_con">
                    <dl class="ec_list">
                        ...
                        <dd>
                            ...
                            <p>注：在www.deccatech.cn会员中心的用户ID，即是系统的授权ID，请正确填写，否则会影响系统功能的使用，如升级功能；</p>
                        </dd>
                    </dl>
                    <div class="opn-btn">
