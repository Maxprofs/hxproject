                                ...
                                <li class="list_dl">
                                    ...
                                    <div class="item-bd pr-10">
                                        ...
                                        <div  class="clearfix mt-10">
                                            <a class="label-module-cur-item mr-5 short-cut" data="{#WEBNAME#}">网站名称</a>
                                            <a class="label-module-cur-item mr-5 short-cut" data="{#FREEPHONE#}">客户号码</a>
                                            <a class="label-module-cur-item mr-5 short-cut" data="{#MEMBERNAME#}">会员名称</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
