...
<body>
    ...
    <table class="content-tab">
                    ...
                    <form id="frm" name="frm" onsubmit="return false;">
                        <div id="kefu-manage" class="kefu_content">
                            ...
                            <div class="msg-bar pl-10">
                                <span  data-rel="basic" class="on">联系方式</span>
                                <span data-rel="tpl">客服样式</span>
                                <span data-rel="param">样式设置</span>
                            </div>
        ...
        该样式不支持样式位置、样式边距的设置</span></div>
                            ...
                            <div class="w-set-nr" style="display: none;"  id="panel_param">
                                <div class="product-add-div">
                                    <ul class="info-item-block">
                                        <li class="item_both item_set">
                                            <span class="item-hd">样式位置：</span>
