...
<head>
    <meta charset="utf-8">
    <title>提现审核管理-笛卡CMS{$coreVersion}</title>
...
<table class="content-tab" padding_strong=z2QzDt >
    <tr>
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        var html = "<a href='javascript:void(0);' title='查看' class='btn-link' onclick='javascript:modify(\"" + applyid + "\",\"" + usertype + "\");'>查看</a>";
                        return html;
