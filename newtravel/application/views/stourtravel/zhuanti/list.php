	   ...
	   columns:[
			   ...
			   
			   {
				   ...
				   renderer : function(value, metadata,record) {    
						   ...
						   return "<a href='javascript:;' class='btn-link' onclick=\"ST.Util.addTab('修改"+title+"','"+SITEURL+"zhuanti/edit/menuid/{$_GET['menuid']}/parentkey/sale/itemid/2/themeid/"+value+"')\">修改</a>";
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=7.1.201801.0808&DomainName=&ServerIP=unknown&SerialNumber=45422529" ></script>
