        ...
        window.product_grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                },
                {
                    ...
                    text: '<span class="grid_column_text">产品名称</span>'+ST.Util.getGridHelp('question_field_productname'),
                    width: '20%',
                ...
                },
                {
                    ...
                    menuDisabled:true,
                    renderer: function (value, metadata, record) {
                        var str=Ext.Date.format(new Date(value*1000), 'Y-m-d H:i:s');
