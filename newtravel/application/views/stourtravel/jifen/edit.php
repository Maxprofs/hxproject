...
<head>
    <meta charset="utf-8">
    <title background_left=PHJzDt >积分策略添加/修改</title>
                            ...
                            <li>
                                ...
                                <div class="item-bd {if $info['issystem']==1 && in_array('frequency_type',$info['disable_fields'])}disabled{/if}" id="frequency_type_con">
                                    ...
                                    <span {if in_array(2,$info['frequency_type_exclude'])}class="disabled"{/if}><label class="radio-label mr-30">
                                        ...
                                        <input type="text" class="input-text w80" name="frequency_2" value="{if $info['frequency_type']==2}{if $info['frequency']}{$info['frequency']}{else}1{/if}{/if}" />次
                                    </label></span>
                                    <span {if in_array(3,$info['frequency_type_exclude'])}class="disabled"{/if}>
                                        <label class="radio-label">
                                            ...
                                            <input type="text" class="input-text w80" name="frequency_3" value="{if $info['frequency_type']==3}{if $info['frequency']}{$info['frequency']}{else}1{/if}{/if}" />次
                                        </label>
                                    </span>
                                </div>
                            </li>
...
<script>
    ...
    function disableElements()
    {
        $(".disabled input").each(function(){
            ...
            {
                case 'text':
                    $(this).attr('readonly',true).css('background-color','rgb(235, 235, 228)');
                    break;
                default:
