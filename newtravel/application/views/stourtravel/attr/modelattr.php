            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer : function(value, metadata,record) {
                        ...
                        if(id.indexOf('add')==-1)
                        {
                            return "<span class='row-editable-sp'>"+value+"</span>"+"&nbsp;&nbsp;<font color='orange' margin_html=hIACXC >[id:"+id+"]</font>";
                        }
                        return value;
                    }
                },
                {
                    ...
                    renderer : function(value, metadata,record) {
                        ...
                        var html="<span class='select-box w150'><select class='select' onchange=\"updateField(this,"+id+",'webid',0,'select')\" onclick=\"stopDef(event)\">"
                ...
                },
                {
                    ...
                    renderer : function(value, metadata,record) {
                        ...
                        return '<a href="javascript:;" class="btn-link" onclick="attrSet('+id+','+{$typeid}+')">配置</a>'+front_view;
                    }
                }
            ],
            plugins: [
