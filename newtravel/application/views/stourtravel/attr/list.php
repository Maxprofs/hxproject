            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer : function(value, metadata,record) {
                        ...
                        if(!value)
                            value='';
                        return '<a href="javascript:;" class="btn-link" onclick="setDests('+id+','+typeid+')">设置</a>';
                ...
                },
                {
                    ...
                    renderer : function(value, metadata,record) {
                        ...
                        if(id.indexOf('add')!=-1 || pid=='0')
                            return '';
                        return '<a href="javascript:;" title="配置" class="btn-link" onclick="attrSet('+id+','+{$typeid}+')">配置</a>';
                    }
                }
            ],
            plugins: [
