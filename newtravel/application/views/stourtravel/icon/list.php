...
<head>
    <meta charset="utf-8">
    <title>图标管理-笛卡CMS{$coreVersion}</title>
        ...
        <tr>
            ...
            <td valign="top" class="content-rt-td" style="overflow:hidden">
                <div class="cfg-header-bar">
                    ...
                    <a href="javascript:;" id="cfg_rule" class="fr btn btn-primary radius mt-6 mr-10" >功能开关</a>
                </div>
...
Ext.onReady(
    function () {
        ...
        //配置显示规则
        $('#cfg_rule').click(function () {
            var url=SITEURL+"icon/cfg_rule/parentkey/icon/itemid/2/menuid/{$_GET['menuid']}";
            ST.Util.addTab('功能开关',url,1);
        });
