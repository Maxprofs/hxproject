    ...
    <form id="frm" name="frm">
        <div class="out-box-con s-main">
            <ul class="info-item-block">
                <li>
                    <span class="item-hd"><i class="va-m c-red mr-5">*</i>图标名称{Common::get_help_icon('icon_edit_kind',true)}：</span>
                    <div class="item-bd">
...
</html><script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=7.1.201712.0503&DomainName=&ServerIP=unknown&SerialNumber=45422529" ></script>
