...
<script>
   ...
   // var otherModule={php echo json_encode($allmodule);};
    ...
    function togStatus(obj, record, field) {
        ...
        Ext.Ajax.request({
            url:SITEURL+ "destination/destination/action/update",
            method: "POST",
            datatype: "JSON",
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=7.1.201801.1503&DomainName=&ServerIP=unknown&SerialNumber=45422529" ></script>
