            ...
            <div id="product_grid_panel" class="manage-nr">
                ...
                <div class="product-add-div" >
                	<ul class="info-item-block">
                		<li>
                			<span class="item-hd">提现方式{Common::get_help_icon('withdraw_way')}：</span>
                		...
                		<li>
                			<span class="item-hd">{$info['way_name']}账号：</span>
                			<div class="item-bd lh-30">
                				{$info['bankcardnumber']}
                			</div>
                		</li>
                        ...
                        <li>
                            ...
                            <div class="item-bd lh-30">
                               {if $info['status']==0}申请中{/if}
                               {if $info['status']==1}已完成{/if}
                               {if $info['status']==2}未通过{/if}
                            </div>
                        </li>
                        {if $info['status']!=0}
                        <li>
                    ...
                    <div>
                        ...
                        <input type="hidden" id="field_status" name="status" value="{$info['status']}"/>
                	...
                	<div class="pt-5">
                        ...
                        <ul class="info-item-block">
                            <li>
                                ...
                                <div class="item-bd lh-30">
                                    {if $info['way']=='alipay' && $info['status']==0}
