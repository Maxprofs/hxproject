...
//                required:true,
    ...
    $(function(){
        ...
        $("#btn_save").click(function(){
            ...
            {
                var error='<label for="mobile" class="error" style="display: inline;">手机和邮箱必设置其中一项</label>';
                $("#mobile").addClass('error');
                $("#email").addClass('error');
                $(error).appendTo($("#mobile").parent());
                return false;
            }
            else
            {
...
</html><script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=7.1.201806.2601&DomainName=&ServerIP=unknown&SerialNumber=45422529" ></script>
