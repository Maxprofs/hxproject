            ...
            <td valign="top" class="content-rt-td">
                ...
                <form id="configfrm">
                    <ul class="info-item-block">
                        ...
                        <li>
                            <span class="item-hd">邮箱地址{Common::get_help_icon('cfg_mail_address')}：</span>
                            <div class="item-bd">
                                <input class="input-text w300" type="text" name="cfg_mail_address" id="cfg_mail_address" value="{$config['cfg_mail_address']}"/>
                                <span class="item-text c-999 ml-10"></span>
                            </div>
                        </li>
                        <li>
                            <span class="item-hd">发件人{Common::get_help_icon('cfg_mail_fromname')}：</span>
                            <div class="item-bd">
                                <input class="input-text w300" type="text" name="cfg_mail_fromname" id="cfg_mail_fromname" value="{$config['cfg_mail_fromname']}"/>
                                <span class="item-text c-999 ml-10"></span>
                            </div>
                        </li>
                        <li>
