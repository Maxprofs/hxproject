            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer : function(value, metadata,record) {
                           ...
                           return "<input type='checkbox' class='"+cls+"' "+is_checked+" onclick=\"updateField(this,'"+id+"','right',0,'checkbox','"+isparent+"')\" />";
                    }
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=7.1.201801.2602&DomainName=&ServerIP=unknown&SerialNumber=45422529" ></script>
