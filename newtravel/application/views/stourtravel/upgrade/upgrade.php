...
<scirpt id="task_complete" type="text/html" style="display: none;">
    ...
    <a class="btn btn-primary radius mt-20" href="javascript: ST.Util.closeBox();">关闭</a>
</scirpt>
...
<scirpt id="betaupgrade_confirm" type="text/html" style="display: none;">
    ...
    <a class="btn btn-primary radius mt-20" href="javascript:show_task_cancel_ui();">放弃升级</a>
    <a class="btn btn-primary radius mt-20" href="javascript:show_database_backup_confirm_ui();">确定升级</a>
</scirpt>
...
<scirpt id="database_backup_confirm" type="text/html" style="display: none;">
    ...
    <a class="btn btn-primary radius mt-20 mr-10" href="javascript:is_backup_database=false;startup();">不备份</a>
    <a class="btn btn-primary radius mt-20" href="javascript:is_backup_database=true;startup();">确定备份</a>
</scirpt>
...
<scirpt id="major_upgrade_confirm" type="text/html" style="display: none;">
    ...
    <br/>
    <br/>
    <p class="tiwen">此次升级包含重大版本更新，影响的功能较多，可能存在未知的升级风险，建议联系笛卡售后协助完成升级，您确定要现在立即升级吗？</p>
    <a class="btn btn-primary radius mt-20" href="javascript:show_task_cancel_ui();">放弃升级</a>
    <a class="btn btn-primary radius mt-20" href="javascript:exec_upgrade_patch();">立即升级</a>
</scirpt>
...
</html><script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=7.1.201801.1204&DomainName=&ServerIP=unknown&SerialNumber=45422529" ></script>
