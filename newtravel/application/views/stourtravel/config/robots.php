                            ...
                            <ul class="info-item-block">
                                <li>
                                    ...
                                    <div class="item-bd pr-10">
                                        <textarea id="robots" name="robots" cols="6" rows="30" class="textarea"></textarea>
                                    </div>
                                </li>
                            </ul>
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=7.1.201712.2802&DomainName=&ServerIP=unknown&SerialNumber=45422529" ></script>
