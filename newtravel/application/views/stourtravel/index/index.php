...
<head>
    <meta charset="utf-8">
    <title>{$configinfo['cfg_webname']}-笛卡CMS{$coreVersion}</title>
...
<div class="header-wrapper" id="header">
    ...
    <div class="header-logo">
        <div class="lg-area">
            {if $configinfo['cfg_backstage_logo']}
            <img src="{$configinfo['cfg_backstage_logo']}" />
            {else}
            <img src="{$GLOBALS['cfg_public_url']}images/version-pic.png" />
            {/if}
        </div>
    </div>
    <!-- logo -->
