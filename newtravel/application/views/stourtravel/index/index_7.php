...
<head>
    <meta charset="utf-8">
    <title>笛卡旅游CMS{$coreVersion}</title>
                ...
                <ul class="app-marketing-manage clearfix">
                    {loop Model_Menu_New::get_config_by_pid(7) $v}
                        <li class="item">
                            ...
                            {elseif $v['title']=='积分商城'}
                            <a class="data fl article_item" href="javascript:;" data-url="{$v['url']}" {if isset($v['alias_title'])}data-title="{$v['alias_title']}"{/if}>{$v['title']}</a>
                            <a href="javascript:;" class="num data_item hide" id="channel_order_unview_107" data-url="integral/admin/order/index/typeid/{$v['typeid']}/menuid/{$v['order_id']}" data-name="商城订单"></a>
                            {else}
                            <a class="data fl article_item" href="javascript:;" data-url="{$v['url']}" {if isset($v['alias_title'])}data-title="{$v['alias_title']}"{/if}>{$v['title']}</a>
                            {/if}
                            </span>
