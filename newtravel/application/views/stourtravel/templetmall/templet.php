...
<head>
    <meta charset="utf-8">
    <title>模板安装包-笛卡CMS{$coreVersion}</title>
    ...
    Ext.onReady(
        function () {
            ...
            window.product_store = Ext.create('Ext.data.Store', {
                ...
                fields: [
                   'id','name','status','appStatus','version','appStatusName','site_name','platform_name','page','from','update_ID','update_ProductCode','url'
                ],
            ...
            window.product_grid = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    ...
                    {
                        text: '当前版本' + ST.Util.getGridHelp('templetmall_my_templet_currentversion'),
                        width: '8%',
                        align: 'center',
                        border: 0,
                        dataIndex: 'version',
