...
class Controller_App extends Stourweb_Controller
{
    ...
    public function action_upgrade()
    {
        ...
        Common::sendInfo();
        $this->assign('version', '笛卡CMS' . $cVersion . $versiontype);
    ...
    public function action_other()
    {
        ...
        {
            case 'contract':
                $url = "http://www.deccatech.cn/Member";
                break;
            case 'moban':
                $url = "http://www.deccatech.cn/cms/moban";
                break;
            case 'app':
                $url = "http://www.deccatech.cn/app";
                break;
            case 'seo':
                $url = "http://www.deccatech.cn/peixun";
                break;
            case 'problem':
                $url = "http://www.deccatech.cn/cms/problem";
                break;
            ...
            else //子级
            {
                ...
                foreach ($list as $k => $v)
                {
                    ...
                    $list[$k][] = array(
                        'leaf' => true,
                        'id' => $node . 'add',
                        'kindname' => '<button class="btn btn-primary radius size-S" onclick="addSub(' . $list[$k]['id'] . ')">添加</button>',
                        'allowDrag' => false,
                        'allowDrop' => false,
                        'litpic' => 'add',
                        'displayorder' => 'add'
