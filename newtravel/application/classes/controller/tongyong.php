...
class Controller_Tongyong extends Stourweb_Controller
{
    ...
    * */
    ...
    public function action_ajax_save()
    {
        ...
        $model->bookcount = intval($_POST['bookcount']);
   ...
   * */
    ...
    public function saveBaoJia($productid, $suitid, $arr)
    {
        ...
        $basicprice = Arr::get($arr, 'basicprice') ? floatval(Arr::get($arr, 'basicprice')): 0;
        $profit = Arr::get($arr, 'profit') ? floatval(Arr::get($arr, 'profit')) : 0;
