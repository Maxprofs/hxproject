...
class Controller_Quickmenu extends Stourweb_Controller
{
    ...
    {
        $template=json_decode(file_get_contents('http://www.deccatech.cn/api/cms/template'));
        $app=json_decode(file_get_contents('http://www.deccatech.cn/api/cms/app'));
        $stourzx=json_decode(file_get_contents('http://www.deccatech.cn/api/cms/stourzx'));
