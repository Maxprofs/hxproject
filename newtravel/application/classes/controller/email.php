...
class Controller_Email extends Stourweb_Controller
{
    ...
    public function action_ajax_saveconfig()
    {
        ...
        $config_data['cfg_mail_address'] = Common::remove_xss(Arr::get($_POST, 'cfg_mail_address'));
        ...
        $config_data['cfg_mail_fromname'] = Common::remove_xss(Arr::get($_POST, 'cfg_mail_fromname'));
