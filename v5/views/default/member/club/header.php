<div class="header-info">
    <div class="wm-1200">
        <div class="login-info fl">
            您好，
            <a class="name">{if $member}{$member['nickname']}{else}游客{/if}</a>
            <a class="out" href="{Common::get_main_host()}/member/login{if $member}/loginout{/if}">{if $member}退出{else}去登录{/if}</a>
        </div>
