        ...
        <div class="blank-wrap">
            ...
            <div class="daily-tasks">
                <ul class="clearfix">
                    ...
                    {if Model_Jifen::check_policy_is_open(3, 'sys_write_notes')}
                    <li>
                        <a>
                    ...
                    {/if}
                    {if Model_Jifen::check_policy_is_open(8, 'sys_member_login')}
                    <li>
                        <a>
                    ...
                    {if Model_Jifen::check_policy_is_open(3, 'sys_write_jieban')}
                    <li>
                        <a>
                    ...
                    {/if}
                    {if Model_Jifen::check_policy_is_open(3 ,'sys_write_wenda')}
                    <li>
                        <a>
