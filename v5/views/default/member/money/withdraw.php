      ...
      <div class="st-main-page">
        ...
        <div class="user-cont-box">
            ...
            <div class="take-btn-bar">
                <a class="submit btn" href="javascript:;" {if $cash_available_num!=0}id="submit_btn"{else}style="background:#ccc;cursor: not-allowed;"{/if}>提交</a>
