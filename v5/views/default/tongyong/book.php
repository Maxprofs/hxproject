      ...
      <div class="st-main-page">
          ...
          <div class="product-msg">
            ...
            {if !empty($userInfo)}
                ...
                {else}
                {include 'tongyong/nologin_address'}
            {/if}
...
<script>
    ...
    $(function(){
        ...
        $("input[name=linktel],input[name=linkman]").focus(function(){
            old_address_name=$("input[name=linkman]").val();
            old_address_tel=$("input[name=linktel]").val();
        });
        $(".linkman-text").blur(function(){
            if(!$("#m_receiver").val()||old_address_name==$("#m_receiver").val())
            {
                $("#m_receiver").val($("input[name=linkman]").val());
            }
            if(!$("#m_phone").val()||old_address_tel==$("#m_phone").val())
            {
                $("#m_phone").val($("input[name=linktel]").val());
            }
        });
