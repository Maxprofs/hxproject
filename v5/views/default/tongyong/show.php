...
<meta charset="utf-8">
    ...
    {Common::js('jquery.min.js,base.js,common.js,delayLoading.min.js,SuperSlide.min.js,focus-slide.js,template.js')}
</head>
      ...
      <div class="st-main-page">
          ...
          <div class="lineshow-tw">
            ...
            <div class="cp-show-msg">
              ...
              <div class="sl">
                  <span>{__('销量')}：{$info['sellnum']}</span><s>|</s><span class="myd">{__('满意度')}：{$info['score']}</span><s>|</s><a href="#comment_target">{$info['commentnum']}条点评</a>
              </div>
              <dl class="tc">
                <dt>{__('产品类型')}：</dt>
