...
class Taglib_Ship
{
    private static $basefiled = 'a.id,a.shipid,a.webid,a.aid,a.title,a.price,a.price_date,a.litpic,a.startcity,a.kindlist,a.attrid,a.bookcount,a.storeprice,a.sellpoint,a.iconlist,a.satisfyscore,a.scheduleid,a.finaldestid';
    ...
    public static function query($param)
    {
        ...
        foreach ($list as &$v)
        {
            ...
            $v['shiptitle'] = self::get_shiptitle($v['shipid']);
    ...
    //获取游轮名称
    public static function get_shiptitle($shipid){

        $sql="select title from sline_ship where  id={$shipid}";
        $arr = DB::query(Database::SELECT, $sql)->execute()->as_array();
        $arr =$arr[0]['title'];
        return $arr;
    }
