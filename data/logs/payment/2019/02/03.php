...
2019-02-03 10:39:17 --- ERROR: Database_Exception [ 1064 ]: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '' at line 1 [ SELECT * FROM sline_model WHERE id= ] ~ MODPATH\database\classes\kohana\database\mysql.php [ 194 ]
2019-02-03 10:39:17 --- STRACE: Database_Exception [ 1064 ]: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '' at line 1 [ SELECT * FROM sline_model WHERE id= ] ~ MODPATH\database\classes\kohana\database\mysql.php [ 194 ]
--
