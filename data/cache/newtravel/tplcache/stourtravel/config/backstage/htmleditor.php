                    ...
                    <div class="w-set-con">
                        ...
                        <div class="w-set-nr">
                            <ul class="info-item-block">
                                <li class="rowElem">
                                    <span class="item-hd">编辑器大小<?php echo Common::get_help_icon('cfg_admin_htmleditor_width');?>：</span>
                                    <div class="item-bd">
                                        <span class="item-text">宽</span>
                                        <input class="input-text w50 ml-5" type="text"  name="cfg_admin_htmleditor_width" id="cfg_admin_htmleditor_width" value="<?php echo $config['cfg_admin_htmleditor_width'];?>" />
