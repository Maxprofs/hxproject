...
<head>
    <meta charset="utf-8">
    <title>顶部自定义导航管理-笛卡CMS<?php echo $coreVersion;?></title>
                    ...
                    <form id="configfrm">
                        <div class="w-set-nr">
                            <ul class="info-item-block">
                                <li class="rowElem">
                                    <span class="item-hd">自定义导航<?php echo Common::get_help_icon('cfg_usernav_open');?>：</span>
                                    <div class="item-bd">
                                        <label class="radio-label"><input type="radio" name="cfg_usernav_open" value="1" <?php if($config['value']=='1') { ?>checked<?php } ?>
>开启</label>
                                        <label class="radio-label ml-20"><input type="radio" name="cfg_usernav_open" value="0" <?php if($config['value']=='0') { ?>checked<?php } ?>
>关闭</label>
                                    </div>
                                </li>
                            </ul>
