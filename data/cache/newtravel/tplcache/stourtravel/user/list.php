...
<head>
<meta charset="utf-8">
<title>用户管理-笛卡CMS<?php echo $coreVersion;?></title>
...
<script>
 ...
 /*顶部按钮，相关设置，站点等*/
     Ext.get('addbtn').on('click',function()
         {
             var url = SITEURL+'user/dialog_edit/menuid/<?php echo $_GET['menuid'];?>';
...
record.destroy();
 ...
 listeners:{
  ...
  {
      var url = SITEURL+'user/dialog_edit/menuid/<?php echo $_GET['menuid'];?>?id='+id;
