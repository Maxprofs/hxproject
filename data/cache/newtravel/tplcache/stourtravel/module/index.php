...
<head>
<meta charset="utf-8">
<title>模块管理--笛卡CMS<?php echo $coreVersion;?></title>
...
<h4 class="tit-bar">
网站页面<?php echo Common::get_help_icon('module_index_webpage');?></h4>
<ul class="page-list">
                                    <?php $n=1; if(is_array($page_module_list)) { foreach($page_module_list as $page_module) { ?>
<li class="item">
                                        <a class="m-menu" href="javascript:;" onclick="javascript:getModulePage(this,'<?php echo $page_module["id"];?>');"><?php echo $page_module["name"];?></a>
<div class="sub">
</div>
</li>
                                    <?php $n++;}unset($n); } ?>
...
<h4 class="tit-bar">
已添加模块<?php echo Common::get_help_icon('module_index_added_module');?></h4>
...
<h4 class="tit-bar">
模块类型<?php echo Common::get_help_icon('module_index_xinxi_module_catolog');?></h4>
<ul class="type-list">
                                    <?php $n=1; if(is_array($module_list)) { foreach($module_list as $module) { ?>
<li class="item" onclick="javascript:getModuleBlock(this,'<?php echo $module["id"];?>');"><?php echo $module["name"];?></li>
                                    <?php $n++;}unset($n); } ?>
</ul>
</div>
<div class="module-choose">
<h4 class="tit-bar">
功能模块<?php echo Common::get_help_icon('module_index_xinxi_module');?></h4>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#moduleblocklist").click(function () {
                ST.Util.addTab('模块列表', 'module/list/menuid/<?php echo $menuid;?>')
            })
            initUI();
        });
