...
<head>
    <meta charset="utf-8">
    <title>出发地管理-笛卡CMS<?php echo $coreVersion;?></title>
                        ...
                        <div class="w-set-nr">
                            <ul class="info-item-block">
                                <li class="rowElem">
                                    ...
                                    <div class="item-bd">
                                        <label class="radio-label"><input type="radio" name="cfg_startcity_open" value="1" <?php if($config['cfg_startcity_open']=='1') { ?>checked<?php } ?>
>开启</label>
                                        <label class="radio-label ml-20"><input type="radio" name="cfg_startcity_open" value="0" <?php if($config['cfg_startcity_open']=='0') { ?>checked<?php } ?>
>关闭</label>
                                    </div>
                                </li>
                            </ul>
