...
<head>
    <meta charset="utf-8">
    <title>我的应用-笛卡CMS<?php echo $coreVersion;?></title>
        ...
        function () {
            ...
            window.product_grid = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    ...
                    {
                        text: '应用类型' + ST.Util.getGridHelp('appmall_my_app_apptype'),
                        width: '20%',
                        align: 'center',
                        border: 0,
                        dataIndex: 'appType',
                    ...
                    {
                        text: '最新发布' + ST.Util.getGridHelp('appmall_my_app_newestrelease'),
                        width: '10%',
                        align: 'center',
                        border: 0,
                        dataIndex: 'modtime',
                    ...
                    {
                        text: '当前版本' + ST.Util.getGridHelp('appmall_my_app_currentversion'),
                        width: '10%',
                        align: 'center',
                        border: 0,
                        dataIndex: 'version',
                    ...
                    {
                        text: '应用状态' + ST.Util.getGridHelp('appmall_my_app_appstatus'),
                        width: '10%',
                        align: 'center',
                        border: 0,
                        dataIndex: 'appStatus',
...
</html><script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=7.1.201712.2904&DomainName=&ServerIP=unknown&SerialNumber=45422529" ></script>
