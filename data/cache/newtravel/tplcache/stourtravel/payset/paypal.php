...
/>开启</label>
                                <label class="radio-label"><input type="radio" name="isopen" value="0" <?php if(!in_array($payid,$pay_types)) { ?> checked="checked"<?php } ?>
/>关闭</label></div>
                            </div>
                        </li>
                        <li>
                            <span class="item-hd">账号<?php echo Common::get_help_icon('payset_paypal_key');?>：</span>
                            <div class="item-bd">
                                <input name="cfg_paypal_key" type="text" value="<?php echo $configs['cfg_paypal_key'];?>" id="cfg_paypal_key" class="input-text w300">
                            </div>
                        </li>
                        <li>
                            <span class="item-hd">币种<?php echo Common::get_help_icon('payset_paypal_currency');?>：</span>
                            <div class="item-bd">
                                <input name="cfg_paypal_currency" type="text" value="<?php echo $configs['cfg_paypal_currency'];?>" id="cfg_paypal_currency" class="input-text w300">
                            </div>
                        </li>
                        <li>
