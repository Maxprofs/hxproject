...
/>关闭</label>
                        ...
                        <li>
                            <span class="item-hd">网关商户号<?php echo Common::get_help_icon('payset_huicao_account');?>：</span>
                            <div class="item-bd">
                                <input name="cfg_huicao_account" type="text" value="<?php echo $configs['cfg_huicao_account'];?>" id="cfg_huicao_account" class="input-text w300">
                            </div>
                        </li>
                        <li>
                            <span class="item-hd">商户密钥：</span>
                            <div class="item-bd">
                                <input name="cfg_huicao_key" type="text" value="<?php echo $configs['cfg_huicao_key'];?>" id="cfg_huicao_key" class="input-text w300">
                            </div>
                        </li>
                        <li>
