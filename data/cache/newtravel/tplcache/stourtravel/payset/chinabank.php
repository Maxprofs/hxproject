...
/>关闭</label>
                        ...
                        <li>
                            <span class="item-hd">商户号<?php echo Common::get_help_icon('payset_chinabank_mchid');?>：</span>
                            <div class="item-bd">
                                <input name="cfg_yinlian_new_name" type="text" value="<?php echo $configs['cfg_yinlian_new_name'];?>" id="cfg_yinlian_new_name" class="input-text w300">
                            </div>
                        </li>
                        <li>
                            <span class="item-hd">签名证书密码<?php echo Common::get_help_icon('payset_chinabank_securitykey');?>：</span>
                            <div class="item-bd">
                                <input name="cfg_yinlian_new_securitykey" type="text" value="<?php echo $configs['cfg_yinlian_new_securitykey'];?>" id="cfg_yinlian_new_securitykey" class="input-text w300">
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <span class="item-hd">证书上传<?php echo Common::get_help_icon('payset_chinabank_upload');?>：</span>
                            <div class="item-bd">
