            ...
            <td valign="top" class="content-rt-td" style="overflow:hidden">
                <div class="cfg-header-bar">
                    <div class="select-box w150 mt-5 ml-10 fl">
                        <select id="verifystatus" onchange="toverifystatus(this)" class="select">
                    ...
                    <div class="select-box w150 mt-5 ml-10 fl">
                        <select id="sex" onchange="tosex(this)"  class="select">
...
menuDisabled:true,
  ...
  menuDisabled:true,
        ...
        $(".btn_excel").click(function(){
            ...
            window.location.href = SITEURL+"member/export_excel?verifystatus=" + verifystatus + '&sex=' + sex + '&virtual=' + virtual;
        });
    });
//实现动态窗口大小
