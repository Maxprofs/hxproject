                ...
                <div class="st-info-block">
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="item-bd">
                                <span class="member-name"><?php echo $info['dinfo']['nickname'];?></span>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div class="item-bd">
                                <a class="btn btn-primary radius size-S" id="default-pwd" href="javascript:;">使用默认密码</a>
                            </div>
                        </li>
                        <li>
                ...
                <div class="st-info-block">
                    <ul>
                        <li>
                            ...
                            <div class="item-bd">
                                <span class="member-hd-img"><img src="<?php echo $info['litpic'];?>" width="90" height="90" /></span>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div class="item-bd">
                                <input type="text" class="default-text" name="nickname" value="<?php echo $info['nickname'];?>">
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div class="item-bd">
                                <label class="radio-label mr-30"><input type="radio" value="男" name="sex" <?php if($info['sex']=='男') { ?>checked="checked" <?php } ?>
>男</label>
                                <label class="radio-label mr-30"><input type="radio" value="女" name="sex" <?php if($info['sex']=='女') { ?>checked="checked" <?php } ?>
>女</label>
                                <label class="radio-label mr-30"><input type="radio" value="保密"  name="sex" <?php if($info['sex']=='保密') { ?>checked="checked" <?php } ?>
>保密</label>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div class="item-bd">
                                <input type="text" class="default-text" name="native_place" value="<?php echo $info['native_place'];?>">
                            </div>
                        </li>
                        <li>
                            <span class="item-hd">QQ：</span>
                            <div class="item-bd">
                                <input type="text" name="qq" value="<?php echo $info['qq'];?>" class="default-text">
                            </div>
                        </li>
                        <li>
                            <span class="item-hd">微信号：</span>
                            <div class="item-bd">
                                <input type="text" class="default-text" name="wechat" value="<?php echo $info['wechat'];?>">
                            </div>
                        </li>
                        <li>
                            <span class="item-hd">个性签名：</span>
                            <div class="item-bd">
                                <textarea name="signature"  class="default-textarea"><?php echo $info['signature'];?></textarea>
                            </div>
                        </li>
                        <li>
                ...
                <input type="hidden" value="<?php echo $info['mid'];?>" name="mid">
            </form>
            <!-- 资料信息 -->
            <?php if($action="edit") { ?>
            <div class="member-info-container">
...
<!--                         <li>
                            ...
                            <div class="item-bd">
                                <span class="member-level"><?php echo $info['grade'];?></span>
                            </div>
                        </li> -->
                        ...
                        <li>
                            ...
                            <div class="item-bd">
                                <span class="msg-item-txt">
                                    ...
                                    <?php } else if($info['verifystatus']==1) { ?>待审核
                                    <?php } else if($info['verifystatus']==2) { ?>已实名
                                    <?php } else if($info['verifystatus']==3) { ?>认证失败<?php } ?>
</span>
                                <?php if($info['verifystatus']>0) { ?>
                                <a class="msg-item-link" href="javascript:;" onclick="toShowVerify('<?php echo $info['mid'];?>')">查看实名信息&gt;</a>
                                <?php } ?>
                            </div>
                        </li>
                        <?php if($info['is_guide']) { ?>
                        <li>
                            <span class="item-hd">是否导游：</span>
                            <div class="item-bd">
                                <?php if($info['is_guide']==1) { ?>
                                <span class="msg-item-txt">是</span>
                                <a class="msg-item-link" href="javascript:;" onclick="toShowGuide('<?php echo $info['guide_id'];?>')">查看导游信息&gt;</a>
                                <?php } else if($info['is_guide']==2) { ?>
                        ...
                        <li>
                            ...
                            <div class="item-bd">
                                <span class="msg-item-txt"><?php echo date('Y-m-d H:i:s',$info['logintime']);?></span>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script>
$('#isopen').val("<?php echo $info['isopen'];?>");
    //查看实名信息
    function toShowVerify(id)
    {
        var url=SITEURL+"member/verifystatus_list/action/show/parentkey/member/menuid/<?php echo $meunid;?>/itemid/1/mid/"+id;
    ...
    {
        var url=SITEURL+"guide/admin/guide/info/id/"+id+"/menuid/<?php echo $guide_menuid;?>/";
        parent.window.addTab('实名认证详情',url,1);
    }
    $(function()
    {
        YYYYMMDDstart();
        var year =  '<?php echo $info['birth_date']['0'];?>';
        var month =  '<?php echo $info['birth_date']['1'];?>';
        var day =  '<?php echo $info['birth_date']['2'];?>';
        if(year)
        {
        ...
        var constellation = '<?php echo $info['constellation'];?>';
