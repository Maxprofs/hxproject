...
<head>
    <meta charset="utf-8">
    <title>提现-笛卡CMS<?php echo $coreVersion;?></title>
...
<table class="content-tab">
    <tr>
        ...
        <input type="text" id="searchkey" value="电话/联系人/订单号" datadef="电话/联系人" class="search-text">
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        var html = "<a href='javascript:void(0);' class='btn-link' onclick=\"edit(" + id + ")\">编辑</a>";
                        return html;
...
{
    var record = window.product_store.getById(id.toString());
    var url=SITEURL+"member/withdraw_edit/<?php if(isset($_GET['menuid'])) { ?>menuid/<?php echo $_GET['menuid'];?>/<?php } ?>
id/"+id;
