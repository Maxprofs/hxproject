...
<head>
    <meta charset="utf-8">
    <title>资金日志-笛卡CMS<?php echo $coreVersion;?></title>
...
<table class="content-tab">
    <tr>
        ...
        <input type="text" id="searchkey" placeholder="会员手机/邮箱/昵称" class="search-text">
