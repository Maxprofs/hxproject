...
<head>
    <meta charset="utf-8">
    <title>问答管理-笛卡CMS<?php echo $coreVersion;?></title>
...
Ext.onReady(
  ...
  menuDisabled:true,
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        if(verifystatus==1)
                        {
                            var html = "<a class='btn-link' href='javascript:void(0);' title='审核' onclick=\"toCheck(" + id + ")\">审核</a>"
                        }
                        else
                        {
                            var html = "<a class='btn-link' href='javascript:void(0);' title='详情'  onclick=\"toShow(" + id + ")\">详情</a>"+
                                "&nbsp;&nbsp;&nbsp;<a class='btn-link' href='javascript:void(0);' title='修改' onclick=\"toModify(" + id + ")\">编辑</a>"
                        }
                         return html;
...
{
    var url=SITEURL+"member/verifystatus_list/action/modify/parentkey/member/menuid/<?php echo $meunid;?>/itemid/1/mid/"+id;
...
function toCheck(id)
{
    var url=SITEURL+"member/verifystatus_list/action/check/parentkey/member/menuid/<?php echo $meunid;?>/itemid/1/mid/"+id;
