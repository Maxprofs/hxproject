          ...
          <a href="javascript:;" class="fr btn btn-primary radius mt-6 mr-10" onclick="window.location.reload()">刷新</a>
            ...
            <div class="product-add-div">
                <ul class="info-item-block">
                  <li>
                  <span class="item-hd">会员提现方式<?php echo Common::get_help_icon('cfg_member_withdraw_way');?>：</span>
                  <div class="item-bd">
                  <label class="check-label mr-20"><input type="checkbox" name="cfg_member_withdraw_way[]" value="bank" <?php if(in_array('bank',$cfg_member_withdraw_way)) { ?>checked="checked"<?php } ?>
/>银行卡</label>
                  <label class="check-label mr-20"><input type="checkbox" name="cfg_member_withdraw_way[]" value="alipay" <?php if(in_array('alipay',$cfg_member_withdraw_way)) { ?>checked="checked"<?php } ?>
/>支付宝</label>
                  <label class="check-label mr-20"><input type="checkbox" name="cfg_member_withdraw_way[]" value="weixin" <?php if(in_array('weixin',$cfg_member_withdraw_way)) { ?>checked="checked"<?php } ?>
/>微信</label>
                  </div>
                  </li>
                </ul>
