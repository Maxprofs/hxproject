                    ...
                    <li>
                        ...
                        <div class="item-bd">
                            <label class="radio-label mr-30">
                                <input name="cash_min" type="radio" class="checkbox" <?php if($config['cash_min']=='0') { ?>checked<?php } ?>
 value="0">无要求
                            </label>
                            <label class="radio-label mr-30">
                                <input name="cash_min" type="radio" class="checkbox" <?php if($config['cash_min']=='1') { ?>checked<?php } ?>
 value="1">每月须达到
                                <input type="text" class="input-text w80 reset-input" name="cash_min_num" value="<?php echo $config['cash_min_num'];?>" >以上才可提现
                            </label>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="item-bd">
                            <label class="radio-label mr-30">
                                <input name="cash_max" type="radio" class="checkbox" <?php if($config['cash_max']=='0') { ?>checked<?php } ?>
 value="0">无要求
                            </label>
                            <label class="radio-label mr-30">
                                <input name="cash_max" type="radio" class="checkbox" <?php if($config['cash_max']=='1') { ?>checked<?php } ?>
 value="1">每月最多可提现
                                <input type="text" class="input-text w80 reset-input" name="cash_max_num" value="<?php echo $config['cash_max_num'];?>">次
                            </label>
                        </div>
                    </li>
                </ul>
