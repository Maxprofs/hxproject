...
<head>
    <meta charset="utf-8">
    <title>笛卡CMS<?php echo $coreVersion;?>-后台登陆</title>
    <?php echo Common::getCss('base.css,login.css');?>
            ...
            <ul class="info-item-block">
                ...
                <li class="clearfix">
                    ...
                    <div class="item-bd">
                        ...
                        <div class="yzm-box"><img id="yzm-box" data-src="<?php  echo URL::site('captcha');?>?_t=" src="<?php echo URL::site('captcha');?>" width="120" height="40"/></div>
                    </div>
                </li>
            </ul>
