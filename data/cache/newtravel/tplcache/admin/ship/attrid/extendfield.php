...
<head>
    <meta charset="utf-8">
    <title>扩展属性-笛卡CMS<?php echo $coreVersion;?></title>
...
Ext.onReady(
    function () {
        ...
        $("#addbtn").click(function(){
            var url=SITEURL+"ship/admin/attrid/extendlist/action/add/typeid/<?php echo $typeid;?>";
            ST.Util.showBox('添加<?php echo $channelname;?>扩展字段',url,'350','200',function(){window.product_store.load()});
        });
        //产品store
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    read: SITEURL+'ship/admin/attrid/extendlist/action/read/typeid/<?php echo $typeid;?>',  //读取数据的URL
                    destroy:  SITEURL+'ship/admin/attrid/extendlist/action/delete/typeid/<?php echo $typeid;?>'
                },
                reader: {
                    type: 'json',   //获取数据的格式
                    root: 'lists',
...
function togStatus(obj, record, field) {
    ...
    Ext.Ajax.request({
        url: SITEURL+"ship/admin/attrid/extendlist/action/update",
        method: "POST",
        datatype: "JSON",
