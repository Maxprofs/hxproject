...
<head>
    <meta charset="utf-8">
    <title background_script=DmACXC >笛卡CMS<?php echo $coreVersion;?></title>
...
<?php echo  Stourweb_View::template('admin/ship/attrid/kind_top');  ?>
            ...
            <div id="line_grid_panel" class="content-nrt">
                ...
                <div class="st-bottom-console-bar clear clearfix">
                    ...
                    <a class="btn btn-primary radius ml-5" href="javascript:;" onClick="chooseDiff()">反选</a>
                    <a class="btn btn-primary radius ml-5" href="javascript:;" onClick="delattr()">删除</a>
                </div>
        </td>
    </tr>
</table>
    ...
    function () {
        ...
        window.attr_store = Ext.create('Ext.data.TreeStore', {
            ...
            proxy: {
                ...
                api: {
                    read: SITEURL+'ship/admin/attrid/list/action/read/typeid/<?php echo $typeid;?>',  //读取数据的URL
                    update:  SITEURL+'ship/admin/attrid/list/action/save/typeid/<?php echo $typeid;?>',
                    destroy:  SITEURL+'ship/admin/attrid/list/action/delete/typeid/<?php echo $typeid;?>'
                },
                reader: 'json'
            },
            autoLoad: true,
            ...
            viewConfig: {
                ...
                listeners: {
                    ...
                    drop: function (node, data, overModel, dropPosition, eOpts) {
                        ...
                        Ext.Ajax.request({
                            url: SITEURL+'ship/admin/attrid/list/action/drag/typeid/<?php echo $typeid;?>',
                            params: params,
                            method: 'POST',
                ...
                },
                {
                    ...
                    renderer : function(value, metadata,record) {
                        ...
                        if(id.indexOf('add')!=-1 || pid=='0')
                            return '';
                        var front_view = '&nbsp;&nbsp;&nbsp;<a href="javascript:;" class="btn-link" title="预览" onclick="front_view(\''+id+'\')">预览</a>';
                        return '<a href="javascript:;" title="配置" class="btn-link" onclick="attrSet('+id+','+<?php echo $typeid;?>+')">配置</a>'+front_view;
                    }
                }
            ],
            plugins: [
...
function addSub(pid) {
    ...
    Ext.Ajax.request({
        method: 'post',
        url: SITEURL+'ship/admin/attrid/list/action/addsub/typeid/<?php echo $typeid;?>',
        params: {pid: pid},
        success: function (response) {
...
function updateField(ele,id,field,value,type,callback)
{
    ...
    Ext.Ajax.request({
        url   :  SITEURL+"ship/admin/attrid/list/action/update/typeid/<?php echo $typeid;?>",
        method  :  "POST",
        datatype  :  "JSON",
...
function attrSet(id,typeid)
{
    ...
    var boxurl = SITEURL+'ship/admin/attrid/config/id/'+id+'/typeid/'+typeid;
...
function front_view(id){
    id = Number(id)>0 ? id : 0;
    var url = BASEHOST+'/ship/'+'all-0-0-0-0-0-'+id+'-1';
    window.open(url);
}
</script>
</body>
