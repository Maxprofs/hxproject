...
<script>
        ...
        function () {
            ...
            window.attr_store = Ext.create('Ext.data.TreeStore', {
                ...
                proxy: {
                    ...
                    api: {
                        read: SITEURL+'ship/admin/ship/facilitykind/action/read',  //读取数据的URL
                        update:  SITEURL+'ship/admin/ship/facilitykind/action/save',
                        destroy:  SITEURL+'ship/admin/ship/facilitykind/action/delete'
                    },
                    reader:{
                        type:'json',
                        root:'children'
    ...
    function addSub(pid,path) {
        ...
        Ext.Ajax.request({
            method: 'post',
            url: SITEURL+'ship/admin/ship/facilitykind/action/addsub',
    ...
    {console.log(ele,id,field,value,type,callback);
        ...
        Ext.Ajax.request({
            url   :  SITEURL+"ship/admin/ship/facilitykind/action/update",
            method  :  "POST",
            datatype  :  "JSON",
