...
<script>
 ...
 Ext.tip.QuickTipManager.init();
        ...
        $("#addbtn").click(function(){
            ST.Util.addTab('添加轮船','<?php echo $cmsurl;?>ship/admin/ship/add/<?php if(isset($_GET['menuid'])) { ?>menuid/<?php echo $_GET['menuid'];?>/<?php } ?>
 ...
 if(response.responseText=='ok')
 {
  ...
  //修改
    function goModify(id)
    {
        ...
        var url = SITEURL+'ship/admin/ship/edit/id/'+id+'/<?php if(isset($_GET['menuid'])) { ?>menuid/<?php echo $_GET['menuid'];?>/<?php } ?>
