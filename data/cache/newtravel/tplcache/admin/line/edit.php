...
<head>
    ...
    <?php echo Common::getCss('style.css,base.css,base2.css,base_new.css,order.show.css');?>
    <?php echo Common::getScript("jquery.upload.js,product_add.js,choose.js,st_validate.js,jquery.colorpicker.js,imageup.js,jquery.upload.js,insurance.js");?>
    <style>
        ...
        <td valign="top" class="content-rt-td" style="overflow:auto;">
            <div class="cfg-header-bar">
                <div class="cfg-header-tab">
                    ...
                    <span class="item" id="column_<?php echo $col['columnname'];?>" onclick="Product.switchTabs(this,'<?php echo $col['columnname'];?>',switchBack)"><?php echo $col['chinesename'];?></span>
                    <?php $n++;}unset($n); } ?>
                    ...
                    <span class="item" id="column_extend" onclick="Product.switchTabs(this,'extend')">扩展<?php echo Common::get_help_icon('extend_filed');?></span>
                </div>
                ...
                <form id="product_fm">
                    <div id="content_basic" class="product-add-div content-show">
                        <ul class="info-item-block">
                            <li>
                                <span class="item-hd">选择站点<?php echo Common::get_help_icon('product_site');?>：</span>
                                <div class="item-bd">
...
>主站</option>
 ...
 value="<?php echo $web['webid'];?>"><?php echo $web['webname'];?></option>
                            ...
                            <li>
                                <span class="item-hd">产品标题<?php echo Common::get_help_icon('product_title');?>：</span>
                                <div class="item-bd">
                                    <input type="text" name="title" data-required="true" class="input-text w800" value="<?php echo $info['title'];?>"/>
                                    <input type="hidden" name="lineid" id="line_id" value="<?php echo $info['id'];?>"/>
                                </div>
                            </li>
                            <li>
                                <span class="item-hd">标题颜色<?php echo Common::get_help_icon('product_color');?>：</span>
                                <div class="item-bd">
                                    <input type="text" name="color" value="<?php echo $info['color'];?>" style="color:  <?php echo $info['color'];?>"  class="input-text w100 title-color"/>
                                    <span style=" display: inline-block; width: 15px; height: 15px; vertical-align: middle; background: <?php echo $info['color'];?>"></span>
                                </div>
                            </li>
                            <li>
                                <span class="item-hd">产品卖点<?php echo Common::get_help_icon('product_sellpoint');?>：</span>
                                <div class="item-bd">
                                    <input type="text" name="sellpoint" value="<?php echo $info['sellpoint'];?>"  class="input-text w800"/>
                                </div>
                            </li>
                            <li>
                                <span class="item-hd">旅游天数<?php echo Common::get_help_icon('line_travel_days');?>：</span>
                                <div class="item-bd">
                                    <input type="text" value="<?php echo $info['lineday'];?>" data-regrex="number" data-required="true" data-msg="必须为数字" id="travel_days" class="input-text w80" name="lineday"/>
                                    <span class="ml-5">天</span>
                                    <input type="text" value="<?php echo $info['linenight'];?>" data-regrex="number" data-msg="必须为数字" class="input-text w80 ml-10" name="linenight"/>
                                    <span class="ml-5">晚</span>
                                </div>
                                </dd>
                            </li>
                            <li>
                                <span class="item-hd">提前天数<?php echo Common::get_help_icon('line_advance_days');?>：</span>
                                <div class="item-bd">
                                    <span class="item-text va-t">建议提前</span>
                                    <input type="text" name="linebefore" value="<?php echo $info['linebefore'];?>" data-regrex="number" data-msg="必须为数字" class="input-text w50 va-t ml-5"/>
                                    <span class="ml-5">天报名</span>
                                    <label class="radio-label ml-10"><input type="checkbox" name="islinebefore" value="1" <?php if($info['islinebefore']==1) { ?>checked="checked"<?php } ?>
/>少于提前天数，则禁止预订</label>
                                </div>
                            </li>
                            <li>
                                <span class="item-hd">上/下架<?php echo Common::get_help_icon('product_shelves');?>：</span>
                                <div class="item-bd">
                                    <label class="radio-label"><input type="radio" name="status"  <?php if($info['status']==3) { ?>checked="checked"<?php } ?>
 value="3">上架</label>
                                    <label class="radio-label ml-20"><input type="radio" name="status"  <?php if($info['status']==2) { ?>checked="checked"<?php } ?>
 value="2">下架</label>
                                </div>
                            </li>
                        </ul>
                        ...
                        <ul class="info-item-block">
                            <li>
                                <span class="item-hd">目的地<?php echo Common::get_help_icon('product_destination');?>：</span>
                                <div class="item-bd">
                                    ...
                                    <div class="save-value-div ml-10 dest-sel">
                                        ...
                                        <span class="mb-5 <?php if($info['finaldestid']==$v['id']) { ?>finaldest<?php } ?>
...
" ><s onclick="$(this).parent('span').remove()"></s><?php echo $v['kindname'];?><input type="hidden" class="lk" name="kindlist[]" value="<?php echo $v['id'];?>"/>
                            ...
                            <li>
                                <span class="item-hd">出发地<?php echo Common::get_help_icon('line_startcity');?>：</span>
                                <div class="item-bd">
...
<!--                                    </span>-->
                            ...
                            <li>
                                <span class="item-hd">产品属性<?php echo Common::get_help_icon('product_attr');?>：</span>
                                <div class="item-bd">
                                    ...
                                    <div class="type-bar-block clearfix attr-sel">
                                        <?php $n=1; if(is_array($info['attrlist_arr'])) { foreach($info['attrlist_arr'] as $v) { ?>
                                        <?php if($v['pid']==0) { ?>
                                        <ul class="info-item-block">
                                            <li>
                                                <span class="item-hd"><?php echo $v['attrname'];?>：</span>
                                                <input type="hidden" name="attrlist[]" value="<?php echo $v['id'];?>"/>
                                                <div class="item-bd attr-parent-div" pid="<?php echo $v['id'];?>">
                                                    <?php $n=1; if(is_array($info['attrlist_arr'])) { foreach($info['attrlist_arr'] as $a) { ?>
                                                    <?php if($a['pid']==$v['id']) { ?>
                                                    <span class="choose-child-item mb-5 mr-5"><?php echo $a['attrname'];?><i onclick="Product.removeAttrNew(this)" class="icon-Close"></i></span>
                                                    <input type="hidden" name="attrlist[]" value="<?php echo $a['id'];?>"/>
                                                    <?php } ?>
                                                    <?php $n++;}unset($n); } ?>
                                                </div>
                                            </li>
                            ...
                            <?php if($cfg_icon_rule==1) { ?>
                            <li>
                                <span class="item-hd">图标设置<?php echo Common::get_help_icon('product_icon');?>：</span>
                                <div class="item-bd">
                                    ...
                                    <div class="save-value-div ml-10 icon-sel">
                                        ...
                                        <span class="mb-5 " title="<?php echo $v['kind'];?>" >
                                            <s onclick="$(this).parent('span').remove()"></s><?php echo $v['kind'];?>
                                            <input type="hidden" class="lk" name="iconlist[]" value="<?php echo $v['id'];?>"/>
                                        </span>
                                        <?php $n++;}unset($n); } ?>
                                    </div>
                                </div>
                            ...
                            <?php } ?>
                            <li>
                                <span class="item-hd">供应商<?php echo Common::get_help_icon('product_supplier');?>：</span>
                                <div class="item-bd">
                            ...
                            <?php $contractlist = Model_Contract::get_product_contract_list(1)?>
                            <?php if($contractlist) { ?>
                            <li>
                                <span class="item-hd">合同<?php echo Common::get_help_icon('product_contract');?>：</span>
                                <div class="item-bd">
                                    <div id="contract_list">
                                        <?php $n=1; if(is_array($contractlist)) { foreach($contractlist as $contract) { ?>
                                        <a   <?php if($info['contractid']==$contract['id']) { ?>class="label-module-cur-item mr-5"<?php } else { ?>class="label-module-item mr-5"<?php } ?>
  href="javascript:void(0)" data-value="<?php echo $contract['id'];?>" onclick="setContract(this)"><?php echo $contract['title'];?></a>
                                        <?php $n++;}unset($n); } ?>
                                        <input type="hidden" name="contractid" id="contractid" value="<?php echo $info['contractid'];?>"/>
                                    </div>
                                </div>
                            </li>
                            <?php } ?>
                    ...
                    <div id="content_tupian" class="product-add-div content-hide">
                        <ul class="info-item-block">
                            <li>
                                <span class="item-hd">图片<?php echo Common::get_help_icon('product_images');?>：</span>
                                <div class="item-bd">
                                    <div class="">
                        ...
                        <ul class="info-item-block">
                            <li>
                                <span class="item-hd">视频<?php echo Common::get_help_icon('product_video');?>：</span>
                                <div class="item-bd">
                                    <div class="mt-3">
                                    ...
                                    <ul class="up-video-list" id="videoContent">
                                        ...
                                        <?php list(,$videoName)=explode('|',$info['product_video'])?>
                                        <li><input name="product_video" type="hidden" value="<?php echo $info['product_video'];?>"><span class="v-name"><?php echo $videoName;?></span><a href="javascript:;" class="btn-link ml-20" onclick="videoNode()">删除</a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            </li>
                    ...
                    <div id="content_promotion" class="product-add-div content-hide">
                        <div class="pd-10">
                            <?php if(St_Functions::is_system_app_install(111)) { ?>
                            <div class="order-show-wrap mb-10">
                                <div class="order-show-bar">
                                    <span class="order-bar-tit c-primary">附加产品</span>
                                </div>
                                <?php echo Request::factory('insurance/admin/insurance/product_add/typeid/1/productid/'.$info['id'])->execute()->body(); ?>
                            </div>
                            <?php } ?>
                            ...
                            <div class="order-show-wrap mb-10">
                                ...
                                <?php echo Request::factory('together/admin/together/product_add/typeid/1/productid/'.$info['id'].'/menuid/'.$_GET['menuid'])->execute()->body(); ?>
                            </div>
                            <?php } ?>
                            <div class="mb-10">
                                <div class="order-show-bar">
                                    <span class="order-bar-tit c-primary">积分策略<?php echo Common::get_help_icon('product_integral_strategy');?></span>
                                </div>
                                <ul class="info-item-block">
                                    <li>
                                ...
                                <ul class="info-item-block">
                                    <li>
                                        <div class="item-bd" style="padding-left: 50px">
                                            <span class="item-text">推荐次数<input type="text" name="recommendnum" value="<?php echo $info['recommendnum'];?>" data-regrex="number" data-msg="*必须为数字" class="input-text w100 ml-5 reset-input"/></span>
                                            <span class="item-text ml-20">满意度<?php echo Common::get_help_icon('product_satisfaction');?><input type="text" name="satisfyscore" value="<?php if(!$info['id']) { ?>100 <?php } else { ?><?php echo $info['satisfyscore'];?><?php } ?>
" data-regrex="number" data-max="100"  data-msg="*必须为数字" class="input-text w100 ml-5 reset-input"/></span>
                                            <span class="item-text ml-20">销量<?php echo Common::get_help_icon('product_sales');?><input type="text" name="bookcount" value="<?php echo $info['bookcount'];?>" data-regrex="number" data-msg="*必须为数字" class="input-text w100 ml-5 reset-input"/></span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div id="content_jieshao" class="product-add-div content-hide">
                        <ul class="info-item-block">
                            <li>
                                ...
                                <div class="item-bd">
                                    <a class=" mr-5 <?php if($info['isstyle']==2 OR empty($info['isstyle'])) { ?>label-module-cur-item<?php } else { ?>label-module-item<?php } ?>
" href="javascript:void(0)"  onclick="togStyle(this,2)">标准版</a>
                                    <a class=" mr-5 <?php if($info['isstyle']==1) { ?>label-module-cur-item<?php } else { ?>label-module-item<?php } ?>
" href="javascript:void(0)"  onclick="togStyle(this,1)">简洁版</a>
                        ...
                        <ul class="info-item-block content-jieshao-detail-extend" style="<?php  if($info['isstyle']==1) echo 'display:none'   ?>">
                            <div class="line"></div>
                            <li>
                                <span class="item-hd">行程附件<?php echo Common::get_help_icon('line_word_stoke');?>：</span>
                                <div class="item-bd">
                                    <div class="">
...
>显示</label>
 ...
 name="showtran" value="0">隐藏</label>
                        ...
                        <div class="content-jieshao-simple  mt-10" style="<?php  if(empty($info['isstyle'])||$info['isstyle']==2) echo 'display:none'   ?>">
                            <div>
                                <textarea name="jieshao" id="simple_jieshao"><?php echo $info['jieshao'];?></textarea>
                            </div>
                        </div>
                    ...
                    <div id="content_template" class="product-add-div content-hide">
                        <ul class="info-item-block">
                            <li>
                                <span class="item-hd">电脑端模板<?php echo Common::get_help_icon('product_template_set');?>：</span>
                                <input type="hidden" name="templet" id="templet" value="<?php echo $info['templet'];?>"/>
                                <div class="item-bd" id="templet_list_pc">
                                </div>
                            </li>
                            <li>
                                <span class="item-hd">移动端模板<?php echo Common::get_help_icon('product_template_set');?>：</span>
                                <input type="hidden" name="wap_templet" id="wap_templet" value="<?php echo $info['wap_templet'];?>"/>
                    ...
                    <div id="content_seo" class="product-add-div content-hide">
                        <ul class="info-item-block">
                            <li>
                                ...
                                <div class="item-bd">
                                    <input type="text" name="seotitle" value="<?php echo $info['seotitle'];?>" class="input-text w600">
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="item-bd">
                                    ...
                                    <input type="text" name="tagword" class="input-text w600 " value="<?php echo $info['tagword'];?>">
                                </div>
                            </li>
                            <li>
                                <span class="item-hd">关键词<?php echo Common::get_help_icon('content_keyword');?>：</span>
                                <div class="item-bd">
                                    <input type="text" name="keyword" value="<?php echo $info['keyword'];?>" class="input-text w600">
                                </div>
                            </li>
                            <li>
                                <span class="item-hd">页面描述<?php echo Common::get_help_icon('content_description');?>：</span>
                                <div class="item-bd">
                                    <textarea class="set-area"  style="width: 588px"  name="description" cols="" rows=""><?php echo $info['description'];?></textarea>
                                </div>
                            </li>
                            <li>
                                <span class="item-hd">301重定向<?php echo Common::get_help_icon('httpstatus_301');?>：</span>
                                <div class="item-bd">
                                    <input type="text" name="redirect_url" id="redirecturl"  class="input-text w600" value="<?php echo $info['redirect_url'];?>">
                                </div>
                            </li>
                        </ul>
                    </div>
...
<script>
    var is_spot_open=parseInt('<?php if(St_Functions::is_system_app_install(5)) { ?>1<?php } else { ?>0<?php } ?>
');
    ...
    function ajax_get_template() {
        ...
        var template = "<?php echo $info['templet'];?>";
        var wap_templet = "<?php echo $info['wap_templet'];?>";
        $.ajax({
            type:'post',
            dataType:'json',
