...
<body style="overflow:hidden">
    <table class="content-tab" div_head=4GACXC >
        <tr>
...
<script>
            ...
            window.dest_treepanel = Ext.create('Ext.tree.Panel', {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        text: '目的地'+ST.Util.getGridHelp('line_destination'),
                        dataIndex: 'kindname',
                        id: 'dest_name',
                        menuDisabled:true,
                        sortable:false,
                    ...
                    {
                        text: '显示'+ST.Util.getGridHelp('line_destination_isopen'),
                        dataIndex: 'isopen',
                        width: '10%',
                        xtype: 'actioncolumn',
                        tdCls: 'dest-al-mid',
                    ...
                    {
                        text: '栏目首页显示'+ST.Util.getGridHelp('line_destination_index_isopen'),
                        dataIndex: 'isnav',
                        width: '10%',
                        xtype: 'actioncolumn',
                        tdCls: 'dest-al-mid',
                    ...
                    {
                        text: '是否热门'+ST.Util.getGridHelp('line_destination_hot'),
                        dataIndex: 'ishot',
                        width: '10%',
                        xtype: 'actioncolumn',
                        tdCls: 'dest-al-mid',
                    ...
                    {
                        text: '优化设置'+ST.Util.getGridHelp('line_destination_seo'),
    ...
    function destProductSet(dest_id) {
        ...
        ST.Util.addTab(channel_name+record.data.kindname+'优化设置', 'line/admin/destination/seo/menuid/<?php echo $_GET["menuid"];?>/id/'+id);
    ...
    function setTemplate(dest_id,webtype) {
        var id = dest_id.substr(dest_id.indexOf('_') + 1);
        ST.Util.showBox('选择模板',SITEURL+'line/admin/destination/set_template/id/'+id+'/webtype/'+webtype,600,'',null,null,document,{loadCallback:setTemplateCallback,loadWindow:window});
    }
    //设置模板回调
    function setTemplateCallback(result,bool)
    {
        ...
        $.ajax({
            data:result.data,
            dataType:'json',
            url:SITEURL+'line/admin/destination/ajax_save_template',
            type:'post',
