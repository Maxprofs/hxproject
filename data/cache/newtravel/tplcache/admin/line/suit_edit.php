...
<body>
                  ...
                  <div class="product-add-div">
                      <ul class="info-item-block">
                          <li>
                              ...
                              <div class="item-bd">
                                  <div class="item-text"><?php echo $lineinfo['title'];?></div>
                          ...
                          <li>
                              ...
                              <div class="item-bd">
                                  <input type="text" name="suitname" id="suitname"  class="input-text w600" value="<?php echo $info['suitname'];?>" />
                              </div>
                          </li>
                          <li>
                              <span class="item-hd">原价<?php echo Common::get_help_icon('product_original_price');?>：</span>
                              <div class="item-bd">
                                  <input type="text" name="sellprice" id="sellprice" maxlength="6"  class="input-text w100 number-only" value="<?php echo $info['sellprice'];?>" />
                              </div>
                          </li>
                          <li>
                          ...
                          <li>
                              ...
                              <div class="item-bd">
                                  <span class="mr-10 w60" style="display: inline-block">儿童标准</span><input type="text" name="childdesc" id="childdesc"  class="input-text w600" value="<?php echo $info['childdesc'];?>" />
                              </div>
                              <div class="item-bd mt-10">
                                  <span class="mr-10 w60" style="display: inline-block">老人标准</span><input type="text" name="olddesc" id="olddesc"  class="input-text w600" value="<?php echo $info['olddesc'];?>" />
                              </div>
                              <div class="item-bd mt-10">
                                  <span class="mr-10 w60" style="display: inline-block" >单房差标准</span><input type="text" name="roomdesc" id="adultdesc"  class="input-text w600" value="<?php echo $info['roomdesc'];?>" />
                              </div>
                          </li>
                      </ul>
                      <div class="line"></div>
 ...
 />定金预定</label>
                                      <span id="dingjin" style="<?php if($info['paytype'] != '2') { ?>display: none<?php } ?>
">
                                          &nbsp;&nbsp;&nbsp;每人支付定金
                                          <input type="text" class="input-text w60 va-t" maxlength="6" name="dingjin" id="dingjintxt" value="<?php echo $info['dingjin'];?>" size="6" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-\.]+/,'');}).call(this)" onblur="this.v();">&nbsp;</span>
                                      <script>
 ...
 />需要供应商或管理员手动确认</label>
                          ...
                          <li>
                              ...
                              <div class="item-bd">
                                  <label class="radio-label"><input type="checkbox" name="pay_way[]" id="online_pay" value="1" <?php if($info['pay_way']=='1' || $info['pay_way']==3) { ?>checked="checked"<?php } ?>
 <?php if($action=='add') { ?>checked="checked"<?php } ?>
 />线上支付</label>
                                  <label class="radio-label"><input type="checkbox" name="pay_way[]" id="offline_pay" value="2" <?php if($info['pay_way']=='2' || $info['pay_way']==3) { ?>checked="checked"<?php } ?>
 <?php if($action=='add') { ?>checked="checked"<?php } ?>
 />线下支付</label>
                              </div>
                          </li>
                          <li>
                              ...
                              <div class="item-bd">
                                  <input type="text" name="auto_close_time_hour" id="auto_close_time_hour" maxlength="2" onkeyup="value=value.replace(/[^\d]/g,'')"  class="input-text w60" <?php if($action=='add') { ?>value="24"<?php } else { ?>value="<?php echo $info['auto_close_time_hour'];?>"<?php } ?>
 />&nbsp;小时
                                  <input type="text" name="auto_close_time_minute" id="auto_close_time_minute" maxlength="2" onkeyup="value=value.replace(/[^\d]/g,'')"  class="input-text w60" <?php if($action=='add') { ?>value="0"<?php } else { ?>value="<?php echo $info['auto_close_time_minute'];?>"<?php } ?>
 />&nbsp;分钟
                              </div>
                          </li>
                      </ul>
