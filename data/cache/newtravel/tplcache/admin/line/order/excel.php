...
<script>
    ...
    var params = <?php if(!empty($params)) { ?> <?php echo json_encode($params);?><?php } else { ?>null<?php } ?>
;
    $(function(){
       $(".btn_excel").click(function(){
           ...
           var url = SITEURL+'line/admin/order/genexcel/typeid/'+typeid+'/timetype/'+timetype+'?starttime='+starttime+'&endtime='+endtime+'&time_target='+time_target;
           for(var i in params)
           {
               url+='&'+i+'='+params[i];
           }
