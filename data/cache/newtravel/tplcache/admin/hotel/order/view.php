            ...
            <div class="order-info-block">
                <ul>
                  <li>
                    ...
                    <li>
                        <strong class="item-hd">入住日期：</strong>
                        <div class="item-bd">
                            <div class="order-num">
                    ...
                    <li>
                        <strong class="item-hd">离店日期：</strong>
                        <div class="item-bd">
                            <div class="order-num">
                ...
                <table class="user-info-table mt-5">
                    ...
                    <tr>
                        <td width="20%">房型</td>
                        <td width="15%"><?php echo $night;?>合计</td>
                        <td width="20%">预订数量</td>
                        <td width="15%">总计</td>
                        <td>&nbsp;</td>
                    </tr>
                    ...
                    <tbody>
                    <tr>
                        <td><span class="cor_666"><?php echo $suit['roomname'];?></span></td>
                        <td><span class="cor_666"><?php echo Currency_Tool::symbol();?>
                                <?php if(in_array($info['status'],array(0,1))) { ?>
                                <input type="text" class="set-text-xh wid_80 mt-4" name="price" id="price" style="float: none;" value="<?php echo $info['price'];?>" />
                                <?php } else { ?>
                                   <?php echo $info['price'];?>
                                <?php } ?>
                            </span></td>
                        <td>
                            <span class="order-num">
                                <span class="type">
                                <?php echo $info['dingnum'];?>
                                </span>
                            </span>
                            <span class="unit">间</span>
                        </td>
                        <td><span class="color_f60 adult_price_total_txt"><?php echo Currency_Tool::symbol();?><?php echo $info['dingnum']*$info['price'];?></span></td>
                        <td>&nbsp;</td>
                    </tr>
                    </tbody>
                </table>
...
<script>
    ...
    function refund_submit(type,description)
    {
        ...
        $.ajax({
            url : SITEURL+"hotel/admin/order/ajax_refund_submit",
            type:'post',
            dataType:'json',
