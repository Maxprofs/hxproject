    ...
    <!--右侧内容区-->
     ...
     <td valign="top" class="content-rt-td">
          ...
          <div class="manage-nr">
              ...
              <div class="item-bd">
              <span class="item-text"><?php echo $hotelname;?></span>
              </div>
              </li>
              <li>
              <span class="item-hd">房型名称：</span>
              <div class="item-bd">
              <input type="text" name="roomname" id="roomname" class="input-text w700" value="<?php echo $info['roomname'];?>" />
              </div>
              </li>
              <li>
              ...
              <div class="item-bd">
              <input type="text" name="sellprice" id="sellprice" class="input-text w100" value="<?php echo $info['sellprice'];?>" />
              ...
              <div class="item-bd">
              <input type="text" name="roomarea" id="roomarea" class="input-text w100" value="<?php echo $info['roomarea'];?>" />
              ...
              <div class="item-bd">
              <input type="text" name="roomfloor" id="roomfloor" class="input-text w100" value="<?php echo $info['roomfloor'];?>" />
              ...
              <div class="item-bd">
              <input type="text" name="roomnum" id="roomnum" class="input-text w100" value="<?php echo $info['number'];?>" />
              ...
              <form class="fl">
                              <div class="on-off lh-30">
                                  <?php $n=1; if(is_array($roomtype)) { foreach($roomtype as $room) { ?>
                                   <label class="radio-label mr-20" for="R_BedCategory_<?php echo $n;?>"><input id="R_BedCategory_<?php echo $n;?>" type="radio" name="roomstyle" value="<?php echo $room;?>" <?php if($info['roomstyle']==$room) { ?>checked="checked"<?php } ?>
/><?php echo $room;?></label>
                                  <?php $n++;}unset($n); } ?>
...
/>
                                  ...
                                  <input type="text" class="uservalue" data-value="user_room_v" style="width:70px;border-left:none;border-right:none;border-top:none"  value="<?php if(!in_array($info['roomstyle'],$roomtype) && !empty($info['roomstyle'])) { ?><?php echo $info['roomstyle'];?><?php } ?>
">                      
                                  </label>
<script>
    $(function(){
            $('.uservalue').bind('input propertychange', function() {
              ...
              <div class="on-off lh-30">
                                  ...
                                  <label class="radio-label mr-20" for="roomwindow_<?php echo $n;?>"><input id="roomwindow_<?php echo $n;?>" type="radio" name="roomwindow" value="<?php echo $window;?>"  <?php if($info['roomwindow']==$window) { ?>checked="checked"<?php } ?>
/><?php echo $window;?></label>
                                  <?php $n++;}unset($n); } ?>
...
/>
                                  <label class="radio-label mr-20" for="user_roomwindow_v"><input type="text" class="uservalue" data-value="user_window_v" style="width:70px;border-left:none;border-right:none;border-top:none"  value="<?php if(!in_array($info['roomwindow'],$windowtype) && !empty($info['roomwindow'])) { ?> <?php echo $info['roomwindow'];?><?php } ?>
"></label>
                                 </div>
              </div>
              </li>
              ...
              <div class="on-off">
                                  ...
                                  <label class="radio-label mr-20" for="b<?php echo $n;?>"><input type="radio" name="breakfirst" id="b<?php echo $n;?>"  value="<?php echo $repast;?>" <?php if($info['breakfirst']==$repast) { ?>checked="checked"<?php } ?>
/><?php echo $repast;?></label>
                                  <?php $n++;}unset($n); } ?>
...
/>
                                  <label class="radio-label mr-20" for="user_repast_v"><input type="text" class="uservalue" data-value="user_repast_v" style="width:70px;border-left:none;border-right:none;border-top:none"  value="<?php if(!in_array($info['breakfirst'],$repasttype) && !empty($info['breakfirst'])) { ?> <?php echo $info['breakfirst'];?><?php } ?>
"></label>
                              </div>
              </div>
              </li>
              ...
              <div class="on-off lh-30">
                                <?php $n=1; if(is_array($computertype)) { foreach($computertype as $computer) { ?>
                                   <label class="radio-label mr-20" for="c<?php echo $n;?>"><input name="computer" type="radio" value="<?php echo $computer;?>" id="c<?php echo $n;?>" <?php if($info['computer']==$computer) { ?>checked="checked"<?php } ?>
/><?php echo $computer;?></label>
                                  <?php $n++;}unset($n); } ?>
...
/>
                                  <label class="radio-label mr-20" for="user_computer_v"><input type="text" class="uservalue" data-value="user_computer_v" style="width:70px;border-left:none;border-right:none;border-top:none"  value="<?php if(!in_array($info['computer'],$computertype) && !empty($info['computer'])) { ?> <?php echo $info['computer'];?><?php } ?>
"></label>
                              </div>
              </div>
              </li>
              ...
              <div class="item-bd">
              <div class="on-off">
                                  <label class="radio-label mr-20"><input type="radio" name="paytype" value="1" <?php if($info['paytype']=='1') { ?>checked="checked"<?php } ?>
 />全款支付</label>
                                  <label class="radio-label mr-20"><input type="radio" name="paytype" value="2" <?php if($info['paytype']=='2') { ?>checked="checked"<?php } ?>
 />定金支付</label>
                                  <span class="mr-10" id="dingjin" style="<?php if($info['paytype'] == '2') { ?>display:inline-block<?php } else { ?>display: none<?php } ?>
"><input type="text" class="input-text w50"  name="dingjin" id="dingjintxt" value="<?php echo $info['dingjin'];?>" size="8" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-\.]+/,'');}).call(this)" onblur="this.v();">&nbsp;元</span>
                                  <label class="radio-label mr-20"><input type="radio" name="paytype" value="3"  <?php if($info['paytype']=='3') { ?>checked="checked"<?php } ?>
 />二次确认支付</label>
                                  <label class="radio-label mr-20"><input type="radio" name="paytype" value="4"  <?php if($info['paytype']=='4') { ?>checked="checked"<?php } ?>
 />线下支付</label>
                                  <script>
...
" data-val="month">按号数</a>
                              ...
                              <div class="price_sub">
                                  <div>
                                      <table class="table">
                                          <tr>
                                              <td class="tit text-r">日期范围：</td><td><input type="text" name="starttime" class="input-text w100 choosetime" value="<?php echo $info['lastoffer']['starttime'];?>"/> <span class="item-text">&nbsp;~&nbsp;</span> <input type="text" class="input-text w100 choosetime" name="endtime" value="<?php echo $info['lastoffer']['endtime'];?>"/></td>
                                          </tr>
                                          <tr>
                                                  ...
                                                  <table class="table">
                                                      <tr class="group_2">
                                                          <td>
                                                              ...
                                                              <input type="text" class="input-text w60 ml-10" name="basicprice" onkeyup="calPrice(this)" value="<?php echo $info['lastoffer']['basicprice'];?>" autocomplete="off">
                                                              <span class="item-text">+利润</span>
                                                              <input type="text" class="input-text w60  ml-10" name="profit" onkeyup="calPrice(this)" value="<?php echo $info['lastoffer']['profit'];?>" autocomplete="off">
                                                              <span class="item-text ml-10">售价：<b style=" color:#f60" class="tprice"><?php echo $info['lastoffer']['price'];?></b></span>
                                                          </td>
                                                      </tr>
                                                 </table>
                                              </td>
                                          ...
                                          <tr>
                                              ...
                                              <td>
                                              <input type="text" class="input-text w300 fl" name="description" value="<?php echo $info['lastoffer']['description'];?>">                                           
                                              </td>
                                          </tr>
                                          <tr>
                                              <td class="tit text-r">库存：</td>
                                              <td><input type="text" class="input-text w100 fl" name="number" maxlength="4" value="<?php echo $info['lastoffer']['number'];?>"> <span class="fl lh-30 c-999 pl-10">-1表示不限</span></td>
                                          </tr>
                                      </table>
                                  </div>
...
<input type="hidden" name="roomid" id="roomid" value="<?php echo $info['id'];?>"/>
                      ...
                      <a class="btn btn-primary radius size-L ml-10" id="btn_view_more" style="<?php if($action=='add') { ?>display:none<?php } ?>
...
$(document).ready(function(){
        ...
        {
            <?php if($action=='edit') { ?>
                var piclist = ST.Modify.getUploadFile(<?php echo $info['piclist_arr'];?>,0);
