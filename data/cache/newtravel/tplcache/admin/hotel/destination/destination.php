...
<table class="content-tab">
    <tr>
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            ...
            <div class="cfg-header-search" id="search_bar">
...
<script>
   ...
   // var otherModule=<?php echo json_encode($allmodule);?>;
                    ...
                    },
                    {
                        ...
                        renderer : function(value, metadata,record) {
                            ...
                            if(id.indexOf('add')==-1)
                            {
                                ...
                                return value+"&nbsp;&nbsp;<font color='orange' margin_padding=s5OzDt >[id:"+id+"]</font>";
                            }
                            return value;
                        },
                        listeners: {
                        ...
                        tpl: new Ext.XTemplate(
                            '{[this.realName(values.id)]}',
                            {
                                realName: function (id) {
                                    ...
                                    return '<a class="btn-link" href="javascript:;" class="row-mod-btn" title="优化设置" onclick="destProductSet(\'' + id + '\')">优化设置</a>'+viewHtml;
                                }
                            }
                        ),
                        listeners: {
    ...
    function destProductSet(dest_id) {
        ...
        ST.Util.showBox('设置',SITEURL+'hotel/admin/destination/dialog_productinfo?id='+id+"&typeid="+display_mode,600,500,null,null,document,{loadCallback:setProductInfo,loadWindow:window});
    }
    //设置模板
