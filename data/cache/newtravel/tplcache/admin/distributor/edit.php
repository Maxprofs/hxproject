...
<head>
    ...
    <?php echo Common::js_plugin('distributor.js','distributor');?>
    <style>
        .error{
            color:red;
            padding-left:5px;
...
<!--                                 <li class="list_dl">
    ...
    if (action == 'edit') {
        ...
        $("#id").val("<?php echo $info['0']['mid'];?>");
        $("#regtype").val("<?php echo $info['0']['regtype'];?>");
        $("#isopen").val('<?php echo $info['0']['isopen'];?>');
        $("#mobile").val("<?php echo $info['0']['mobile'];?>");
        $("#email").val("<?php echo $info['0']['email'];?>");
        $("#nickname").val("<?php echo $info['0']['nickname'];?>");
        $("#phone").val("<?php echo $info['0']['phone'];?>");
        $("#truename").val("<?php echo $info['0']['truename'];?>")
        $("#qq").val("<?php echo $info['0']['qq'];?>");
        $("#wechat").val("<?php echo $info['0']['wechat'];?>");
        $("#province").val("<?php echo $info['0']['province'];?>");
        $("#city").val("<?php echo $info['0']['city'];?>");
        $("#address").val("<?php echo $info['0']['address'];?>");
        $("#lng").val("<?php echo $info['0']['lng'];?>");
        $("#lat").val("<?php echo $info['0']['lat'];?>");
        $(".date").text(formatDateTime(<?php echo $info['0']['jointime'];?>));
        $(".licensepic-link").attr('href', "<?php echo $info['0']['license_pic'];?>");
        $("#licenseimg").attr('src', "<?php echo $info['0']['license_pic'];?>")
        $("#license_pic").val("<?php echo $info['0']['license_pic'];?>");
        $("#createdate").val("<?php echo $info['0']['createdate'];?>");//成立日期
        $("#xinyongdaima").val("<?php echo $info['0']['xinyongdaima'];?>");
        $("#beianhao").val("<?php echo $info['0']['beianhao'];?>");
        $("#companyname").val("<?php echo $info['0']['companyname'];?>");
        $('#idcard').val("<?php echo $info['0']['cardid'];?>");
        $('#frontimg').attr('src', "<?php echo Common::img($info['0']['idcard_pic']['front_pic'],198,123);?>");
        $('.frontpic-link').attr('href', "<?php echo Common::img($info['0']['idcard_pic']['front_pic'],198,123);?>");
        $('#front_pic').val("<?php echo Common::img($info['0']['idcard_pic']['front_pic'],198,123);?>");
        $('#versoimg').attr('src', "<?php echo Common::img($info['0']['idcard_pic']['verso_pic'],198,123);?>");
        $('.versopic-link').attr('href', "<?php echo Common::img($info['0']['idcard_pic']['verso_pic'],198,123);?>");
        $('#verso_pic').val("<?php echo Common::img($info['0']['idcard_pic']['verso_pic'],198,123);?>");
    }
    if (action == 'add') {
