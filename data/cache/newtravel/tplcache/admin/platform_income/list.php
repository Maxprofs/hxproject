...
<head>
    <meta charset="utf-8">
    <title>供应商收入审核-笛卡CMS<?php echo $coreVersion;?></title>
            ...
            <div class="cfg-search-bar">
                <div class="fl select-box w100 mt-3 ml-10">
                    <select name="typeid" onchange="togTypeids(this)" class="select">
                        ...
                        <?php $n=1; if(is_array($modules)) { foreach($modules as $row) { ?>
                ...
                <div class="fl select-box w150 mt-3 ml-10">
                    <select name="paysource" onchange="togPaysource(this)" class="select">
                        ...
                        <?php $n=1; if(is_array($pay_sources)) { foreach($pay_sources as $v) { ?>
                        <option value="<?php echo $v['paysource'];?>"><?php echo $v['paysource'];?></option>
                        <?php $n++;}unset($n); } ?>
                    </select>
                </div>
                <div class="fl select-box w150 mt-3 ml-10">
                    <select name="status" onchange="togStatus(this)" class="select">
                        ...
                        <?php $n=1; if(is_array($account_status)) { foreach($account_status as $k => $v) { ?>
...
<script>
    ...
    function view(id) {
        ...
        var url=SITEURL+"income/admin/income/view/<?php if(isset($_GET['menuid'])) { ?>menuid/<?php echo $_GET['menuid'];?>/<?php } ?>
id/"+id;
