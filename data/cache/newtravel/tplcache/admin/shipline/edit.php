...
<tr>
    ...
    <span class="item on" id="column_basic" onclick="Product.switchTabs(this,'basic')">基础信息</span>
                <?php $n=1; if(is_array($columns)) { foreach($columns as $col) { ?>
                    <span class="item" id="column_<?php echo $col['columnname'];?>" onclick="Product.switchTabs(this,'<?php echo $col['columnname'];?>',switchBacks)"><?php echo $col['chinesename'];?></span>
                <?php $n++;}unset($n); } ?>    
    ...
    <a href="javascript:;" class="fr btn btn-primary radius mt-6 mr-10" onclick="window.location.reload()">刷新</a>
            ...
            <div class="manage-nr">
                ...
                <div class="item-bd">
                <input type="text" name="title" data-required="true" class="input-text w700" value="<?php echo $info['title'];?>"/>
...
><?php echo $supplier['suppliername'];?></option>
                ...
                <select class="select" name="shipid" id="shipid_sel">
                                        ...
                                        <option value="<?php echo $ship['id'];?>" <?php if($info['shipid']==$ship['id']) { ?>selected="selected"<?php } ?>
><?php echo $ship['title'];?></option>
                                        <?php $n++;}unset($n); } ?>
                                    </select>
                </span>
                </div>
                ...
                <select class="select" name="scheduleid" id="shipdate_sel">
                                    ...
                                    <?php $n=1; if(is_array($schedulelist)) { foreach($schedulelist as $schedule) { ?>
                                      <option value="<?php echo $schedule['id'];?>" <?php if($info['scheduleid']==$schedule['id']) { ?>selected="selected"<?php } ?>
><?php echo $schedule['title'];?></option>
                                    <?php $n++;}unset($n); } ?>
                                </select>
                </span>
                </div>
                ...
                <div class="save-value-div mt-2 ml-10 attr-sel w700">
                                    ...
                                    <span class="mb-5"><s onclick="$(this).parent('span').remove()"></s><?php echo $v['attrname'];?><input type="hidden" name="attrlist[]" value="<?php echo $v['id'];?>"></span>
                                    <?php $n++;}unset($n); } ?>
                                </div>
                </div>
                </li>
...
<div class="item-bd">
<input type="text" value="<?php echo $info['lineday'];?>" data-regrex="number" data-required="true" data-msg="必须为数字" id="travel_days" class="input-text w60" name="lineday" onblur="switchBack()"/>
<span class="item-text ml-10">*天</span>
<input type="text" value="<?php echo $info['linenight'];?>" data-regrex="number" data-msg="必须为数字" class="input-text w60 ml-10" name="linenight"/>
...
<div class="temp-chg">
                    ...
                    <textarea class="ml-80" name="jieshao" id="simple_jieshao"><?php echo $info['jieshao'];?></textarea>
                    </div>
                ...
                <ul class="info-item-block">
                        ...
                        <div class="item-bd">
                                <textarea id="visacontent" name="visacontent"><?php echo $info['visacontent'];?></textarea>
                            </div>
                        </li>
                   </ul>    
                </div>
                ...
                <div class="item-bd">
                <textarea id="bookcontent" name="bookcontent"><?php echo $info['bookcontent'];?></textarea>
                </div>
                </li>
                </ul>
                </div>
...
<div class="up-list-div">
  ...
  href="javascript:void(0)" data-value="<?php echo $r['path'];?>" onclick="setTemplet(this)"><?php echo $r['templetname'];?></a>
                ...
                <div class="item-bd"><input type="text" name="color" value="<?php echo $info['color'];?>" class="input-text w100"/></div>
                </li>
                <li>
                <span class="item-hd">热度基数：</span>
                <div class="item-bd">
                <span class="item-text fl">推荐次数</span>
                                <input type="text" name="recommendnum" value="<?php echo $info['recommendnum'];?>" data-regrex="number" data-msg="*必须为数字" class="input-text w60 ml-5 mr-20 fl"/>
                                <span class="item-text fl">满意度</span>
                                <input type="text" name="satisfyscore" value="<?php echo $info['satisfyscore'];?>" data-regrex="number" data-msg="*必须为数字" class="input-text w60 ml-5 mr-20 fl"/>
                                <span class="item-text fl">销量</span>
                                <input type="text" name="bookcount" value="<?php echo $info['bookcount'];?>" data-regrex="number" data-msg="*必须为数字" class="input-text w60 ml-5 mr-20 fl"/>
                </div>
                </li>
                <li>
