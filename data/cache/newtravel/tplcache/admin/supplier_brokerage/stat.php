...
<head>
    <meta charset="utf-8">
    <title color_head=ZsACXC >线路订单管理-笛卡CMS<?php echo $coreVersion;?></title>
            ...
            <td valign="top" class="content-rt-td" style="overflow:hidden">
                <div class="cfg-header-bar">
                    <div class="cfg-header-order-info">
                        <span class="item">总计可提金额：<span class="c-f60">&yen;<?php echo $price_arr['allow_price'];?></span></span>
                        <span class="item">累积已提金额：<span class="c-f60">&yen;<?php echo $price_arr['withdraw_price_finish'];?></span></span>
                        <span class="item">总计申请中金额：<span class="c-f60">&yen;<?php echo $price_arr['withdraw_price_approval'];?></span></span>
                    </div>
                ...
                <div class="cfg-search-bar">
                    <div class="fl select-box w100 mt-2 ml-10">
                        <select name="webid" onchange="togStatus(this)"  class="select">
                            ...
                            <?php $n=1; if(is_array($supplierkind)) { foreach($supplierkind as $supplier) { ?>
                            <option value="<?php echo $supplier['id'];?>"><?php echo $supplier['kindname'];?></option>
                            <?php $n++;}unset($n); } ?>
                        </select>
                    </div>
    ...
    function () {
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    read: SITEURL+'supplier_brokerage/admin/brokerage/stat/action/read/',  //读取数据的URL
                    update: SITEURL+'supplier_brokerage/admin/brokerage/stat/action/save/',
                    destroy: SITEURL+'supplier_brokerage/admin/brokerage/stat/action/delete/'
                },
                reader: {
                    type: 'json',   //获取数据的格式
                    root: 'lists',
