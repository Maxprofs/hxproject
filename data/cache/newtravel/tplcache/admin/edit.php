                  ...
                  <div class="product-add-div">
                      ...
                      <ul class="info-item-block">
                          <li>
                              ...
                              <div class="item-bd">
                                  <input type="text" name="name" id="name" class="input-text w300"  value="<?php echo $info['name'];?>" />
                          ...
                          <li>
                               ...
                               <div class="item-bd">
                                   <label class="radio-label"><input type="radio" name="isopen" value="1" <?php if($info['isopen']==1) { ?> checked="checked"<?php } ?>
 >开启</label>
                                   <label class="radio-label ml-20"><input type="radio"  name="isopen" value="0" <?php if($info['isopen']==0) { ?> checked="checked"<?php } ?>
 >关闭</label>
                               </div>
                           </li>
                          <li>
                              ...
                              <div class="item-bd">
                                  <label class="radio-label"><input class="radio_check" type="radio" name="type" value="0" <?php if($info['type']==0) { ?> checked="checked"<?php } ?>
 >固定金额</label>
                                  <input type="text" name="amount[0]" id="amount0" class="input-text w100 mr-5" value="<?php if($info['type']==0) { ?> <?php echo $info['amount'];?> <?php } ?>
" />元
                                  <label class="radio-label ml-20"><input class="radio_check" type="radio" name="type"  <?php if($info['type']==1) { ?> checked="checked"<?php } ?>
  value="1">折扣比</label>
                                  <input type="text" name="amount[1]" id="amount1" class="input-text w100 mr-5" value="<?php if($info['type']==1) { ?> <?php echo $info['amount'];?> <?php } ?>
" />折
                          ...
                          <li>
                               ...
                               <div class="item-bd">
                                   ...
                                   <input type="text" name="samount" id="samount" class="input-text w100 mr-5" value="<?php if($info['samount']) { ?><?php echo $info['samount'];?><?php } else { ?>0<?php } ?>
" />可用
                          ...
                          <li>
                              ...
                              <div class="item-bd">
                                  <label class="radio-label"><input  type="radio"   class="radio_check"  name="isnever" value="0" <?php if($info['isnever']==0) { ?> checked="checked"<?php } ?>
  >永久有效</label>
                                  <label class="radio-label ml-20"><input type="radio" class="radio_check"  name="isnever" <?php if($info['isnever']==1) { ?> checked="checked"<?php } ?>
  value="1">区间内有效</label>
                                  <span <?php if($info['isnever']==0) { ?> style="display:none"<?php } ?>
 class="isneverspan item-text va-t ml-5">
                                      <input type="text" name="starttime" id="starttime" class="input-text w200 choosetime" value="<?php echo $info['starttime'];?>" />
                                      <span>—</span>
                                      <input type="text" name="endtime" id="endtime" class="input-text w200 choosetime" value="<?php echo $info['endtime'];?>" />
                                      <span class="item-text c-999 ml-10">*必填</span>
                                  </span>
                              </div>
                          </li>
                          <li>
                              ...
                              <div class="item-bd">
                                  <input type="text" name="totalnumber" id="totalnumber" class="input-text w100"  value="<?php echo $info['totalnumber'];?>" />&nbsp;张&nbsp;&nbsp; <span class="item-text c-999">*设置此优惠券的总数量，领取完后则不能再领取</span>
                              </div>
                          </li>
                          <li>
                              <span class="item-hd">用户最多领取：</span>
                              <div class="item-bd">
                                  <input type="text" name="maxnumber" id="maxnumber" class="input-text w100"  value="<?php if($info['maxnumber']) { ?><?php echo $info['maxnumber'];?><?php } else { ?>1<?php } ?>
" />&nbsp;张&nbsp;&nbsp; <span class="item-text c-999">*设置每个账号最多可以领取多少张优惠券，默认为1张</span>
                              </div>
                          </li>
                      </ul>
                  </div>
                          ...
                          <li>
                              ...
                              <div class="item-bd">
                                  <label class="radio-label">
                                      <input type="radio" name="kindid" value="1" <?php if($info['kindid']!=2) { ?> checked="checked"<?php } ?>
 >免费领取
                                  </label>
                                  <label class="radio-label ml-20">
                                      <input type="radio" name="kindid" value="2" <?php if($info['kindid']==2) { ?> checked="checked"<?php } ?>
 >积分兑换
                                  </label>
                                  <input type="text" name="needjifen" id="needjifen" class="input-text w100 ml-5" value=" <?php echo $info['needjifen'];?> " />
                          ...
                          <li>
                              ...
                              <div class="item-bd">
                                  <?php $n=1; if(is_array($member_grades)) { foreach($member_grades as $grade) { ?>
                                  <label class="check-label mr-20">
                                      <input type="checkbox" name="membergrade[]" value="<?php echo $grade['id'];?>" <?php if(in_array($grade['id'],$info['memeber_grades'])||!$info['memeber_grades']) { ?>  checked <?php } ?>
  ><?php echo $grade['name'];?>
                                  </label>
                                  <?php $n++;}unset($n); } ?>
                              </div>
                      ...
                      <div class="order-info-bar"><strong class="bt-bar">使用条件</strong></div>
                          <ul class="info-item-block">
                             <li>
                                 ...
                                 <div class="item-bd">
                                     <input type="text" name="antedate" id="antedate" class="input-text w100" value="<?php if($info['antedate']) { ?><?php echo $info['antedate'];?><?php } else { ?>0<?php } ?>
" />
                              ...
                              <li>
                                  ...
                                  <div class="item-bd">
                                      <div>
                                          <label class="radio-label"><input type="radio" name="typeid" value="0" <?php if($info['typeid']==0) { ?> checked <?php } ?>
>所有产品</label>
                                          <span class="item-text c-999 ml-10">*默认所有产品可用，设置为所有产品则可以在所有产品中使用</span>
                                      </div>
                                      <div class="clearfix">
                                          <label class="radio-label"><input class="radio_check" type="radio" name="typeid" value="1" <?php if($info['typeid']==1) { ?> checked <?php } ?>
> 按产品类</label>
                                          <div class="typeid_1" <?php if($info['typeid']!=1) { ?> style="display: none" <?php } else { ?> style="display: inline-block" <?php } ?>
>
                                          ...
                                          <div style="display: inline-block; float: none" class="save-value-div ml-10 modules-sel">
                                              <?php $n=1; if(is_array($info['modules'])) { foreach($info['modules'] as $module) { ?>
                                              <span style="display: inline-block; float: none"><s onclick="$(this).parent('span').remove()"></s><?php echo $module['modulename'];?><input type="hidden" name="models[]" value="<?php echo $module['id'];?>"></span>
                                              <?php $n++;}unset($n); } ?>
                                          </div>
                                      </div>
                                  </div>
                                  <div>
                                      <label class="radio-label"><input type="radio" name="typeid" value="9999" <?php if($info['typeid']==9999) { ?> checked <?php } ?>
> 指定产品</label>
                                      <div class="typeid_9999" <?php if($info['typeid']!=9999) { ?>  style="display: none" <?php } else { ?> style="display: inline-block" <?php } ?>
 >
                                  ...
                                  <div class="apply-tab-wrap typeid_9999" <?php if($info['typeid']!=9999) { ?>  style="display: none" <?php } else { ?> style="display:block" <?php } ?>
>
                                      ...
                                      <div class="item-nr">
                                          <span class="select-box w200">
                                              <select id="search_typeid" class="select" onchange="togStatus(this)">
                                                  ...
                                                  <?php $n=1; if(is_array($models)) { foreach($models as $m) { ?>
                                                  <option value="<?php echo $m['id'];?>"> <?php echo $m['modulename'];?></option>
                                                  <?php $n++;}unset($n); } ?>
                                              </select>
                                          </span>
                  ...
                  <div class="clear clearfix pt-20 pb-20">
                      <input type="hidden" name="couponid" id="couponid" value="<?php echo $info['id'];?>"/>
