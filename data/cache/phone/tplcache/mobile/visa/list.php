...
<body>
            ...
            <ul class="st-list-group visa-list" id="product_list">
                ...
                <li class="first-li">
                    <a id="des" href="javascript:;">
                        <div class="pic"><img src="<?php echo $area['litpic'];?>" alt="" title="<?php echo $area['kindname'];?>"></div>
                        <div class="nr">
                            <p class="bt"><?php echo $area['kindname'];?></p>
                            <p class="des"><?php echo $area['summary'];?></p>
                            <p class="ico"></p>
                        </div>
                    </a>
                </li>
    ...
    <?php echo Request::factory("visa/searchnav")->execute()->body(); ?>
    <?php echo Request::factory("pub/code")->execute()->body(); ?>
    
    <div id="introduce" class="introduce">
    <div class="des">
    <?php echo $area['jieshao'];?>
    </div>
    ...
    <script>
        ...
        {
            var params={
                area:"<?php echo $areapy;?>",
                cityid:'<?php echo $cityid;?>',
                keyword:'<?php echo $keyword;?>',
                visatype:'<?php echo $visatype;?>',
                page:'<?php echo $page;?>'
            };
            return params;
        }
