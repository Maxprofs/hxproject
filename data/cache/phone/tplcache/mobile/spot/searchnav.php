...
<div id="filter-page" class="filter-page first-floor">
    ...
    <div class="filter-item">
        <div class="hd">
            <ul>
                <li data-sub="priceid" class="active">价格</li>
        ...
        <div class="bd">
            ...
            <ul id="sub_priceid">
                ...
                <?php $spot_tag = new Taglib_Spot();if (method_exists($spot_tag, 'price_list')) {$data = $spot_tag->price_list(array('action'=>'price_list',));}?>
...
<script>
    $(document).ready(function(){
        ...
        $("#filter_back_btn").click(function(){
            $(".filter-item .bd ul").each(function (index,e) {
                $(e).find("li.active").removeClass('active');
                var obj=$(e).find("li").eq(0);
                //obj.addClass('active');
                var field = obj.attr('selfield');
                var id = obj.data('id');
        ...
        function get_next_dests(pinyin,isparent)
        {
            ...
            $.ajax({
                url:SITEURL+'spot/ajax_get_next_dests',
                type:'POST',
                data:{
                    destpy:pinyin,
                    typeid:typeid,
