...
<head>
    ...
    <?php echo Common::css('base.css,question.css');?>
    <?php echo Common::js('lib-flexible.js,Zepto.js,template.js');?>
</head>
<body>
    ...
    <div class="hold-bottom-bar">
        <div class="bottom-fixed">
            <a class="wask" href="<?php echo $cmsurl;?>questions/add">我要提问</a>
        </div>
    </div>
    <!-- 我要提问 -->
    <script type="text/html" id="tpl_question_list">
        ...
        <ul class="item-ul clearfix">
            ...
            <li class="clearfix">
                ...
                <div class="txt cleafix">{{#value.replycontent}}</div>
            </li>
        </ul>
        {{/each}}
    </script>
