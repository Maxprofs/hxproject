<?php if(defined('SHAREWXCLIENT') && strpos($_SERVER['HTTP_USER_AGENT'], 'MicroMessenger') !== false) { ?>
<?php if($info['litpic']) { ?>
<img id="wx_litpic" src="<?php echo $info['litpic'];?>" style="display:none" width="0" height="0">
<?php } ?>
