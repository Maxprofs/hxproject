...
<head size_background=zeaorl >
    ...
    <?php echo Common::css('style-new.css,mobilebone.css,swiper.min.css');?>
...
<div id="pageHome" class="page out">
    ...
    <div class="page-content">
        <div class="comment-info-bar">
            <div class="myd">
                <span class="sz"><?php echo $info['number']['satisfyscore'];?></span>
                <span class="wz">满意度</span>
            </div>
            <div class="attr">
                <a class="active" data-flag="all" href="javascript:;">全部(<?php echo $info['number']['total'];?>)</a>
                <a data-flag="pic" href="javascript:;">有图(<?php echo $info['number']['picnum'];?>)</a>
                <a data-flag="well" href="javascript:;">好评(<?php echo $info['number']['wellnum'];?>)</a>
                <a data-flag="mid" href="javascript:;">中评(<?php echo $info['number']['midnum'];?>)</a>
                <a data-flag="bad" href="javascript:;">差评(<?php echo $info['number']['badnum'];?>)</a>
            </div>
        </div>
...
<?php echo Common::js('jquery.min.js,mobilebone.js,swiper.min.js,template.js');?>
