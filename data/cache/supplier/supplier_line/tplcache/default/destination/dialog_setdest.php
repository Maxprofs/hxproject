...
<head>
    ...
    <?php echo Common::js('jquery.min.js,artDialog/dist/dialog-plus.js,jquery.colorpicker.js,common.js,choose.js,product.js,uploadify/uploadify.js');?>
</head>
<body >
   <div class="s-main">
       <div class="s-search">
       ...
       <div class="s-final">
        <!--   <table><tr><td width="15%">最终目的地：</td><td></td><td class="c-999 item-text"></td></tr></table>-->
