...
<head>
<meta charset="utf-8">
<title>线路产品管理-<?php echo $webname;?></title>
 ...
 <div class="page-box">
    <table class="main-tb" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="side-td">
                <div class="side-menu">
                    <dl class="order">
                        ...
                        <dd>
                            <a href="<?php echo $cmsurl;?>index/list" id="nav_line_list" class="on" target="frm">线路列表</a>
                            <a href="<?php echo $cmsurl;?>order/all" id="nav_line_order" target="frm">线路订单</a>
                        </dd>
                    </dl>
            ...
            <td>
              <div class="panel">
                    <iframe src="<?php echo $cmsurl;?>index/list" name="frm">
                    </iframe>
              </div>
          </td>
        </tr>
