                ...
                <div class="pm-tabcon-list" id="productList">
                    <table class="pm-table-list" width="100%" border="0">
                        ...
                        <tr class="pl-tr" id="product_<?php echo $row['id'];?>">
                            ...
                            <td width="15%" align="center"><div class="pm-table-boxs"><?php if($row['suitday']) { ?><span class="color-grey"><?php echo $row['suitday'];?></span><?php } else { ?><span class="color-red">无报价</span><?php } ?>
</div></td>
                            ...
                            <td width="10%" align="center">
                                <div class="pm-table-boxs">
                                    ...
                                    <a href="javascript:void(0)" class="pm-clone-btn" onclick="goClone('<?php echo $row['id'];?>')"  title="克隆"></a>
                                </div>
                            </td>
                        </tr>
                        <?php $n++;}unset($n); } ?>
