...
<head>
    ...
    <?php echo Common::css('admin_base.css,admin_base2.css,admin_style.css,style.css,destination_dialog_setdest.css,base_new.css');?>
    <?php echo Common::css('public/js/uploadify/uploadify.css,public/js/artDialog/css/ui-dialog.css');?>
    <?php echo Common::js('artDialog/dist/dialog-plus.js,jquery.colorpicker.js,common.js,choose.js,product.js,uploadify/uploadify.js');?>
</head>
<body>
<div class="s-main">
    <div class="s-search">
    ...
    <div class="s-chosen">
        ...
        <div class="chosen-con" id="selected_place">
            ...
            <?php if($place['id']==$startplaceid) { ?>
            <span class="chosen-one" id="chosen_item_<?php echo $place['id'];?>" data-id="<?php echo $place['id'];?>"><label class="lb-tit"><?php echo $place['cityname'];?></label><a
    ...
    <div class="s-list" id="content_area">
        <div class="con-one" step="1">
            <ul>
                <li>
                    <?php $n=1; if(is_array($startplacetop)) { foreach($startplacetop as $place) { ?>
                    <span class="dest-item choose-child-item" id="chosen_item_<?php echo $place['pid'];?>"
                          data-pid="<?php echo $place['pid'];?>" data-id="<?php echo $place['id'];?>">
                        <label class="lb-tit"><?php echo $place['cityname'];?></label>
                        <a class="lb-num num-len1" href="javascript:;" data-rel="<?php echo $place['id'];?>"><?php echo $place['num'];?></a>
                    </span>
                    <?php $n++;}unset($n); } ?>
                    <div class='clear-both'></div>
                </li>
