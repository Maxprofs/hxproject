...
<head>
    ...
    <?php echo Common::js('jquery.min.js,artDialog/dist/dialog-plus.js,msgbox/msgbox.js,jquery.colorpicker.js,DatePicker/WdatePicker.js,common.js,product.js,choose.js');?>
    <style>
        *{
            padding:0px;
            margin:0}
