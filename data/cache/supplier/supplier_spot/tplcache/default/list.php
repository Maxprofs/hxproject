...
<head>
<meta charset="utf-8">
<title>景点门票列表-<?php echo $webname;?></title>
                  ...
                  <?php if(!empty($list)) { ?>
                    <table class="pm-table-list" width="100%" border="0">
                      ...
                      <tr class="pl-tr">
                        ...
                        <td width="30%"><div class="pm-table-boxs"><?php echo $row['title'];?></div></td>
                       <td width="30%"><div class="pm-table-boxs"><a class="pm-table-bt" href="<?php echo $row['url'];?>" target="_blank"><?php echo $row['productname'];?></a></div></td>
                        <td width="15%" align="center">
                            <div class="pm-table-boxs" data-id="<?php echo $row['id'];?>">
                                <?php if($row['status']==0) { ?>
                                <span class="sup-status-label edit" onclick="goCheck('<?php echo $row['id'];?>')" title="当前产品为编辑状态"></span>
                                ...
                                <?php } else { ?>
                                <span id="statusNotPass" class="sup-status-label not statusNotPass" data-msg="<?php echo $row['refuse_msg'];?>" title="未通过"></span>
                                <?php } ?>
                            </div>
                        </td>
                        <td width="10%" align="center">
                          <div class="pm-table-boxs">
                            <a href="<?php echo $cmsurl;?>index/suit_edit?id=<?php echo $row['id'];?>" class="pm-delete-btn" title="编辑"></a>
