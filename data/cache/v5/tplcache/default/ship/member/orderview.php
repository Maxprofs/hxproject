...
"> <em></em> <strong></strong> <span><?php echo __('已退款');?></span> </li> </ul> </div> <?php } ?> <div class="speed-show-list"> <?php $log_list = Model_Member_Order_Log::get_list($info['id']);?> <ul class="info-list" style="height: 52px;"> <?php $n=1; if(is_array($log_list)) { foreach($log_list as $log) { ?> <li><span><?php echo date('Y-m-d H:i:s',$log['addtime']);?></span><span><?php echo $log['description'];?></span></li> <?php $n++;}unset($n); } ?> </ul> <?php if(count($log_list)>2) { ?> <div id="more-info" class="more-info down"><?php echo __('展开详细进度');?></div> <?php } ?> </div> </div> <!-- 订单进度 --> <div class="os-term"> <div class="os-tit"><?php echo __('联系人信息');?></div> <div class="os-block"> <div class="linkman-info clearfix"> <div class="item-block"> <em><?php echo __('联系人');?>：</em> <p><?php echo $info['linkman'];?></p> </div> <div class="item-block"> <em><?php echo __('手机号');?>：</em> <p><?php echo $info['linktel'];?></p> </div> <div class="item-block"> <em><?php echo __('邮箱');?>：</em> <p><?php echo $info['linkemail'];?></p> </div> <?php if(!empty($info['remark'])) { ?> <div class="item-block bz"> <em><?php echo __('备注');?>：</em> <p><?php echo $info['remark'];?></p> </div> <?php } ?> </div> </div> </div> <?php if(!empty($tourlist)) { ?> <div class="os-term"> <div class="os-tit"><?php echo __('游客信息');?></div> <div class="os-block"> <div class="user-bm-info"> <ul class="clearfix"> <?php $n=1; if(is_array($tourlist)) { foreach($tourlist as $k => $t) { ?> <li class="<?php if(($k+1)%4==0) echo 'mr_0';?>"> <p><em><?php echo __('姓名');?>：</em><span><?php echo $t['tourername'];?></span></p> <p><em><?php echo __('证件类型');?>：</em><span><?php echo $t['cardtype'];?></span></p> <p><em><?php echo __('证件号码');?>：</em><span><?php echo $t['cardnumber'];?></span></p> </li> <?php $n++;}unset($n); } ?> </ul> </div> </div> </div> <?php } ?> <?php require_once ("E:/wamp64/www/taglib/member.php");$member_tag = new Taglib_Member();if (method_exists($member_tag, 'order_bill')) {$bill = $member_tag->order_bill(array('action'=>'order_bill','orderid'=>$info['id'],'return'=>'bill',));}?> <?php if(!empty($bill)) { ?> <div class="os-term"> <div class="os-tit"><?php echo __('发票信息');?></div> <div class="os-block"> <div class="order-show-invoice"> <ul> <li><em><?php echo __('发票明细');?>：</em><?php echo __('旅游费');?></li> <li><em><?php echo __('发票金额');?>：</em><i class="currency_sy"><?php echo Currency_Tool::symbol();?></i><?php echo $info['payprice'];?></li> <li><em><?php echo __('发票抬头');?>：</em><?php echo $bill['title'];?></li> <li><em><?php echo __('收件人');?>：</em><?php echo $bill['receiver'];?></li> <li><em><?php echo __('联系电话');?>：</em><?php echo $bill['mobile'];?></li> <li><em><?php echo __('收货地址');?>：</em><?php echo $bill['province'];?> <?php echo $bill['city'];?> <?php echo $bill['address'];?></li> </ul> </div> </div> </div> <?php } ?> <!-- 发票信息 --> <?php if(!empty($info['iscoupon'])|| !empty($info['usejifen'])) { ?> <div class="os-term"> <div class="os-tit"><?php echo __('优惠信息');?></div> <div class="os-block"> <div class="order-show-cheap"> <ul> <?php if(!empty($info['iscoupon'])) { ?> <li><em><?php echo __('优惠券');?>：</em><i class="currency_sy"><?php echo Currency_Tool::symbol();?></i><?php echo $info['iscoupon']['cmoney'];?>（<?php echo $info['iscoupon']['name'];?>）</li> <?php } ?> <?php if($info['usejifen']) { ?> <li><em><?php echo __('积分抵现');?>：</em><i class="currency_sy"><?php echo Currency_Tool::symbol();?></i><?php echo $info['jifentprice'];?></li> <?php } ?> </ul> </div> </div> </div> <?php } ?> <!-- 优惠信息 --> <div class="os-term"> <div class="os-tit"><?php echo __('支付信息');?></div> <div class="os-block"> <div class="order-show-cheap"> <ul> <li><em><?php echo __('支付方式');?>：</em><?php echo $info['paytype_name'];?> &nbsp;<?php if($info['paytype']==2) { ?>(<?php echo $info['dingjin'];?>/<?php echo __('间');?>)<?php } ?> </li> <?php if($GLOBALS['cfg_order_agreement_open']==1&&!empty($GLOBALS['cfg_order_agreement_title'])) { ?> <li><em><?php echo __('预定协议');?>：</em><span class="check-ht" id="agreement_btn">《<?php echo $GLOBALS['cfg_order_agreement_title'];?>》</span></li> <?php } ?> </ul> </div> </div> </div> <?php if($info['refund']) { ?> <div class="os-term"> <div class="os-tit">退款信息</div> <div class="os-block"> <div class="order-show-cheap"> <ul> <li><em>返款方式：</em><?php echo $info['refund']['platform'];?></li> <?php if($info['refund']['alipay_account']) { ?> <li><em>退款账号：</em><?php echo $info['refund']['alipay_account'];?></li> <?php } ?> <?php if($info['refund']['cardholder']) { ?> <li><em>持卡人：</em><?php echo $info['refund']['cardholder'];?></li> <?php } ?> <?php if($info['refund']['bank']) { ?> <li><em>开户行：</em><?php echo $info['refund']['bank'];?></li> <?php } ?> <?php if($info['refund']['cardnum']) { ?> <li><em>银行卡号：</em><?php echo $info['refund']['cardnum'];?></li> <?php } ?> <li><em>退款金额：</em><?php echo $info['refund']['refund_fee'];?></li> <li style="height: auto;"><em>退款原因：</em><?php echo $info['refund']['refund_reason'];?></li> <?php if($info['refund']['description']) { ?> <li><em>处理结果：</em><?php echo $info['refund']['description'];?></li> <?php } ?> </ul> </div> </div> </div> <?php } ?> <!-- 支付信息 --> <?php if(!empty($info['eticketno']) && Product::is_app_install('stourwebcms_app_supplierverifyorder')) { ?> <div class="os-term"> <div class="os-tit"><?php echo __('消费码');?></div> <div class="os-block"> <div class="order-show-code"> <p class="txt"><em><?php echo __('短信消费码');?>：</em><?php echo $info['eticketno'];?></p> <div class="pic"><img src="/res/vendor/qrcode/make.php?param=<?php echo $info['eticketno'];?>"></div> </div> </div> </div> <?php } ?> <!-- 消费码 --> <div class="os-term"> <div class="os-tit"><?php echo __('订单信息');?></div> <div class="os-block"> <div class="order-show-info"> <table width="100%" border="0" class="order-show-table"> <tr> <th width="26%" height="40" scope="col"><span class="l-con"><?php echo __('房型名称');?></span></th> <th width="17%" scope="col"><?php echo __('出行日期');?></th> <th width="17%" scope="col"><?php echo __('结束日期');?></th> <th width="10%" scope="col"><?php echo __('单价/间');?></th> <th width="10%" scope="col"><?php echo __('房间数');?></th> <th width="10%" scope="col"><?php echo __('人数');?></th> <th width="10%" scope="col"><?php echo __('总价');?></th> </tr> <?php $n=1; if(is_array($sublist)) { foreach($sublist as $sub) { ?> <tr> <td height="40"><span class="l-con"><?php echo $sub['title'];?></span></td> <td><?php echo $info['usedate'];?></td> <td><?php echo $info['departdate'];?></td> <td><?php echo $sub['price'];?></td> <td><?php echo $sub['dingnum'];?></td> <td><?php echo $sub['peoplenum'];?></td> <td><span class="jg"><i class="currency_sy"><?php echo Currency_Tool::symbol();?></i><?php echo intval($sub['price']) * intval($sub['dingnum']);?></span></td> </tr> <?php $n++;}unset($n); } ?> </table> </div> </div> </div> <!-- 订单信息 --> <div class="order-item-count clearfix"> <div class="item-nr"> <div class="item-list"><strong class="hd"><?php echo __('商品总额');?>：</strong><span class="jg"><i class="currency_sy"><?php echo Currency_Tool::symbol();?></i><?php echo $info['totalprice'];?></span></div> <div class="item-list"><strong class="hd"><?php echo __('商品优惠');?>：</strong><span class="jg">-<?php echo Currency_Tool::symbol();?><?php echo $info['privileg_price'];?></span></div> <hr> <div class="item-total"><strong class="hd"><?php echo __('应付总额');?>：</strong><span class="jg"><i class="currency_sy"><?php echo Currency_Tool::symbol();?></i><?php echo $info['actual_price'];?></span></div> <?php if($info['paytype']==2) { ?> <div class="item-way">(<?php echo __('到店支付');?> <i class="currency_sy"><?php echo Currency_Tool::symbol();?></i><?php echo $info['actual_price']-$info['payprice']; ?> + <?php echo __('定金支付');?> <i class="currency_sy"><?php echo Currency_Tool::symbol();?></i><?php echo $info['payprice'];?>)</div> <?php } ?> </div> </div> <div class="condition-col"> <span class="item-child"><?php if($info['paytype']==2) { ?><?php echo __('定金支付');?><?php } else { ?><?php echo __('应付总额');?><?php } ?>
：<strong class="jg"><i class="currency_sy"><?php echo Currency_Tool::symbol();?></i><?php echo $info['payprice'];?></strong></span> <?php if($info['status']=='1') { ?> <a class="pay-btn fr" href="javascript:;"><?php echo __('立即付款');?></a> <?php } ?> <?php if($info['status']==5 && $info['ispinlun']!=1) { ?> <a class="pl-btn fr" href="javascript:;"><?php echo __('立即评论');?></a> <?php } ?> </div> <!-- 支付结算 --> </div> <div class="agreement-term-content" style="display: none;"> <div class="agreement-term-tit"><strong><?php echo $GLOBALS['cfg_order_agreement_title'];?></strong><i class="close-ico" onclick="$(this).parents('.agreement-term-content').hide();"></i></div> <div class="agreement-term-block"> <h3 class="agreement-bt">《<?php echo $GLOBALS['cfg_order_agreement_title'];?>》</h3> <div class="agreement-nr"> <?php echo $GLOBALS['cfg_order_agreement'];?> </div> </div> </div> <script>
    ...
    $(function () {
        ...
        $("#apply-refund-Click").on("click", function () {
            parent.layer.open({
                ...
                title: "申请退款",
                area: ['560px','570px'],
                content: '<?php echo $cmsurl;?>ship/member/order_refund?ordersn=<?php echo $info['ordersn'];?>',
                btn: ['确认', '取消'],
                btnAlign: 'C',
                closeBtn: 0,
    ...
    function refund_status(data) {
        $.post('<?php echo $GLOBALS["cfg_basehost"];?>/ship/member/ajax_order_refund', data, function (result) {
            parent.layer.open({
    ...
    function refund_status(data) {
        $.post('<?php echo $GLOBALS["cfg_basehost"];?>/ship/member/ajax_order_refund_back', data, function (result) {
            parent.layer.open({
                content: result.message,
                btn: ['<?php echo __("OK");?>'],
                end:function(){
