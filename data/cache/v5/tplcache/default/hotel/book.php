<?php defined('SYSPATH') or die();?> <!doctype html> <html> <head> <meta charset="utf-8"> <title>预订<?php echo $info['title'];?>-<?php echo $GLOBALS['cfg_webname'];?></title> <?php echo  Stourweb_View::template("pub/varname");  ?> <?php echo Common::css_plugin('hotel.css','hotel');?> <?php echo Common::css('base.css,extend.css,stcalendar.css');?> <?php echo Common::js('jquery.min.js,base.js,common.js,SuperSlide.min.js,jquery.validate.js,jquery.validate.addcheck.js');?> </head> <body> <?php echo Request::factory("pub/header")->execute()->body(); ?> <div class="big"> <div class="wm-1200"> <div class="st-guide"> <a href="<?php echo $cmsurl;?>"><?php echo $GLOBALS['cfg_indexname'];?></a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<?php echo $channelname;?> </div><!--面包屑--> <div class="st-main-page"> <div class="order-content"> <?php if(empty($userInfo['mid'])) { ?> <div class="order-hint-msg-box"> <p class="hint-txt">温馨提示：<a href="<?php echo $cmsurl;?>member/login" id="fast_login">登录</a>可享受预定送积分、积分抵现！</p> </div><!-- 未登录提示 --> <?php } ?> <form id="orderfrm" method="post" action="<?php echo $cmsurl;?>hotel/create"> <div class="con-order-box"> <div class="product-msg"> <h3 class="pm-tit"><strong class="ico01">预定信息</strong></h3> <dl class="pm-list"> <dt>产品编号：</dt> <dd><?php echo $info['series'];?></dd> </dl> <dl class="pm-list"> <dt>产品名称：</dt> <dd><?php echo $info['title'];?></dd> </dl> <dl class="pm-list"> <dt>产品类型：</dt> <dd><?php echo $suitInfo['roomname'];?></dd> </dl> <div class="table-msg"> <table width="100%" border="0" class="people_info" script_table=LxACXC > <tr> <th width="25%" height="40" scope="col"><span class="l-con">入住日期</span></th> <th width="25%" scope="col">离店日期</th> <th width="25%" scope="col">购买数量</th> <th width="25%" scope="col">总价格</th> </tr> <tr> <td height="40"> <input type="text" class="inputdate" name="startdate" id="startdate"  value=""> </td> <td> <input type="text" class="inputdate" name="leavedate" id="leavedate" value=""> </td> <td> <div class="control-box"> <span class="add-btn">-</span> <input type="text" id="dingnum" name="dingnum" class="number-text" value="1"/> <span class="sub-btn">+</span> </div> </td> <td><span class="price suit-totalprice"></span></td> </tr> </table> </div> </div><!--预定信息--> <div class="product-msg"> <h3 class="pm-tit"><strong class="ico02">联系人信息</strong></h3> <dl class="pm-list"> <dt><span class="st-star-ico">*</span>联系人：</dt> <dd><input type="text" class="linkman-text" name="linkman" value="<?php echo $userInfo['truename'];?>" /><span class="st-ts-text hide"></span></dd> </dl> <dl class="pm-list"> <dt><i class="st-star-ico">*</i>手机号码：</dt> <dd> <input type="text" id="linktel"  class="linkman-text" name="linktel"  value="<?php echo $userInfo['mobile'];?>"> <span class="st-ts-text hide"></span> <?php if($GLOBALS['cfg_plugin_hotel_book_sms_verify']==1) { ?> <a class="ver-code" id="linktel_btn" href="javascript:;">获取验证码</a> <?php } ?> </dd> </dl> <?php if($GLOBALS['cfg_plugin_hotel_book_sms_verify']==1) { ?> <dl class="pm-list"> <dt><i class="st-star-ico">*</i>验证码：</dt> <dd> <input type="text" id="phone_code" class="linkman-text" name="phone_code"> </dd> </dl> <?php } ?> <dl class="pm-list"> <dt>电子邮箱：</dt> <dd><input type="text" class="linkman-text" name="linkemail" value="<?php echo $userInfo['email'];?>" /></dd> </dl> <dl class="pm-list"> <dt>订单留言：</dt> <dd><textarea class="order-remarks" name="remark" cols="" rows=""></textarea></dd> </dl> </div><!--联系人信息--> <?php if($GLOBALS['cfg_plugin_hotel_usetourer']==1) { ?> <div class="product-msg"> <h3 class="pm-tit"><strong class="ico03">游客信息</strong></h3> <?php require_once ("E:/wamp64/www/taglib/member.php");$member_tag = new Taglib_Member();if (method_exists($member_tag, 'linkman')) {$tourerlist = $member_tag->linkman(array('action'=>'linkman','memberid'=>$userInfo['mid'],'return'=>'tourerlist',));}?> <?php if(!empty($userInfo) && !empty($tourerlist['0']['linkman'])) { ?> <div class="select-linkman"> <div class="bt">选择常用旅客：</div> <div class="son"> <?php $n=1; if(is_array($tourerlist)) { foreach($tourerlist as $row) { ?> <span data-linkman="<?php echo $row['linkman'];?>" data-cardtype="<?php echo $row['cardtype'];?>"
                                          data-idcard="<?php echo $row['idcard'];?>" data-sex="<?php echo $row['sex'];?>"><i></i><?php echo $row['linkman'];?></span> <?php $n++;}unset($n); } ?> </div> <?php if(count($tourerlist)>5) { ?> <div class="more">更多&gt;</div> <?php } ?> </div> <script>
                        $(function () {
                    ...
                    </script> <?php } ?> <div class="visitor-msg"> <table width="100%" border="0" id="tourer_list"> </table> </div> </div> <!--游客信息--> <?php } ?> <!--支付方式--> <?php if(!empty($userInfo) && ($suitInfo['paytype']==1 || $suitInfo['paytype']==3)) { ?> <div class="product-msg"> <h3 class="pm-tit" id="yhzc_tit"><strong class="ico08">优惠政策</strong></h3> <?php if(St_Functions::is_normal_app_install('coupon')) { ?> <?php echo Request::factory('coupon/box-'.$typeid.'-'.$info['id'])->execute()->body(); ?> <?php } ?> <?php if(!empty($userInfo) && !empty($jifentprice_info)) { ?> <div class="item-yh"> <h3>积分优惠</h3> <div class="item-nr"> <table> <tr> <td> <span class="use-jf"><label>使用 </label><input type="text" id="needjifen"  data-exchange="<?php echo $jifentprice_info['cfg_exchange_jifen'];?>" class="jf-num" name="needjifen"/><label> 积分抵扣<em class="dk-num" id="jifentprice"><?php echo Currency_Tool::symbol();?>0</em></label></span> <span class="cur-jf">最多可以使用<?php echo $jifentprice_info['toplimit'];?>积分抵扣<i class="currency_sy"><?php echo Currency_Tool::symbol();?></i><?php echo $jifentprice_info['jifentprice'];?>，我当前积分：<?php echo $userInfo['jifen'];?></span> </td> <td> <span class="jifen-error"></span> </td> </tr> </table> </div> </div> <?php } ?> </div><!--积分优惠--> <script>
                    if($("#yhzc_tit").siblings().not('script,style').length==0)
                    {
                        $("#yhzc_tit").hide();
                    }
                </script> <?php } ?> <div class="order-js-box"> <div class="total">订单结算总额：<span class="totalprice"></span></div> <div class="yz"> <input type="button" class="tj-btn" value="提交订单" /> <input type="text" name="checkcode" id="checkcode" maxlength="4" class="ma-text" /> <span class="pic"><img src="<?php echo $cmsurl;?>captcha" onClick="this.src=this.src+'?math='+ Math.random()" width="80" height="32" /></span> <span class="bt">验证码：</span> </div> </div><!--提交订单--> </div><!--订单内容--> <!--隐藏域--> <input type="hidden" name="suitid" id="suitid" value="<?php echo $suitInfo['id'];?>"/> <input type="hidden" name="hotelid" value="<?php echo $info['id'];?>"/> <input type="hidden" name="usedate" value="<?php echo $info['usedate'];?>"/> <input type="hidden" name="webid" value="<?php echo $info['webid'];?>"/> <input type="hidden" name="frmcode" value="<?php echo $frmcode;?>"><!--安全校验码--> <input type="hidden" name="usejifen" id="usejifen" value="0"/><!--是否使用积分--> <input type="hidden" id="price" value="0"/> <input type="hidden" id="jifentprice" value="<?php echo $suitInfo['jifentprice'];?>"><!--积分抵现金额--> <input type="hidden" id="total_price" value=""/> </form> <div class="clear"></div> <?php if($GLOBALS['cfg_order_agreement_open']==1) { ?> <div class="booking-need-term"> <div class="term-tit"><strong>我已阅读预定须知，同意则提交订单</strong></div> <div class="term-block"> <?php echo $GLOBALS['cfg_order_agreement'];?> </div> </div> <?php } ?> </div> <div class="st-sidebox"> <div class="side-order-box"> <div class="order-total-tit">结算信息</div> <div class="show-con"> <ul class="ul-cp"> <li><a class="pic" href="<?php echo $info['url'];?>"><img src="<?php echo $info['litpic'];?>" alt="<?php echo $info['title'];?>"></a></li> <li> <a class="txt" href="<?php echo $info['url'];?>"><?php echo $info['title'];?>(<?php echo $suitInfo['roomname'];?>)</a> <p class="address"><?php echo $info['address'];?></p> </li> </ul> <ul class="ul-list"> <li>床型：<?php echo $suitInfo['roomstyle'];?></li> <li>宽带：<?php echo $suitInfo['computer'];?></li> <li>早餐：<?php echo $suitInfo['breakfirst'];?></li> <li>楼层：<?php echo $suitInfo['roomfloor'];?></li> <li>面积：<?php echo $suitInfo['roomarea'];?></li> </ul> <div class="total-price">订单总额：<span class="totalprice"></span></div> </div> </div> </div> </div><!--订单结算信息--> </div> </div> <?php echo Request::factory("pub/footer")->execute()->body(); ?> <?php echo Common::js('layer/layer.js');?> <div id="calendar" style="display: none"></div> <script>
...
";
    var linktel_verify_identity = "<?php echo $linktel_verify_identity;?>";
