<?php defined('SYSPATH') or die();?> <style>
    .coupon-side-block{
        width: 162px;
        height: 398px;
        position: absolute;
...
</style> <div class="coupon-side-block" style="top: 1300px;"><a href="javascript:;" class="coupon-close-btn"> </a> <ul class="coupon-item-block clearfix"> </ul><a class="more-coupon"  target="_blank" href="/coupon-<?php echo $typeid;?>-<?php echo $proid;?>">更多优惠券</a></div> <div class="coupon-side-btn" style="top: 400px; display: none;">先领券 再购物</div> <script>
    $(function(){
...
</script> <?php echo Common::js('layer/layer.js',0);?> <script>
    $(function(){
        //领取优惠券
