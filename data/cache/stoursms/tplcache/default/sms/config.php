...
<head>
    ...
    <link type="text/css" href="/<?php echo $admindir;?>/public/css/base_new.css" rel="stylesheet" />
    <script type="text/javascript" src="/<?php echo $admindir;?>/public/js/common.js"></script>
                    ...
                    <form id="configfrm">
                        <ul class="info-item-block">
                            <li>
                                ...
                                <div class="item-bd">
                                    <label class="radio-label mr-20"><input type="radio" name="isopen" <?php if($provider['isopen']=='0') { ?> checked <?php } ?>
  value="0" />关</label>
                                    <label class="radio-label mr-20"><input type="radio" name="isopen" <?php if($provider['isopen']=='1') { ?> checked <?php } ?>
  value="1" />开</label>
                                </div>
                            </li>
                            <li>
                                <span class="item-hd">笛卡官网账号<img class="ml-5 va-m" title="查看帮助cfg_sms_username" style="cursor:pointer; margin-top: -3px" src="/<?php echo $admindir;?>/public/images/help-ico.png" onclick="helpBox(this,'cfg_sms_username',event)">：</span>
                                <div class="item-bd">
                                    <input class="input-text w300" type="text" name="cfg_sms_username" id="cfg_sms_username" value="<?php echo $cfg_sms_username;?>" />
                                </div>
                            </li>
                            <li>
                                <span class="item-hd">笛卡官网密码：</span>
                                <div class="item-bd">
                                    <input class="input-text w300" type="password" name="cfg_sms_password" id="cfg_sms_password" value="<?php echo $cfg_sms_password;?>" />
                                </div>
                            </li>
                        </ul>
                    </form>
                    ...
                    <div class="sms-num mt-20">剩余短信<img class="ml-5 va-m" title="查看帮助plugins_stoursms_sms_account_balance" style="cursor:pointer; margin-top: -3px" src="/<?php echo $admindir;?>/public/images/help-ico.png" onclick="helpBox(this,'plugins_stoursms_sms_account_balance',event)"/>：<strong><?php echo $balance;?></strong>条</div>
                    <div class="sms-set">
                        <div class="msg-bar">
...
<script>
    ...
    function helpBox(ele, label, e)
    {
        ...
        parent.parent.window.floatBox('帮助', '/<?php echo $admindir;?>/user/dialog_help?label=' + label, 600, 300);
    }
</script>
</body>
</html>
