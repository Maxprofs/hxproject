...
<body>
  ...
  value="1" />开</label>
                    ...
                    <div class="sms-num mt-20">剩余短信：<strong><!-- <iframe src="http://mb345.com:999/ws/SelSum.aspx?CorpID=<?php echo $cfg_sms_username;?>&Pwd=<?php echo $cfg_sms_password;?>" frameborder="0" style="position: relative; top: +3px; height: 25px;width: 60px;" scrolling="no"></iframe> -->
                    <?php echo $count;?>
                    </strong>条</div>
                    <div class="sms-set">
                        <div class="msg-bar">
