...
$menu = $mysql->query("select id from sline_menu_new WHERE `title`='财务管理'");
$pid = $menu[0]['id'];
$mysql->query("delete from sline_menu_new WHERE title='供应商财务' and pid=$pid");
...
if (isset($moduleArr['supplier_brokerage']))
{
    unset($moduleArr['supplier_brokerage']);
