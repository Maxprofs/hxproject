...
function delete_data()
{
    ...
    $sqls = array(
        //model
        'sline_model' => 'where id=8 and pinyin="visa"',
        //page
        'sline_page' => 'where pagename in ("visa_index","visa_list","visa_show") or (pid=0 and kindname="签证模块")',
        //site_page
        'sline_site_page' => 'where pagename in ("visa_index","visa_list","visa_show") or (pid=0 and kindname="签证模块")',
        //sms_msg
        'sline_sms_msg' => 'where msgtype in("visa_order_msg1","visa_order_msg2","visa_order_msg3","visa_order_msg4")',
        //email_msg
        'sline_email_msg' => 'where msgtype in("visa_order_msg1","visa_order_msg2","visa_order_msg3","visa_order_msg4")',
        //advertise_5x
        'sline_advertise_5x' => 'where is_system="1" and prefix="visa_index"',
        //sysconfig
        //  'sline_sysconfig' => 'where varname="cfg_visa_minprice_rule"',
        //sline_menu_new
        'sline_menu_new' => 'where typeid=8',
        //sline_nav
        'sline_nav' => 'where typeid=8',
        //sline_m_nav
        'sline_m_nav' => 'where m_typeid=8'
    );
    foreach ($sqls as $k => $v)
    {
...
if (isset($moduleArr['visa']))
{
    unset($moduleArr['visa']);
