...
function delete_data()
{
    ...
    $sqls = array(
        //model
        'sline_model' => 'where id=5 and pinyin="spot"',
        //page
        'sline_page' => 'where pagename in ("spot_index","spot_list","spot_show") or (pid=0 and kindname="景点模块")',
        //site_page
        'sline_site_page' => 'where pagename in ("spot_index","spot_list","spot_show") or (pid=0 and kindname="景点模块")',
        //sms_msg
        'sline_sms_msg' => 'where msgtype in("spot_order_msg1","spot_order_msg2","spot_order_msg3","spot_order_msg4")',
        //email_msg
        'sline_email_msg' => 'where msgtype in("spot_order_msg1","spot_order_msg2","spot_order_msg3","spot_order_msg4")',
        //advertise_5x
        'sline_advertise_5x' => 'where is_system="1" and prefix="spot_index"',
        //sline_menu_new
        'sline_menu_new' => 'where typeid=5',
        //sline_nav
        'sline_nav' => 'where typeid=5',
        //sline_m_nav
        'sline_m_nav' => 'where m_typeid=5',
    );
    foreach ($sqls as $k => $v)
    {
...
if (isset($moduleArr['spot']))
{ 
    unset($moduleArr['spot']);
