...
class AlipayTradeService {
	...
	function __construct($alipay_config){
		...
		$this->private_key_path = $alipay_config['merchant_private_key_path'];
		$this->alipay_public_key = $alipay_config['alipay_public_key'];
		$this->alipay_public_key_path = $alipay_config['alipay_public_key_path'];
...
//		}
	...
	function aopclientRequestExecute($request,$ispage=false) {
		...
		$aop->alipayPublicKey = $this->alipay_public_key_path;
		$aop->apiVersion ="1.0";
