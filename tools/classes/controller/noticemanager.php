...
class Controller_NoticeManager extends Stourweb_Controller
{
    ...
    protected function get_order_msgtaglist($model_info, $product_id = "")
    {
        ...
        $result = array_merge($result, NoticeCommon::create_product_order_msgtag_summary(NoticeCommon::PRODUCT_ORDER_REVIEWING_MSGTAG, $model_info['pinyin'], $product_id));
        $result = array_merge($result, NoticeCommon::create_product_order_msgtag_summary(NoticeCommon::PRODUCT_ORDER_REFUND_MSGTAG, $model_info['pinyin'], $product_id));
