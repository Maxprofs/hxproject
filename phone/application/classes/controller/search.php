...
class Controller_Search extends Stourweb_Controller
{
    ...
    public function action_index()
    {
        ...
        if(!$keyword)
        {
            $keyword =  Model_Global_Search::get_hot_search_default();
        }
        if($keyword)
        {
            Model_Global_Search::search_jump($keyword,'mobile');
        }
    ...
    public function action_order()
    {
        ...
        $url = $member ? 'member#&orderSeek' : 'member/login?redirecturl='.urlencode('/phone/member#&orderSeek');
