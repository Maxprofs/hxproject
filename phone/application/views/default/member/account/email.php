    ...
    <div class="user-item-list">
        ...
        <ul class="list-group">
            <li>
                ...
                <input type="text" name="email" id="email" class="data-text text-left fr" placeholder="输入邮箱地址" onkeyup="validate()" />
            </li>
            <li>
...
<script>
    ...
    $('#emailfrm').validate({
        ...
        submitHandler: function (form) {
            ...
            if(account_type==2)
            {
                ...
                var is_bind_exist=confirm("此邮箱已存在，绑定后，当前会员账号下的相关数据可能会丢失。确定绑定此邮箱账号吗？");
                if (!is_bind_exist)
                {
                    return;
                }
    ...
    function validate(){
        ...
        $("#emailfrm").validate().element($("#email"))
    }
