    ...
    <div class="order-content">
        <div class="tab-bar">
            <ul class="tab-list clearfix">
                ...
                <li {if $type==3}class="on"{/if} data="3">退款</li>
            </ul>
        </div>
...
<script type="text/html" id="tpl_list_item">
    ...
    <li>
        ...
        <div class="item-jg">
            ...
            <span class="num fl">总额：<em>{Currency_Tool::symbol()}{{value.totalprice}}</em></span>
            <span class="num fr">全额支付：<em>{Currency_Tool::symbol()}{{if value.price}}{{value.price}}{{else}}0{{/if}}</em></span>
            {{else}}
            <span class="num fl">总额：<em>{Currency_Tool::symbol()}{{value.totalprice}}</em></span>
            <span class="num fr">定金支付：<em>{Currency_Tool::symbol()}{{value.price}}</em></span>
            {{/if}}
        </div>
