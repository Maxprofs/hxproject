    ...
    <form id="questionfrm">
        <div class="faq-page-content">
            ...
            <div class="faq-fb-block">
                <textarea style="border-bottom: none;" class="faq-textarea" name="content" id="content" placeholder="请至少输入5个字"></textarea>
<!--                <div class="faq-yzm">-->
<!--                    <i class="ico"></i>-->
<!--                    <input class="write-yzm" type="text" name="checkcode" id="checkcode" placeholder="请输入右侧图形验证码"  />-->
<!--                    <em class="img-yzm"><img src="{$cmsurl}captcha" class="captcha1" width="100%" height="100%" /></em>-->
<!--                    <input type="text" class="input-t" placeholder="请输入验证码" />-->
<!--                    <img class="code captcha" src="{$cmsurl}captcha"/>-->
<!--                </div>-->
            </div>
            <ul class="faq-list-group" style="margin-top:0">
                <li class="item">
                    <input type="text" id="mobile" name="mobile" class="input-t" placeholder="请输入您的联系电话(必填)"
                           value="{if !empty($member)}{php}$m_info=Model_Member::get_member_byid($member['mid']);{/php}{$m_info['mobile']}{/if}" />
                </li>
                <li class="item">
                    <input type="text" id="checkcode" name="checkcode" class="input-t" placeholder="请输入验证码" />
                    <img class="code captcha" src="{$cmsurl}captcha"/>
                </li>
            </ul>
