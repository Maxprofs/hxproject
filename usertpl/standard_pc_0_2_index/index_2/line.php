...
<div class="line_trip_box">
    ...
    <div class="product_box">
        <div class="sidle_hot">
            ...
            <ul>
                {st:line action="query" flag="order" row="6" changecity="1" return="recline"}
                {loop $recline $l}
                <li>
                    <s></s>
        ...
        <div class="con_list">
            <div class="st-tabnav">
                {st:dest action="query" flag="channel_nav" row="9" typeid="1" return="linedest"}
                {loop $linedest $ld}
            ...
            <div class="st-tabcon" style="display: block;">
                <ul>
                    {st:line action="query" flag="mdd" destid="$ld['id']" row="8" changecity="1" return="linelist" }
                    {php}$k=1;{/php}
                    {loop $linelist $ll}
