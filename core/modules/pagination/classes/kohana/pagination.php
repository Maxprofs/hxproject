...
class Kohana_Pagination {
	...
	public function setup(array $config = array())
	{
        ...
        $this->needpage =$this->config['needpage'];
			...
			OR isset($config['items_per_page']))
		{
			...
			$this->previous_page      = ($this->current_page > $this->config['needpage']) ? $this->current_page - $this->config['needpage'] : FALSE;
			$this->next_page          = ($this->current_page+$this->config['needpage'] < $this->total_pages) ? $this->current_page + $this->config['needpage'] : FALSE;
