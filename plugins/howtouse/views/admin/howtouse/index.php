...
<head>
    <meta charset="utf-8">
    <title>操作指引-笛卡CMS{$coreVersion}</title>
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            ...
            <div class="novice-guide-page">
                <div class="novice-guide-box">
                    <h3 class="tit">欢迎使用笛卡CMS</h3>
                    <p class="txt">通过新手教程，助您快速上手，使用本系统！</p>
                </div>
                <div class="novice-guide-container">
                    <ul class="novice-guide-wrapper">
                        <li>
                            <a class="item" href="javascript:{if $step1_menu['right']!=1 }ST.Util.showMsg('权限不足,请联系管理员', 5, 1000){else}ST.Util.addTab('首页设置', '{$cmsurl}config/base/menuid/{$step1_menu['id']}'){/if};">
                        ...
                        <li>
                            <a class="item" href="javascript:{if $step2_menu['right']!=1 }ST.Util.showMsg('权限不足,请联系管理员', 5, 1000){else}ST.Util.addTab('全局目的地', '{$cmsurl}destination/destination/menuid/{$step2_menu['id']}'){/if};">
                        ...
                        <li>
                            <a class="item" href="javascript:{if $step3_menu['right']!=1 }ST.Util.showMsg('权限不足,请联系管理员', 5, 1000){else}ST.Util.addTab('全局出发地', '{$cmsurl}startplace/index/menuid/{$step3_menu['id']}'){/if};">
                        ...
                        <li>
                            <a class="item" href="javascript:{if $step4_menu['right']!=1 }ST.Util.showMsg('权限不足,请联系管理员', 5, 1000){else}ST.Util.addTab('支付接口', '{$cmsurl}payset/alipay/menuid/{$step4_menu['id']}'){/if};">
                        ...
                        <li>
                            <a class="item" href="javascript:{if $step5_menu['right']!=1 }ST.Util.showMsg('权限不足,请联系管理员', 5, 1000){else}ST.Util.addTab('短信接口', '{$cmsurl}sms/index/menuid/{$step5_menu['id']}'){/if};">
