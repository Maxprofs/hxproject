 ...
 *Author: nilsir
 *QQ: 2758691158
 *Time: 2017/7/18 16:10
 *Desc: PC端支付宝双功能,可支持担保支付,亦可即时到账
 */
class Controller_Pc_Alipaydouble extends Stourweb_Controller
{
    //支付id
    private $_id = 12;
    //支付宝双功能目录
    private $_alipay_double_dir = '';
    //异步通知
    private $_notify_url;
    //同步通知
    private $_return_url;
    //日志目录
    const LOGSDIR = 'alipaydouble';

    public function before()
    {
        parent::before();
        $this->_alipay_double_dir = ALIPAY . 'vendor' . DS . 'pc' . DS . 'alipay_double' . DS;
        $this->_notify_url = $GLOBALS['cfg_basehost'] . '/alipaydouble/pc/notify_url';;
        $this->_return_url = $GLOBALS['cfg_basehost'] . '/alipaydouble/pc/notify_url';;
    }
    ...
    {
        require_once($this->_alipay_double_dir . "lib/alipay_submit.class.php");
        //支付宝配置
    ...
    private function _alipay_config()
    {
        ...
        $alipay_config['cacert'] = $this->_alipay_double_dir . 'cacert.pem';
    ...
    {
        $bool = 'fail';
        include($this->_alipay_double_dir . 'lib/alipay_notify.class.php');
        $alipay_config = $this->_alipay_config();
