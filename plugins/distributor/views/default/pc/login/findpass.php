                            ...
                            <li>
                                ...
                                <div class="msg-box">
                                    ...
                                    <span class="change-yzm">
                                        <a style="cursor: pointer" id="btnSwitchRegisterMode" onClick="switchRegisterMode(this);">使用手机找回</a>
                                    </span>
    ...
    $(function(){
        ...
        $('.sms-send').click(function () {
            ...
            if (bool === 'true') {
                ...
                var postValue = regtype == 'phone' ? {'phone': content, 'type': 'findpass_code'} : {'email': content, 'type': 'findpass_code'};
                if (content != '') {
                    if ($("#code").val() != '') {
                        //发送验证码
        ...
        $('#setp1_form').validate({
            ...
            showErrors: function (errorMap, errorList) {
                ...
                $.post(SITEURL + 'pc/findpass/ajax_do_setp1', postValue, function (data) {
                    if (data.status == 1) {
