...
<head>
    ...
    {php echo Common::css('style.css,base.css,base2.css,base_new.css'); }
    {php echo Common::css('extjs/resources/ext-theme-neptune/ext-theme-neptune-all-debug.css'); }
            ...
            <td valign="top" class="content-rt-td">
                ...
                <div class="cfg-header-bar">
                    ...
                    <div class="cfg-header-search">
                        <input type="text" id="searchkey" placeholder="名称/联系人/联系电话/手机号/地址" value="" class="search-text" />
