    ...
    function () {
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    read: SITEURL+'distributor_brokerage/admin/brokerage/approval/action/read/',  //读取数据的URL
                    update: SITEURL+'distributor_brokerage/admin/brokerage/approval/action/save/',
                    destroy: SITEURL+'distributor_brokerage/admin/brokerage/approval/action/delete/'
                },
                reader: {
                    type: 'json',   //获取数据的格式
                    root: 'lists',
...
function modify(id) {
    ...
    var url = SITEURL+'distributor_brokerage/admin/brokerage/modify_approval/menuid/{$_GET['menuid']}/id/'+id;
