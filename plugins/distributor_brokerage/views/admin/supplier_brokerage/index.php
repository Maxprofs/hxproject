    ...
    function () {
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    read: SITEURL+'distributor_brokerage/admin/brokerage/index/action/read/',  //读取数据的URL
                    update: SITEURL+'distributor_brokerage/admin/brokerage/index/action/save/',
                    destroy: SITEURL+'distributor_brokerage/admin/brokerage/index/action/delete/'
                },
                reader: {
                    type: 'json',   //获取数据的格式
                    root: 'lists',
...
//结算规则
function modifyRule() {
    var url = SITEURL+'distributor_brokerage/admin/brokerage/modify_rule/menuid/{$_GET['menuid']}';
...
//审核
function modify(id) {
    var url = SITEURL+'distributor_brokerage/admin/brokerage/change_status?id='+id;
...
function changeStatus(result,bool) {
    if(bool)
    {
        var url = SITEURL+'distributor_brokerage/admin/brokerage/ajax_change_status';
        $.ajax({
            url:url,
            dataType:'json',
            type:'post',
