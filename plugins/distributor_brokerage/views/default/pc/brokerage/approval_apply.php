...
<head>
    ...
    <style>
        ...
        .error-txt:before {
            ...
            margin: -3px 5px 0 0;
            background: url(/plugins/distributor/public/default/pc/images/gys-dg-ico.png) no-repeat -52px -83px;
        }
    </style>
</head>
<body>
                            ...
                            <div class="tixian-item">
                                <ul>
                                    <li class="clearfix">
                                        ...
                                        <div class="item-nr">
                                            <input type="text" class="default-text w200" name="withdrawamount" id="withdrawamount" data-max="{$price_arr['allow_price']}">
                                            <span class="usable">可提现金额¥{$price_arr['allow_price']}</span>
    ...
    $(function () {
        ...
        $('.tj-btn').click(function () {
            ...
            $.ajax({
                ...
                url:'{$cmsurl}'+'brokerage/ajax_save_approval',
