...
<head>
    ...
    {Common::css('base.css')}
    {Common::css_plugin('refund.css','car')}
...
<script type="text/javascript">
    ...
    function refund_status(data) {
        $.post('{$cmsurl}cars/member/ajax_order_refund', data, function (result) {
            parent.layer.open({
                content: result.message,
                btn: ['{__("OK")}'],
                end:function(){
                    window.location = '{$cmsurl}cars/member/orderview?ordersn={$info['ordersn']}';
                }
            });
        }, 'json');
    }
