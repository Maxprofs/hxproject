    ...
    <div class="filter-item">
        <div class="hd">
            <ul>
                ...
                {st:attr action="query" flag="grouplist" typeid="$typeid" return="p_attrlist"}
        ...
        <div class="bd">
            ...
            <ul id="sub_kindid">
                ...
                {loop $data $r}
                   <li data-id="{$r['id']}" selfield="kindid">{$r['title']}<i class="on"></i></li>
                {/loop}
                {/st}
            </ul>
            <!--圈子-->
            ...
            <ul id="sub_priceid">
                ...
                {loop $data $r}
                <li data-id="{$r['id']}" selfield="priceid">{$r['title']}<i class="on"></i></li>
                {/loop}
                {/st}
            </ul>
            <!--属性-->
            ...
            {loop $p_attrlist $pattr}
                 <ul id="sub_attrid_{$pattr['id']}" class="sub_attrid">
                    ...
                    {st:attr action="query" flag="childitem" typeid="$typeid" groupid="$pattr['id']" return="attrlist"}
                    {loop $attrlist $attr}
