          ...
          <div class="bd">
            <ul>
                {loop $carad['aditems'] $v}
                    <li><a href="{$v['adlink']}" target="_blank"><img src="{Product::get_lazy_img()}" original-src="{Common::img($v['adsrc'],815,320)}" alt="{$v['adname']}" /></a></li>
                {/loop}
            </ul>
          </div>
          <!--前/后按钮代码-->
      ...
      <div class="st-cp-slideTab">
              ...
              {st:car action="query" flag="recommend" kindid="$carkind[0]['id']" row="8"}
                {loop $data $c}
                    <li {if $n%4==0}class="mr_0"{/if}>
                        <i class="hot-ico"></i>
                        <a class="pic" href="{$c['url']}" title="{$c['title']}" target="_blank"><img src="{Product::get_lazy_img()}" st-src="{Common::img($c['litpic'],283,193)}" alt="{$c['title']}" /></a>
                        <p class="tit"><a href="{$c['url']}" target="_blank" title="{$c['title']}">{$c['title']}</a></p>
                      <p class="data">
        ...
        <script type="text/html" id="tpl_car">
          ...
          {{each list as value i}}
            ...
            <i class="hot-ico"></i>
            <a class="pic" href="{{value.url}}" title="{{value.title}}" target="_blank"><img src="{{value.litpic}}" alt="{{value.title}}" /></a>
            <p class="tit"><a href="{{value.url}}" target="_blank" title="{{value.title}}">{{value.title}}</a></p>
            <p class="data">
