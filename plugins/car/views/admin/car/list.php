        ...
        <tr>
            ...
            <td valign="top" class="content-rt-td" style="overflow:hidden">
                ...
                <div class="cfg-search-bar">
                    ...
                    <span class="cfg-select-box btnbox mt-3 ml-10" id="carkind" data-url="box/index/type/carkind" data-result="result_kind" >车辆类型&nbsp;&gt;&nbsp;<span id="result_kind">全部</span><i class="arrow-icon"></i></span>
                    <span class="cfg-select-box btnbox mt-3 ml-10" id="attrlist" data-url="box/index/type/attrlist/typeid/3" data-result="result_attrlist" >属性&nbsp;&gt;&nbsp;<span id="result_attrlist">全部</span><i class="arrow-icon"></i></span>
                    <div class="cfg-header-search">
                        <input type="text" id="searchkey" placeholder="车辆名称/车辆编号" datadef="车辆名称/车辆编号" class="search-text">
	   ...
	   columns:[
			   ...
			   },
               {
                   ...
                   renderer : function(value, metadata,record,rowIndex,colIndex) {
                       ...
                       else
                       {
                           ...
                           return '<span class="c-red">' + str + '</span>';
                       }
			   ...
			   },
			   {
				   ...
				   renderer : function(value, metadata,record,rowIndex,colIndex) {
						 ...
						 var id=record.get('id');
						 var d_text=value!=0&&value?'<span class="c-green">已设</span>':'<span class="c-999">未设</span>';
			   ...
			   },
			   {
				  ...
				  renderer : function(value, metadata,record,rowIndex,colIndex) {
						 ...
						 var id=record.get('id');
                         var d_text=value&&value!=0?'<span class="c-green">已设</span>':'<span class="c-999">未设</span>';
			   ...
			   },
			   {
			   ...
			   },
			    {
				   ...
				   renderer : function(value, metadata,record) {
					     ...
					     var id=record.get('id');
						 return "<a href='javascript:void(0);'class='btn-link' title='编辑' onclick=\"goModify("+id+")\">编辑</a>&nbsp;&nbsp;"+"<a href='javascript:void(0);' title='克隆' class='btn-link' onclick=\"ST.Util.goClone("+id+",'car/admin/car')\">克隆</a>";
                                   // return getExpandableImage(value, metadata,record);
                    },
					 listeners:{
					     afterrender:function(obj,eopts)
						 ...
						 if(id.indexOf('suit')!=-1)
						   {
                               ...
                               var suitname=record.get('title');
						        return "<a href='javascript:;' class='btn-link' onclick=\"modSuit("+suitid+")\" title='编辑'>编辑</a>&nbsp;&nbsp;<a href='javascript:;' title='删除' class='btn-link' onclick=\"delSuit('"+id+"')\">删除</a>";
						   }
					     else
						    return '<a href="javascript:;" class="btn-link" onclick="ST.Util.addTab(\''+name+'-套餐类型\',\'car/admin/car/suittype/menuid/{$_GET['menuid']}/parentkey/product/itemid/3/carid/'+id+'\')">套餐类型<a>&nbsp;&nbsp;<a href="javascript:;" class="btn-link" onclick="ST.Util.addTab(\'添加套餐\',\'car/admin/car/addsuit/menuid/{$_GET['menuid']}/parentkey/product/itemid/3/carid/'+id+'\')">添加套餐</a>';
                                   // return getExpandableImage(value, metadata,record);
                    },
				    listeners:{
					     afterrender:function(obj,eopts)
