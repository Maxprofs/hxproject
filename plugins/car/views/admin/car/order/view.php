...
<body>
<table class="content-tab" div_body=BAACXC >
    <tr>
            ...
            <div class="order-info-block">
                <ul>
                  <li>
                    ...
                    <li>
                        <strong class="item-hd">还车日期：</strong>
                        <div class="item-bd">
                            <div class="order-num">
                                {$info['departdate']}
                            </div>
            ...
            <div class="order-info-block">
                <ul>
                    ...
                    <li>
                        ...
                        <div class="item-bd">
                            <span class="order-num">{$info['paytype_name']}  &nbsp;{if $info['paytype']==2}({$info['dingjin']}/辆){/if}</span>
                        </div>
                    </li>
...
<script>
    ...
    function refund_submit(type,description)
    {
        ...
        $.ajax({
            url : SITEURL+"car/admin/order/ajax_refund_submit",
            type:'post',
            dataType:'json',
