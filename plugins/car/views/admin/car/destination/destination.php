...
<script>
   ...
   // var otherModule={php echo json_encode($allmodule);};
                        ...
                        tpl: new Ext.XTemplate(
                            '{[this.realName(values.id)]}',
                            {
                                realName: function (id) {
                                    ...
                                    return '<a href="javascript:;" class="btn-link" title="设置" onclick="destProductSet(\'' + id + '\')">设置</a>'+viewHtml;
                                }
                            }
                        ),
                        listeners: {
    ...
    function destProductSet(dest_id) {
        ...
        ST.Util.showBox('设置',SITEURL+'car/admin/destination/dialog_productinfo?id='+id+"&typeid="+display_mode,600,500,null,null,document,{loadCallback:setProductInfo,loadWindow:window});
