...
<div class="sms-base sms-single">
  ...
  value="1" />
                ...
                <tr>
                    <td>
                        笛卡官网账号<img class="ml-5 mt-3" title="查看帮助cfg_sms_username" style="cursor:pointer" src="/newtravel/public/images/help-ico.png" onclick="helpBox(this,'cfg_sms_username',event)">：
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        笛卡官网密码<img class="ml-5 mt-3" title="查看帮助cfg_sms_password" style="cursor:pointer" src="/newtravel/public/images/help-ico.png" onclick="helpBox(this,'cfg_sms_password',event)"/>：
                    </td>
                    <td>
