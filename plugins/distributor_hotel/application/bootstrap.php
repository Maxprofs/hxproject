...
//缓存目录,日志目录指定
$cache_dir = CACHE_DIR.'distributor/distributor_hotel';
$logs_dir = LOGS_DIR.'distributor/distributor_hotel';
...
Kohana::init(array(
    'base_url' => '/plugins/distributor_hotel/',
    'index_file' => '',
    'cache_dir' => $cache_dir,
...
$cfg_res_url = "/plugins/distributor_hotel/public";
