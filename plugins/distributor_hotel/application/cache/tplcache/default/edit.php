                  ...
                  <!--<dl>
                      ...
                      <dd>
                          ...
                          <div class="save-value-div mt-2 ml-10 distributor-sel">
                              <?php if(!empty($info['distributor_arr']['distributorname'])) { ?>
                              <span><s onclick="$(this).parent('span').remove()"></s><?php echo $info['distributor_arr']['distributorname'];?><input type="hidden" name="distributorlist[]" value="<?php echo $info['distributor_arr']['id'];?>"></span>
                              <?php } ?>
                          </div>
                      </dd>
                  </dl>-->
