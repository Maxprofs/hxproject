                        ...
                        <div class="flow-path-con">
                            <div class="nr-box">
                                ...
                                <div class="verify-finally">
                                    ...
                                    <ul class="info-item-block confirm-info-box c-666">
                                        <li>
                                            ...
                                            <div class="item-bd">
                                                <span class="item-text">{$userinfo['suppliername']}</span>
                                            </div>
                                        </li>
                                        <li>
                                            <span class="item-hd">法人代表：</span>
                                            <div class="item-bd">
                                                <span class="item-text">{$userinfo['reprent']}</span>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div class="item-bd">
                                                ...
                                                {/php}
                                                {loop $product_list $p}
                                                    {if in_array($p['id'],$apply_product)}<span class="item-text">{$p['modulename']}</span>&nbsp;&nbsp;{/if}
                                                {/loop}
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div class="item-bd">
                                                ...
                                                <span class="item-text">{$verifytype}</span>
                                ...
                                <div class="send-success">
                                    <p>您的资料已<strong>{if $isfirstupdate==1}提交成功{else}更新成功{/if}</strong>，请等待客服审核。</p>
                                ...
                                <div class="way">
                                    <div class="gy-top-box">
                                        <ul>
                                            <li><strong class="lm">企业名称：</strong><div class="zl-con"><input type="text" name="suppliername" class="tit-text" value="{$qd['suppliername']}" id="suppliername" /></div></li>
                                            ...
                                            <li>
                                                ...
                                                <div class="zl-con">
                                                    <div class="zj-radio">
                                                        ...
                                                        {/php}
                                                        {loop $product_list $p}
                                                        <label><input type="checkbox" class="apply" name="apply_product[]" value="{$p['id']}" {if in_array($p['id'],$apply_product)}checked="checked"{/if}>{$p['modulename']}</label>
                                                        {/loop}
                                    ...
                                    <a class="submit-btn" href="javascript:;"> {if $userinfo['verifystatus']==0}提交审核{else}修改资料{/if}</a>
