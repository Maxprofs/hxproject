...
<div class="header">
    ...
    <div class="tx">
        <span class="wc">欢迎您，<a id="myaccountlink" href="/plugins/supplier/pc/index/userinfo" style="color: #fff">{if $userinfo['suppliername']}{$userinfo['suppliername']}{else}供应商{/if}</a></span>
