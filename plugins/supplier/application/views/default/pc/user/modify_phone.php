            ...
            <div class="frame-box">
                <div class="frame-con">
                    ...
                    <div class="change-phone-box">
                        <div class="change-phone-tit"><strong class="bt">更换绑定手机</strong></div>
                        <div class="change-phone-con">
                            <div class="change-phone-step">
                                ...
                                <div class="current-con" id="setp1_div">
                                    <form id="setp1_form" head_ul=DFACXC >
                                        <ul>
                                            <li>
                                                <strong class="bt">手机号码：</strong>

                                                <div class="msg-box"><span class="phone-num">{php}echo (empty($data['mobile'])?'未绑定':$data['mobile']) {/php}</span></div>
                                            </li>
                                            <li>
                                ...
                                <div class="current-con" id="setp3_div" style=" display:none">
                                    <div class="success-txt">恭喜您，手机号码更新成功！</div>
        ...
        $('.sms-send').click(function () {
            ...
            if (bool === 'true') {
                if ($("#newphone").val() != '') {
                    //发送验证码
                    $('.sms-send').attr('do-send', 'false');
                    $.post(SITEURL + 'pc/pub/ajax_send_message', {'phone': $("#newphone").val(),'type':'findpass_code'}, function (bool) {
                        if (bool != 1) {
                            var message = bool == 0 ? '发送失败，请检查短信接口或消息开关' : bool;
