...
class Controller_Pc_Login extends Stourweb_Controller
{
    ...
    public function action_index()
    {
        ...
        $cfg_supplier_loginbg = Common::get_sys_para('cfg_supplier_loginbg');
        $this->assign('supplier_loginbg', $cfg_supplier_loginbg ? $cfg_supplier_loginbg : '/plugins/supplier/public/default/pc/images/login-bg.jpg');
