 ...
 */
//缓存目录,日志目录指定
$cache_dir = CACHE_DIR.'distributor/distributor_spot';
$logs_dir = LOGS_DIR.'distributor/distributor_spot';
...
Kohana::init(array(
    'base_url' => '/plugins/distributor_spot/',
    'index_file' => '',
    'cache_dir' => $cache_dir,
...
if (file_exists($plugins_modules = BASEPATH . '/data/module.php')) {
    ...
    foreach ($distributor_plugins_modules as $plugin_key => $plugin_modules) {
        $distributor_modules_arr[$plugin_key] = BASEPATH . $plugin_modules;
    }
    $modules = array_merge($modules, $distributor_modules_arr);
}
...
$cfg_res_url = "/plugins/distributor_spot/public";
