...
<head>
    <meta charset="utf-8">
    <title>套餐添加/修改</title>
    {Common::css("style.css,base.css,style_hotel.css,base_hotel.css,base2.css,jquery.datetimepicker.css,calendar-price-jquery.min.css")}
    {Common::js("jquery.min.js,common.js,product.js,choose.js,imageup.js,jquery.datetimepicker.full.js")}

    <script src="/plugins/distributor_spot/public/js/calendar-price-jquery.js"></script>
            ...
            <div class="product-add-div" id="content_base">
                <div class="add-class">
                    <dl>
                        ...
                        <dd>
                            ...
                            <div class="save-value-div mt-2 ml-10" id="spotid_con">
                                {if !empty($product)}
                                <span><s onclick="$(this).parent('span').remove()"></s>{$product['title']}<input type="hidden" class="lk" name="spotid" value="{$product['id']}"></span>
                                {/if}
                            </div>
                        </dd>
                    </dl>
                    <dl>
                        <dt>门票名称：</dt>
                        <dd>
                            <input type="text" name="title" id="suitname"  class="set-text-xh text_700 mt-2" value="{$info['title']}" />
                        </dd>
                    </dl>
                    <dl>
                        <dt>门票类型：</dt>
                    ...
                    <dl>
                        <dt>原价：</dt>
                        <input type="text" name="sellprice"  class="set-text-xh text_100 mt-2" value="{$info['sellprice']}" />
                    </dl>
                ...
                <div class="add-class">
                    <dl>
                        ...
                        <dd style="width:800px">
                            <label class="fl">提前 </label><input type="text" id="day_before" maxlength="3" name="day_before" class="set-text-xh text_60 mt-2 ml-5" value="{$info['day_before']}" />
                            <label class="fl ml-5"> 天预订 </label>
                            <input type="text" name="time_before" id="time_before" class="set-text-xh text_60 mt-2 ml-20" value="{$info['time_before']}" />
                    ...
                    <dl>
                        <dt>取票方式：</dt>
                       <dd><input type="text" name="get_ticket_way"  class="set-text-xh text_700 mt-2" value="{$info['get_ticket_way']}" /> </dd>
                    </dl>
                    <dl>
                        <dt>有效期：</dt>
                        <dd> <label class="fl ml-5">游客指定入园日期后&nbsp;&nbsp; </label><input type="text" name="effective_days"  class="set-text-xh text_60 mt-2" value="{$info['effective_days']}" />&nbsp;&nbsp;天内有效 </dd>
                    </dl>
                    <dl>
                        <dt>退票类型：</dt>
                        <dd>
                    ...
                    <dl>
                        ...
                        <dd>
                            <label class="radio-label"><input type="checkbox" name="need_confirm" value="1" {if $info['need_confirm']=='1'}checked="checked"{/if} />需要管理员手动确认</label>
                        </dd>
                    </dl>
                </div>
               <!-- <div class="add-class">
                    <dl>
                        <dt>供应结算价：</dt>
                        <dd>
                            <input type="text" name="basicprice" value="{$suit['basicprice']}" class="set-text-xh text_100 mt-2 "  />
                    ...
                    <dl>
                        <dt>建议零售价：</dt>
                        <dd>
                            <input type="text" name="suggest_price"  value="{$suit['suggest_price']}" class="set-text-xh text_100 mt-2 "  />
...
<script>
    ...
    var has_period = "{$has_period}";
    var tickettypeid = "{$info['tickettypeid']}"
