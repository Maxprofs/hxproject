            ...
            <div class="pm-tab-box">
              ...
              <table class="pm-table-hd" width="100%" border="0">
                  <tr class="pl-th">
                    ...
                    <th width="22%" scope="col">景点名称</th>
                    <th width="8%" scope="col">门票类型</th>
                    <th width="8%" scope="col">门票名称</th>
                ...
                <table class="pm-table-list" width="100%" border="0">
                 <?php $n=1; if(is_array($list)) { foreach($list as $row) { ?>
                  <tr class="pl-tr">
                    ...
                    <td width="22%"><div class="pm-table-boxs"><a class="pm-table-bt" href="<?php echo $row['url'];?>" target="_blank"><?php echo $row['title'];?></a></div></td>
                    ...
                    <td width="8%" align="center">
                      <div class="pm-table-boxs">
                        <a href="javascript:;" data-id="<?php echo $row['id'];?>" class="pm-add-tc-btn add-suit" title="添加套餐">添加套餐</a>
                      </div>
                    </td>
                  </tr>
                   <?php $n=1; if(is_array($row['suit'])) { foreach($row['suit'] as $suit) { ?>
                     <tr class="pl-tr pl-child-tr">
                        ...
                        <td width="8%" align="center"><div class="pm-table-boxs">&nbsp;</div></td>
                        <td width="22%"><div class="pm-table-boxs"><a class="pm-table-bt" href="javascript:;"></a></div></td>
                        <td width="8%" align="center"><div class="pm-table-boxs"><span class="color-grey"><?php echo $suit['suit_type'];?></span></div></td>
                        <td width="8%" align="center"><div class="pm-table-boxs"><span class="color-grey"><?php echo $suit['title'];?></span></div></td>
                        ...
                        <td width="8%" align="center"><div class="pm-table-boxs"><span class="color-grey"><?php echo $suit['number'];?></span></div></td>
                        <td width="8%" align="center">
                          <div class="pm-table-boxs">
