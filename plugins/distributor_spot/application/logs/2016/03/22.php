...
--
#0 D:\web\v5\plugins\distributor_spot\application\classes\controller\index.php(179): Kohana_ORM->update()
...
#5 D:\web\v5\plugins\distributor_spot\index.php(131): Kohana_Request->execute()
#6 {main}
...
#1 D:\web\v5\plugins\distributor_spot\application\classes\model\spot.php(145): Kohana_Database_Query->execute()
#2 D:\web\v5\plugins\distributor_spot\application\classes\model\spot.php(105): Model_Spot::get_spot_suit('1909')
#3 D:\web\v5\plugins\distributor_spot\application\classes\model\spot.php(38): Model_Spot::format_data(Array)
#4 D:\web\v5\plugins\distributor_spot\application\classes\controller\index.php(212): Model_Spot::spot_list(30, '')
...
#9 D:\web\v5\plugins\distributor_spot\index.php(131): Kohana_Request->execute()
#10 {main}
...
--
#0 D:\web\v5\plugins\distributor_spot\application\classes\controller\index.php(180): Kohana_ORM->update()
#1 [internal function]: Controller_Index->action_ajax_save()
#2 D:\web\v5\core\system\classes\kohana\request\client\internal.php(116): ReflectionMethod->invoke(Object(Controller_Index))
#3 D:\web\v5\core\system\classes\kohana\request\client.php(64): Kohana_Request_Client_Internal->execute_request(Object(Request))
#4 D:\web\v5\core\system\classes\kohana\request.php(1160): Kohana_Request_Client->execute(Object(Request))
...
#2 D:\web\v5\plugins\distributor_spot\application\classes\controller\index.php(196): Functions::save_extend_data(5, '1909', Array)
...
#7 D:\web\v5\plugins\distributor_spot\index.php(131): Kohana_Request->execute()
#8 {main}
...
#1 D:\web\v5\plugins\distributor_spot\application\classes\model\spot.php(133): Kohana_Database_Query->execute()
#2 D:\web\v5\plugins\distributor_spot\application\classes\model\spot.php(148): Model_Spot::get_min_data('1909', '20')
#3 D:\web\v5\plugins\distributor_spot\application\classes\model\spot.php(105): Model_Spot::get_spot_suit('1909')
#4 D:\web\v5\plugins\distributor_spot\application\classes\model\spot.php(38): Model_Spot::format_data(Array)
#5 D:\web\v5\plugins\distributor_spot\application\classes\controller\index.php(212): Model_Spot::spot_list(30, '')
...
#10 D:\web\v5\plugins\distributor_spot\index.php(131): Kohana_Request->execute()
#11 {main}
...
#4 D:\web\v5\plugins\distributor_spot\application\classes\controller\index.php(262): Kohana_ORM->get_all()
...
#2 D:\web\v5\plugins\distributor_spot\index.php(131): Kohana_Request->execute()
#3 {main}