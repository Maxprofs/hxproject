...
class Controller_Admin_visa_Attrid extends Stourweb_Controller
{
    private $_typeid = 8;
    ...
    public function action_list()
    {
        ...
        if (empty($action))
        {
            ...
            $this->display('admin/visa/attrid/list');
        }
        else if ($action == 'read')
        {
    ...
    public function action_config()
    {
        ...
        $this->assign('typeid', $typeid);
        $this->display('admin/visa/attrid/config');
    }
    ...
    public function action_extendlist()
    {
        ...
        if (empty($action))
        {
            ...
            $this->assign('typeid', $typeid);
            $this->assign('channelname', $channelname);
            $this->display('admin/visa/attrid/extendfield');
        }
        else if ($action == 'read')
        {
        ...
        else if ($action == 'add')
        {
            ...
            $this->display('admin/visa/attrid/addfield');
        }
        else if ($action == 'delete')
        {
            ...
            if (is_numeric($id))
            {
                ...
                //清理扩展字段
                DB::delete('visa_content')->where('columnname','=',$fieldname)->execute();
            }
        }
    ...
    public function action_content()
    {
        ...
        if (empty($action))
        {
            ...
            $this->display('admin/visa/attrid/content');
        }
        else if ($action == 'save')
        {
    ...
    public function action_dialog_delfield()
    {
        ...
        $this->assign('id', $id);
        $this->display('admin/visa/attrid/dialog_delfield');
    }
