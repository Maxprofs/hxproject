...
<script>
   ...
   $(".additem").click(function(){
       ...
       $.ajax({
           type: 'POST',
           url: SITEURL+"visa/admin/attrid/ajax_addfield/typeid/{$typeid}",
           dataType:'json',
  ...
  function rowSave()
  {
      ...
      Ext.Ajax.request({
          url   :  SITEURL+"visa/admin/attrid/content/action/save/typeid/{$typeid}",
          method  :  "POST",
          isUpload :  true,
          form  : "day_fm",
          datatype  :  "JSON",
  ...
  function backDel(result,bool)
  {
      ...
      $.ajax({
          type: 'POST',
          url: SITEURL+"visa/admin/attrid/ajax_delfield",
          dataType:'json',
  ...
  {
      ST.Util.showBox('删除字段',SITEURL+'visa/admin/attrid/dialog_delfield?id='+id+"&typeid="+typeid,400,'',null,null,document,{loadWindow:window,loadCallback:backDel,maxHeight:600});
