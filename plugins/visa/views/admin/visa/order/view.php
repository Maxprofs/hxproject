...
<body>
<table class="content-tab" body_color=BElzhm >
    <tr>
            ...
            <div class="order-info-block">
                <ul>
                  <li>
                    ...
                    <li>
                        <strong class="item-hd">单价：</strong>
                        <div class="item-bd">
                            <div class="order-num">
                                <span class="cor_666">{Currency_Tool::symbol()}
            ...
            <div class="order-info-block">
                <ul>
                    ...
                    <li>
                        ...
                        <div class="item-bd">
                            <span class="order-num">{$info['paytype_name']}  &nbsp;{if $info['paytype']==2}({$info['dingjin']}/个){/if}</span>
                        </div>
                    </li>
...
<script>
    ...
    function refund_submit(type,description)
    {
        ...
        $.ajax({
            url : SITEURL+"visa/admin/order/ajax_refund_submit",
            type:'post',
            dataType:'json',
    ...
    {
        $.ajaxform({
            url   :  SITEURL+"visa/admin/order/ajax_save",
            method  :  "POST",
            form  : "#frm",
            dataType:'json',
            success  :  function(data)
