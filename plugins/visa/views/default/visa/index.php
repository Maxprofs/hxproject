        ...
        <div class="st-main-page">
            ...
            <div class="visa-hot-country">
                ...
                <div class="hot-country-block">
                    <ul>
                        {st:visa action="area" flag="hot" minprice="true" row="8" return="arealist"}
                        {loop $arealist $k $area}
                        ...
                        <a href="{$area['url']}">
                            <div class="pic">
                                <div class="layer">
                                    ...
                                    <span class="eg">{$area['english']}</span>
                                </div>
                                <img src="{Product::get_lazy_img()}" st-src="{Common::img($area['litpic'],282,192)}" alt="{$area['title']}" />
                            </div>
                            <div class="txt">
                    ...
                    <ul class="st-visa-list">
                        ...
                        <li {if $n%5==0}class="mr_0"{/if}>
                            <a class="fl" href="{$v['url']}" target="_blank">
                                <div class="country"><em><img src="{Product::get_lazy_img()}" st-src="{Common::img($v['litpic'],140,95)}" alt="{$v['title']}"/></em></div>
