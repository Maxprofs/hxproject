    ...
    <div class="os-term">
        ...
        <div class="os-block">
            <div class="order-show-info">
                ...
                <table width="100%" border="0" class="order-show-table" div_head=KZzCXC >
                    <tr>
...
<script>
    $(function () {
        ...
        $("#apply-refund-Click").on("click", function () {
            parent.layer.open({
                ...
                title: "申请退款",
                area: ['560px','570px'],
                content: '{$cmsurl}visa/member/order_refund?ordersn={$info['ordersn']}',
                btn: ['确认', '取消'],
                btnAlign: 'C',
                closeBtn: 0,
    ...
    function refund_status(data) {
        $.post('{$GLOBALS["cfg_basehost"]}/visa/member/ajax_order_refund', data, function (result) {
            parent.layer.open({
...
<script>
    ...
    function refund_status(data) {
        $.post('{$GLOBALS["cfg_basehost"]}/visa/member/ajax_order_refund_back', data, function (result) {
            parent.layer.open({
                content: result.message,
                btn: ['{__("OK")}'],
                end:function(){
