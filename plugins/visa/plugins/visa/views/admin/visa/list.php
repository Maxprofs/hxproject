...
<body style="overflow:hidden" bottom_margin=dhQzDt >
...
Ext.onReady(
    function () {
        ...
        $("#addbtn").click(function(){
            ...
            ST.Util.addTab('添加签证','{$cmsurl}visa/admin/visa/add/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/product/itemid/5',0);
        });
...
function goModify(id)
{
    var record=window.product_store.getById(id.toString());
    var title = record.get('title');
    var url = SITEURL+'visa/admin/visa/edit/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/product/itemid/5/id/'+id;
