...
(function(window){
    ...
    //标题日期格式相减
    function dateMinusFmt(dateStr1,dateStr2)
    {
        var date1=getDateByStr(dateStr1);
        var date2=getDateByStr(dateStr2);
        if(!date1 || !date2)
        {
            return null;
        }
    ...
    _Datetime.dateMinusFmt=dateMinusFmt;
    _Datetime.format=format;
