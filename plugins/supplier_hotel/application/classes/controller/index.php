...
class Controller_Index extends Stourweb_Controller
{
    ...
    public function action_ajax_save()
    {
        ...
        $model->supplierlist = $this->_user_info['id'];
        ...
        {
            if($this->_user_info['id'] != $model->supplierlist)
            {
    ...
    public function action_ajax_suit_save()
    {
        ...
        //权限判断
        $supplier = ORM::factory('hotel',$hotelid)->get('supplierlist');
        if($supplier!=$this->_user_info['id'])
        {
