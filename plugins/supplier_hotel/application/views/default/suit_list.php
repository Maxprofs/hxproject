            ...
            <div class="pm-tab-box">
              ...
              <div class="pm-tabcon-list">
                  ...
                  <tr class="pl-th">
                    ...
                    <th width="8%" scope="col">门市价</th>
                    <th width="8%" scope="col">优惠价</th>
                    <th width="8%" scope="col">房间数</th>
                ...
                <table class="pm-table-list" width="100%" border="0">
                 {loop $list $row}
                  <tr class="pl-tr">
                    ...
                    <td width="8%" align="center"><div class="pm-table-boxs">{$row['series']}</div></td>
                    <td width="30%"><div class="pm-table-boxs"><a class="pm-table-bt" href="{$row['url']}" target="_blank">{$row['title']}</a></div></td>
                    <td width="8%" align="center"><div class="pm-table-boxs"><span class="color-grey">{$row['expired_date']}</span></div></td>
                   ...
                   {loop $row['suit'] $suit}
                     <tr class="pl-tr pl-child-tr">
                        ...
                        <td width="8%" align="center"><div class="pm-table-boxs">&nbsp;</div></td>
                        <td width="30%"><div class="pm-table-boxs"><a class="pm-table-bt" href="#">{$suit['roomname']}</a></div></td>
                        <td width="8%" align="center"><div class="pm-table-boxs"><span class="color-grey">{$suit['expired_date']}</span></div></td>
                        <td width="8%" align="center"><div class="pm-table-boxs"><input type="text" class="pm-jf-text" data-field="sellprice" data-id="{$suit['id']}" value="{$suit['sellprice']}" /></div></td>
                        <td width="8%" align="center"><div class="pm-table-boxs"><input type="text" class="pm-jf-text" data-field="price" data-id="{$suit['id']}" value="{$suit['price']}" /></div></td>
                        <td width="8%" align="center"><div class="pm-table-boxs"><input type="text" class="pm-jf-text" data-field="number" data-id="{$suit['id']}" value="{$suit['number']}" /></div></td>
                        <td width="8%" align="center"><div class="pm-table-boxs"><span class="color-grey">{$suit['min_price']}</span></div></td>
                        <td width="8%" align="center"><div class="pm-table-boxs"><span class="color-grey">{$suit['min_profit']}</span></div></td>
                        <td width="8%" align="center">
                          <div class="pm-table-boxs">
