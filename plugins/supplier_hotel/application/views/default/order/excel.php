...
<head>
    <meta charset="utf-8">
    <title></title>
    {Common::plugin_pinyin_css('order.css','supplier')}
    {Common::plugin_pinyin_css('hdate.css','supplier')}
    {Common::plugin_pinyin_js('hdate/hdate.js,jquery.min.js','supplier')}
    {Common::js('common.js')}
        ...
        <form>
            <table class="derive_tb">
                ...
                <tr>
                    <td colspan="2">
                        <label>订单状态：</label>
                        <select id="orderstatus"><option value="">所有</option>
