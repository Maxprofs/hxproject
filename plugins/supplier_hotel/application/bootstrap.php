...
//缓存目录,日志目录指定
$cache_dir = CACHE_DIR.'supplier/supplier_hotel';
$logs_dir = LOGS_DIR.'supplier/supplier_hotel';
...
Kohana::init(array(
    'base_url' => '/plugins/supplier_hotel/',
    'index_file' => '',
    'cache_dir' => $cache_dir,
...
$cfg_res_url = "/plugins/supplier_hotel/public";
