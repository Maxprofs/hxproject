...
<head>
    <meta charset="utf-8">
    <title>移动到组-笛卡CMS3.0</title>
    <?php echo  Stourweb_View::template("pub");  ?>
    <?php echo Common::css('admin_base.css,admin_base2.css,admin_style.css,style.css,image.css');?>
    ...
    <?php echo Common::js('jquery.min.js,artDialog/dist/dialog-plus.js,msgbox/msgbox.js,jquery.colorpicker.js,common.js,choose.js,product.js,image/plupload.full.min.js,image/zh_CN.js,uploadify/uploadify.js');?>
</head>
<body>
