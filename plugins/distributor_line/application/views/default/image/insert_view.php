...
<head>
    ...
    {include "pub"}
    {Common::css('admin_base.css,admin_base2.css,admin_style.css,style.css,image.css')}
    ...
    {Common::js('jquery.min.js,artDialog/dist/dialog-plus.js,msgbox/msgbox.js,jquery.colorpicker.js,common.js,choose.js,product.js,image/plupload.full.min.js,image/zh_CN.js,uploadify/uploadify.js')}
</head>
<body>
