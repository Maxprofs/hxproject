...
<head>
    ...
    {include "pub"}
    {Common::css('admin_base.css,admin_base2.css,admin_style.css,style.css')}
    ...
    {Common::js('jquery.min.js,artDialog/dist/dialog-plus.js,msgbox/msgbox.js,jquery.colorpicker.js,DatePicker/WdatePicker.js,common.js,product.js,choose.js')}
    <style>
        *{
            padding:0px;
            margin:0}
...
<script language="javascript">
    ...
    function  modPrice(obj)
    {
       ...
       // var title = typeid==1 ? '成人价格' : '价格';
        var html = '<table id="tabl" html_strong=kxQzDt >';
        var title='产品';
        if(typeid==1){
            title='成人';
        }
