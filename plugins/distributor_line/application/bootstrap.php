...
//缓存目录,日志目录指定
$cache_dir = CACHE_DIR.'distributor/distributor_line';
$logs_dir = LOGS_DIR.'distributor/distributor_line';
...
Kohana::init(array(
    'base_url' => '/plugins/distributor_line/',
    'index_file' => '',
    'cache_dir' => $cache_dir,
...
if (file_exists($plugins_modules = BASEPATH . '/data/module.php')) {
    $distributor_plugins_modules = include $plugins_modules;
    if (isset($distributor_plugins_modules['coupon'])) {
        $modules['coupon'] = BASEPATH . $distributor_plugins_modules['coupon'];
    }
    if (isset($distributor_plugins_modules['red_envelope'])) {
        $modules['red_envelope'] = BASEPATH . $distributor_plugins_modules['red_envelope'];
    }
}
