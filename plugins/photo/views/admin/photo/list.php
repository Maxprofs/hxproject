        ...
        <tr>
            ...
            <td valign="top" class="content-rt-td" style="overflow:hidden">
                <div class="cfg-header-bar">
                    ...
                    <span class="cfg-select-box btnbox mt-5 ml-10" id="destination" data-url="box/index/type/destlist" data-result="result_dest" >目的地&nbsp;&gt;&nbsp;<span id="result_dest">全部</span><i class="arrow-icon"></i></span>
                    <span class="cfg-select-box btnbox mt-5 ml-10" id="attrlist" data-url="box/index/type/attrlist/typeid/6" data-result="result_attrlist" >属性&nbsp;&gt;&nbsp;<span id="result_attrlist">全部</span><i class="arrow-icon"></i></span>
                    <div class="cfg-header-search">
                        <input type="text" id="searchkey" placeholder="相册名称" datadef="相册名称" class="search-text">
...
<script>
  ...
  Ext.onReady(
    function() 
    {
        ...
        $("#addbtn").click(function(){
            ...
            ST.Util.addTab('添加相册','{$cmsurl}photo/admin/photo/add/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/article/itemid/4',0);
        });
        ...
        window.product_store=Ext.create('Ext.data.Store',{
         ...
         proxy:{
		   ...
		   api: {
              read: SITEURL+'photo/admin/photo/photo/action/read',  //读取数据的URL
			  update:SITEURL+'photo/admin/photo/photo/action/save',
			  destroy:SITEURL+'photo/admin/photo/photo/action/delete'
              },
		      reader:{
                type: 'json',   //获取数据的格式 
                root: 'lists',
	   ...
	   columns:[
			   ...
			   },
			   {
				   ...
				   renderer : function(value, metadata,record) {
							...
							if(!isNaN(id))
			                           return "<div class='aaa' style=' display: table-cell; width: 75px; height: 50px; vertical-align: middle; text-align: center; background: #e7e7e7'><img style=' vertical-align: middle; max-width: 100%; max-height: 100%' src='"+value+"'/></div>";
						}
  ...
  function updateField(ele,id,field,value,type,callback)
  {
	  ...
	  Ext.Ajax.request({
						 url   :  "admin/photo/photo/action/update",
						 method  :  "POST",
						 datatype  :  "JSON",
   ...
   {
       var url = SITEURL+'photo/admin/photo/edit/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/article/itemid/4/photoid/'+id;
