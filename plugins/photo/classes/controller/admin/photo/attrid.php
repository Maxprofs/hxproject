...
class Controller_Admin_Photo_Attrid extends Stourweb_Controller
{
    private $_typeid = 6;
    ...
    public function action_list()
    {
        ...
        if (empty($action))
        {
            ...
            $this->display('admin/photo/attrid/list');
        }
        else if ($action == 'read')
        {
    ...
    public function action_config()
    {
        ...
        $this->assign('typeid', $typeid);
        $this->display('admin/photo/attrid/config');
    }
    ...
    public function action_extendlist()
    {
        ...
        if (empty($action))
        {
            ...
            $this->assign('typeid', $typeid);
            $this->assign('channelname', $channelname);
            $this->display('admin/photo/attrid/extendfield');
        }
        else if ($action == 'read')
        {
        ...
        else if ($action == 'add')
        {
            ...
            $this->display('admin/photo/attrid/addfield');
        }
    ...
    public function action_content()
    {
        ...
        if (empty($action))
        {
            ...
            $this->display('admin/photo/attrid/content');
        }
        else if ($action == 'save')
        {
    ...
    public function action_dialog_delfield()
    {
        ...
        $this->assign('id', $id);
        $this->display('admin/photo/attrid/dialog_delfield');
    }
