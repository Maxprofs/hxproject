 ...
 * 线路目的地控制器
 */
class Controller_Admin_Photo_Destination extends Stourweb_Controller
{
    ...
    public function action_destination()
    {
        ...
        if (empty($action))
        {
            ...
            $this->display('admin/photo/destination/destination');
        }
        else if ($action == 'read')
        {
            ...
            $sql = "select distinct a.id,a.kindname,if(find_in_set($this->_typeid,opentypeids),1,0) as isopen,a.pinyin,a.iswebsite,{$bfields} from sline_destinations a left join $product_dest_table b on a.id=b.kindid where a.pid=$pid and a.isopen=1";
    ...
    */
    ...
    public function action_dialog_productinfo()
    {
        ...
        $this->display('admin/photo/destination/dialog_productinfo');
    }
}