 ...
 * 线路目的地控制器
 */
class Controller_Admin_Notes_Destination extends Stourweb_Controller
{
    ...
    public function action_destination()
    {
        ...
        if (empty($action))
        {
            ...
            $this->display('admin/notes/destination/destination');
        }
        else if ($action == 'read')
        {
...
//            var_dump($sql);
    ...
    */
    ...
    public function action_dialog_productinfo()
    {
        ...
        $this->display('admin/notes/destination/dialog_productinfo');
    }

    //目的地保存
    public function action_ajax_save()
    {
        $dest = new Model_Tongyong('notes_kindlist');
        $dest = $dest->where('kindid','=',$_POST['kindid'])->find();
