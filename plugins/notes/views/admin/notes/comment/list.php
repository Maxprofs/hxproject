    ...
    function () {
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    read: SITEURL+'notes/admin/comment/index/action/read{if isset($_GET["typeid"])}/typeid/{$_GET["typeid"]}{/if}',  //读取数据的URL
                    update: SITEURL+'notes/admin/comment/index/action/save',
                    destroy: SITEURL+'notes/admin/comment/index/action/delete'
                },
                reader: {
                    type: 'json',   //获取数据的格式
                    root: 'lists',
            ...
            columns: [
...

                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        var   html = "<a href='javascript:void(0);' title='删除' class='btn-link' onclick=\"del(" + id + ")\">删除</a>";
                        return html;
...
function updateField(ele, id, field, value, type) {
    ...
    Ext.Ajax.request({
        url: SITEURL+"notes/admin/comment/index/action/update",
        method: "POST",
        datatype: "JSON",
