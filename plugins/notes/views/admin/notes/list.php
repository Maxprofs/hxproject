...
<head>
    <meta charset="utf-8">
    <title>游记管理-笛卡CMS{$coreVersion}</title>
            ...
            <td valign="top" class="content-rt-td" style="overflow:hidden">
                <div class="cfg-header-bar">
                    <div class="cfg-header-search">
                        <input type="text" id="searchkey" value="" placeholder="游记名称" class="search-text">
    ...
    function () {
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    read: SITEURL+'notes/admin/notes/index/action/read',  //读取数据的URL
                    update: SITEURL+'notes/admin/notes/index/action/save',
                    destroy: SITEURL+'notes/admin/notes/index/action/delete'
                },
                reader: {
                    type: 'json',   //获取数据的格式
                    root: 'lists',
        ...
        window.product_grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        var id=record.get('id');
                        return "<a href='/notes/show_"+id+".html' target='_blank'>"+value+"</a>";
                    }
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        var id = record.get('id');
                        var html = "<a href='javascript:void(0);' class='btn-link' onclick=\"view(" + id + ")\">查看</a>";
                        return html;
...

                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        var id = record.get('id');
                        var html = "<a href='javascript:void(0);' class='btn-link' onclick=\"delS(" + id + ")\">删除</a>";
                        return html;
                        // return getExpandableImage(value, metadata,record);
                    }
...
function updateField(ele, id, field, value, type) {
    ...
    Ext.Ajax.request({
        url: SITEURL+"notes/admin/notes/index/action/update",
        method: "POST",
        datatype: "JSON",
...
function view(id)
{
    var url = SITEURL+'notes/admin/notes/view/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/article/itemid/7/id/'+id;
