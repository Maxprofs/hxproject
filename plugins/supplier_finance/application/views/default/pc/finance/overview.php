                ...
                <div class="finance-content">
                    ...
                    <div class="finance-bloock">
                            ...
                            <ul>
                                ...
                                <li class="clearfix">
                                    ...
                                    <div class="item-nr">
                                        ...
                                        <a href="/plugins/supplier_finance/pc/drawcash/drawcash_apply"  class="btn-link">申请提现</a>
                                        <a href="/plugins/supplier_finance/pc/drawcash/list"  class="txt-link">提现记录</a>
                                    </div>
                                </li>
                                <li class="clearfix">
                            ...
                            <ul>
                                <li class="clearfix">
                                    ...
                                    <div class="item-nr">
                                        ...
                                        <a href="/plugins/supplier_finance/pc/financeextend/ordercount"  class="btn-link">结算统计</a>
                                    </div>
                                </li>
                                <li class="clearfix">
                        ...
                        <div class="cw-table clearfix">
                            ...
                            <a href="/plugins/supplier_finance/pc/financeextend/orderrecord"  class="all-list-link">查看所有交易记录</a>
                        </div>
                    </div>
                </div><!-- 财务总览 -->
            </div>
