       ...
       // var title = typeid==1 ? '成人价格' : '价格';
        ...
        //成人
           if($.inArray('2',groupArr)!=-1){
               html+= '<tr>' +
                    '<td>'+title+'报价:</td>' +
                    '<td>成本<input type="text" size="5" style="border:1px solid #d7d7d7;padding:3px;" onkeyup="calPrice2(this)" class="txt" id="basicprice" name="adultbasicprice"  value="'+basicprice+'"/></td>' +
                    '<td>&nbsp;利润<input type="text" size="5" style="border:1px solid #d7d7d7;padding:3px;"  onkeyup="calPrice2(this)" class="txt" id="profit" name="adultprofit" value="'+profit+'"/></td>' +
        ...
        if($.inArray('1',groupArr)!=-1){
            html+= '<tr>' +
                '<td>小孩价格:</td>' +
                '<td>成本<input type="text" size="5" onkeyup="calPrice2(this)" class="txt" id="child_basicprice" name="child-basicprice"  value="'+child_basicprice+'"/></td>' +
                '<td>&nbsp;利润<input type="text" size="5"  onkeyup="calPrice2(this)" class="txt" id="child_profit" name="child-profit" value="'+child_profit+'"/></td>' +
        ...
        if($.inArray('3',groupArr)!=-1){
            html+= '<tr>' +
                '<td>老人价格:</td>' +
                '<td>成本<input type="text" size="5" onkeyup="calPrice2(this)" class="txt" id="old_basicprice" name="old-basicprice"  value="'+old_basicprice+'"/></td>' +
                '<td>&nbsp;利润<input type="text" size="5"  onkeyup="calPrice2(this)" class="txt" id="old_profit" name="old-profit" value="'+old_profit+'"/></td>' +
        ...
        html+= '<tr>' +
            '<td>产品库存:</td>' +
            '<td colspan="3"><input type="text" size="5" class="txt" style="border:1px solid #d7d7d7;padding:3px;" id="number" name="number"  value="'+number+'"/></td>' +
    ...
    function addPrice(obj)
    {
       ...
       // var html = '<table><tr><td>成人价格:</td><td>成本<input type="text" class="txt" size="5" onkeyup="calPrice(this)" name="adultbasicprice" id="basicprice"/></td><td>利润<input type="text" onkeyup="calPrice(this)" class="txt" size="5" name="adultprofit" id="profit"/></td><td class="tprice"><font color="#FF9900"></font>元</td></tr></table>';
        ...
        if($.inArray('2',groupArr)!=-1){
            html+= '<tr>' +
                '<td>成人报价:</td>' +
                '<td>成本<input type="text" size="5" style="border:1px solid #d7d7d7;padding:3px;" onkeyup="calPrice2(this)" class="txt" id="basicprice" name="adultbasicprice"  value=""/></td>' +
                '<td>&nbsp;利润<input type="text" style="border:1px solid #d7d7d7;padding:3px;" size="5"  onkeyup="calPrice2(this)" class="txt" id="profit" name="adultprofit" value=""/></td>' +
        ...
        if($.inArray('1',groupArr)!=-1){
            html+= '<tr>' +
                '<td>小孩价格:</td>' +
                '<td>成本<input type="text" size="5" onkeyup="calPrice2(this)" class="txt" id="child_basicprice" name="child-basicprice"  value=""/></td>' +
                '<td>&nbsp;利润<input type="text" size="5"  onkeyup="calPrice2(this)" class="txt" id="child_profit" name="child-profit" value=""/></td>' +
                '<td class="tprice"><font color="#FF9900"></font>元</td>' +
                '</tr>'
        ...
        if($.inArray('3',groupArr)!=-1){
            html+= '<tr>' +
                '<td>老人价格:</td>' +
                '<td>成本<input type="text" size="5" onkeyup="calPrice2(this)" class="txt" id="old_basicprice" name="old-basicprice"  value=""/></td>' +
                '<td>&nbsp;利润<input type="text" size="5"  onkeyup="calPrice2(this)" class="txt" id="old_profit" name="old-profit" value=""/></td>' +
                '<td class="tprice"><font color="#FF9900"></font>元</td>' +
                '</tr>'
        ...
        html+= '<tr>' +
            '<td>产品库存:</td>' +
            '<td colspan="3"><input type="text" style="border:1px solid #d7d7d7;padding:3px;" size="5" class="txt" id="number" name="number"  value=""/></td>' +
