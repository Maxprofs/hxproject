...
#1 D:\web\v5\plugins\distributor_car\application\classes\model\car.php(150): Kohana_Database_Query->execute()
#2 D:\web\v5\plugins\distributor_car\application\classes\model\car.php(165): Model_Car::get_min_data('6', '14')
#3 D:\web\v5\plugins\distributor_car\application\classes\model\car.php(119): Model_Car::get_car_suit('6')
#4 D:\web\v5\plugins\distributor_car\application\classes\model\car.php(51): Model_Car::format_data(Array)
#5 D:\web\v5\plugins\distributor_car\application\classes\controller\index.php(64): Model_Car::car_list(30, '')
...
#8 D:\web\v5\core\system\classes\kohana\request\client.php(64): Kohana_Request_Client_Internal->execute_request(Object(Request))
#9 D:\web\v5\core\system\classes\kohana\request.php(1160): Kohana_Request_Client->execute(Object(Request))
#10 D:\web\v5\plugins\distributor_car\index.php(131): Kohana_Request->execute()
#11 {main}
...
--
#0 D:\web\v5\plugins\distributor_car\application\classes\model\car.php(169): Kohana_ORM->get('suitname')
#1 D:\web\v5\plugins\distributor_car\application\classes\model\car.php(119): Model_Car::get_car_suit('6')
#2 D:\web\v5\plugins\distributor_car\application\classes\model\car.php(51): Model_Car::format_data(Array)
#3 D:\web\v5\plugins\distributor_car\application\classes\controller\index.php(64): Model_Car::car_list(30, '')
...
#8 D:\web\v5\plugins\distributor_car\index.php(131): Kohana_Request->execute()
#9 {main}
...
#2 D:\web\v5\plugins\distributor_car\application\classes\controller\index.php(148): Functions::get_last_aid('sline_car', NULL)
#3 [internal function]: Controller_Index->action_ajax_save()
#4 D:\web\v5\core\system\classes\kohana\request\client\internal.php(116): ReflectionMethod->invoke(Object(Controller_Index))
#5 D:\web\v5\core\system\classes\kohana\request\client.php(64): Kohana_Request_Client_Internal->execute_request(Object(Request))
#6 D:\web\v5\core\system\classes\kohana\request.php(1160): Kohana_Request_Client->execute(Object(Request))
#7 D:\web\v5\plugins\distributor_car\index.php(131): Kohana_Request->execute()
#8 {main}
...
--
#0 D:\web\v5\core\modules\database\classes\kohana\database\query.php(251): Kohana_Database_MySQL->query(1, 'SELECT MIN(pric...', false, Array)
#1 D:\web\v5\plugins\distributor_car\application\classes\model\car.php(24): Kohana_Database_Query->execute()
#2 D:\web\v5\plugins\distributor_car\application\classes\controller\index.php(441): Model_Car::update_min_price('86')
#3 D:\web\v5\plugins\distributor_car\application\classes\controller\index.php(286): Controller_Index->save_baojia('86', '17', Array)
