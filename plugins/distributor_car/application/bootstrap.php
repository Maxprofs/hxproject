 ...
 */
//缓存目录,日志目录指定
$cache_dir = CACHE_DIR.'distributor/distributor_car';
$logs_dir = LOGS_DIR.'distributor/distributor_car';
...
Kohana::init(array(
    'base_url' => '/plugins/distributor_car/',
    'index_file' => '',
    'cache_dir' => $cache_dir,
...
$cfg_res_url = "/plugins/distributor_car/public";
