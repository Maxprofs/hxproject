    ...
    <div class="main">
        <div class="content-box">
            ...
            <div class="user-msg-box">
                ...
                <div class="user-msg">
                    <div class="yz">
                        <strong class="name"><?php if($userinfo['distributorname']) { ?><?php echo $userinfo['distributorname'];?><?php } else { ?>供应商<?php } ?>
</strong>
...
"><?php if($v['isconsume']==1 ) { ?>已消费<?php } else { ?>未消费<?php } ?>
                                    ...
                                    <td>
                                        <a class="show" href="/plugins/distributor_check/pc/checkorder/show_order?id=<?php echo $v['id'];?>">查看订单</a>
                                    </td>
                                </tr>
                                <?php $n++;}unset($n); } ?>
                            </table>
