                    ...
                    <div class="account-con">
                        <ul>
                            ...
                            <li><strong class="lm">公司名称：</strong>
                                <div class="nr"><span class="name"><?php echo $userinfo['distributorname'];?></span><a class="revise-mz" href="<?php echo $cmsurl;?>pc/qualify/index">修改公司名称</a></div>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <div class="nr">
                                    <div class="dx">
                                        <label><span class="name"><?php echo $userinfo['distributorkind'];?></span></label>
                                    </div>
                                </div>
                            </li>
                            <li>
                        ...
                        <div class="account-headimg-box">
                            ...
                            <input type="hidden" id="distributorid" name="distributorid" value="<?php echo $userinfo['id'];?>">
...
<script>
    $(function(){
        ...
        $("#city").citySelect({
            url:"/plugins/distributor/public/default/pc/js/city/city.min.js",
            nodata:"none",
