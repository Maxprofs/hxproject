...
class Common extends Functions
{
    ...
    * */
     ...
     * @return mixed
     */
    static function get_distributor($table, $productAid)
    {
        $sql = "select s.* from sline_{$table} as t,sline_distributor as s where t.aid={$productAid} and t.distributorlist=s.id";
