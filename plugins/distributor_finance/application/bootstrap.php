 ...
 */
//缓存目录,日志目录指定
$cache_dir = CACHE_DIR.'distributor/distributor_finance';
$logs_dir = LOGS_DIR.'distributor/distributor_finance';
...
Kohana::init(array(
    'base_url' => '/plugins/distributor_finance/',
    'index_file' => '',
    'cache_dir' => $cache_dir,
...
$cfg_cmspath = '/distributor_finance';
...
//用于模板上资源调用
$cfg_res_url = '/plugins/distributor_finance/public'.$cfg_default_templet.$cfg_client_device;
