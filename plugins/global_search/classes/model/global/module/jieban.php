...
class Model_Global_Module_Jieban extends ORM
{
    ...
    public static function search_list($params,$p,$pagesize,$where,$model)
    {
        ...
        $sql = "select a.*,(LENGTH(a.title)-LENGTH(REPLACE(a.title,'{$params['keyword']}',''))) as order_by from sline_jieban as a LEFT JOIN `sline_allorderlist` b ON (a.id=b.aid and b.typeid={$params['typeid']}) WHERE $where
        ORDER BY order_by desc,IFNULL(b.displayorder,9999) ASC,a.addtime DESC limit $offset,$pagesize";
