                ...
                <li class="clearfix">
                    <div class="hd">
                        <a href="{$a['url']}" class="pic">
                            <img src="{Product::get_lazy_img()}"  st-src="{Common::img($a['litpic'],200,136)}" alt="{$a['title']}" title="{$a['title']}"  width="200" height="136">
                        </a>
                    </div>
                    <div class="info">
                        ...
                        <div class="label">
                            <span class="item">{Common::mydate('Y-m-d',$a['addtime'])}发布</span>
                        </div>
                    </div>
                    <div class="sum">
                        <i class="icon"></i>
