...
<head>
    <meta charset="utf-8">
    <title background_color=5Elzhm >搜索{$params['keyword']}产品列表-{$webname}</title>
...
<body>
    ...
    <div class="st-search">
        <div class="st-search-box">
            <input type="text" class="st-search-text" id="keyword" placeholder="{Model_Global_Search::get_hot_search_default()}" value="{$params['keyword']}">
