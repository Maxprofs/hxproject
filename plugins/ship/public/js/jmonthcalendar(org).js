...
(function ($) {
    ...
    jQuery.J.DrawCalendar = function (dateIn) {
        ...
        monthNavHead.append(jQuery('<div class="MonthName"></div>').append(d.getFullYear() + "年" + "<br />" + defaults.locale.months[d.getMonth()] + "月"));
        ...
        do {
            ...
            for (var i = 0; i < 7; i++) {
                ...
                var atts = {
                    'class': "DateBox" + (weekday == 0 || weekday == 6 ? '' : ''),
            ...
            jQuery.each(calendarEvents, function () {
                ...
                if (sDt) {
                    if ((sDt >= _beginDate) && (sDt <= _endDate)) {
                        ...
                        var prices = jQuery('<span class="more">'+ '更多' +'</span><span class="price">' + '<em>' + '&yen;' + '<b>' + ev.Price + '</b>' + '</em>' + '起' + '</span>');

                        var dataPrice = jQuery('<div class="Event" id="Event_' + ev.EventID + '"></div>').append(prices);
                       cell.append(dataPrice);
