 ...
 * 线路目的地控制器
 */
class Controller_Admin_Dest extends Stourweb_Controller
{
    ...
    public function action_destination()
    {
        ...
        if(empty($action))
        {
            ...
            $this->display('admin/destination/destination');
        }
        else if($action == 'read')
        {
    ...
    */
    public function action_ajax_getNextDestList()
    {
        ...
        if($keyword) $sql = "select id,kindname,pinyin from sline_destinations where kindname like '%{$keyword}%' order by pinyin asc";
        else
    ...
    */
    public function action_ajax_getDestsetList()
    {
        ...
        if($keyword) $sql = "select id,kindname,pinyin from sline_destinations where kindname like '%{$keyword}%' and isopen=1  order by pinyin asc";
        else
    ...
    public function action_dialog_productinfo()
    {
        ...
        $this->display('admin/destination/dialog_productinfo');
