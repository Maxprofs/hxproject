                ...
                <div class="product-add-div">
                	<ul class="info-item-block">
                		<li>
                			...
                			<div class="item-bd">
                				<input type="text" name="title" id="title" class="input-text w200"  value="{$info['title']}" />
                			</div>
                		</li>
                		<li>
                			...
                			<div class="item-bd">
                                ...
                                <table id="time_list" class="w500">
                                     {loop $timelist $time}
                                     <tr id="item_{$time['id']}" class="lh-50">
                                         <td width="40%"><input type="text" name="starttime[{$time['id']}]"  class="start_time input-text" value="{date('Y-m-d',$time['starttime'])}" /></td>
                                         <td width="10%" class="text-c">--</td>
                                         <td width="40%"><input type="text" name="endtime[{$time['id']}]"  class="end_time input-text"  value="{date('Y-m-d',$time['endtime'])}" /></td>
                                         <td width="10%" class="text-c"><a href="javascript:;" class="btn-link" onclick="delTime({$time['id']})">删除</a> </td>
                                     </tr>
                                     {/loop}
                                 </table>
                			</div>
