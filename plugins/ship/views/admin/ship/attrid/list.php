...
<head>
    <meta charset="utf-8">
    <title background_script=DmACXC >笛卡CMS{$coreVersion}</title>
    ...
    <tr>
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
			...
			<div class="cfg-header-bar">
				{template 'admin/ship/attrid/kind_top'}
    ...
    function () {
        ...
        window.attr_store = Ext.create('Ext.data.TreeStore', {
            ...
            proxy: {
                ...
                api: {
                    read: SITEURL+'ship/admin/attrid/list/action/read/typeid/{$typeid}',  //读取数据的URL
                    update:  SITEURL+'ship/admin/attrid/list/action/save/typeid/{$typeid}',
                    destroy:  SITEURL+'ship/admin/attrid/list/action/delete/typeid/{$typeid}'
                },
                reader: 'json'
            },
            autoLoad: true,
            ...
            viewConfig: {
                ...
                listeners: {
                    ...
                    drop: function (node, data, overModel, dropPosition, eOpts) {
                        ...
                        Ext.Ajax.request({
                            url: SITEURL+'ship/admin/attrid/list/action/drag/typeid/{$typeid}',
                            params: params,
                            method: 'POST',
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer : function(value, metadata,record) {
                        ...
                        return '<a href="javascript:;" title="配置" class="btn-link" onclick="attrSet('+id+','+{$typeid}+')">配置</a>'+front_view;
                    }
                }
            ],
            plugins: [
...
function addSub(pid) {
    ...
    Ext.Ajax.request({
        method: 'post',
        url: SITEURL+'ship/admin/attrid/list/action/addsub/typeid/{$typeid}',
        params: {pid: pid},
        success: function (response) {
...
function updateField(ele,id,field,value,type,callback)
{
    ...
    Ext.Ajax.request({
        url   :  SITEURL+"ship/admin/attrid/list/action/update/typeid/{$typeid}",
        method  :  "POST",
        datatype  :  "JSON",
