                  ...
                  <div class="product-add-div">
                  	<ul class="info-item-block">
                  		...
                  		<li>
                  			...
                  			<div class="item-bd">
                  				<input type="text" name="area" id="area" class="input-text w70" value="{$info['area']}" /> m&sup2;
                  			</div>
                  		</li>
                  		<li>
                  			<span class="item-hd">房型数量：</span>
                  			<div class="item-bd">
                  				<input type="text" name="num" id="area" class="input-text w70" value="{$info['num']}" />
                  			</div>
                  		</li>
                  		<li>
                  			<span class="item-hd">可住人数：</span>
                  			<div class="item-bd">
                  				<input type="text" name="peoplenum" id="peoplenum" class="input-text w70" value="{$info['peoplenum']}" />
                  			</div>
                  		</li>
                  		<li>
                  			...
                  			<div class="item-bd">
                  				<label class="radio-label mr-20">
                  					<input type="radio" value="0" {if $info['iswindow']==0}checked="checked"{/if} name="iswindow"/>无窗
                  				</label>
                  				<label class="radio-label mr-20">
                  					<input type="radio" value="1" name="iswindow" {if $info['iswindow']==1}checked="checked"{/if}/>有窗
                  				</label>	
					...
					<div class="fl clearfix pb-20">
	                	<input type="hidden" name="shipid" id="shipid" value="{$shipid}"/>
                      	<input type="hidden" name="id" id="roomid"  value="{$info['id']}"/>
