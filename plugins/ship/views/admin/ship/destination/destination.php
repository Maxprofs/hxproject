...
<table class="content-tab" body_script=EmACXC >
    <tr>
...
<script>
   ...
   // var otherModule={php echo json_encode($allmodule);};
        ...
        function () {
            ...
            window.dest_store = Ext.create('Ext.data.TreeStore', {
                ...
                proxy: {
                    type: 'ajax',
                    api: {
                        read: SITEURL+'ship/admin/destination/destination/action/read',  //读取数据的URL
                        update: SITEURL+'ship/admin/destination/destination/action/save',
                        destroy: SITEURL+'ship/admin/destination/destination/action/delete'
                    },
                    reader: 'json'
                },
                autoLoad: true,
    ...
    function togStatus(obj, record, field) {
        ...
        Ext.Ajax.request({
            url: SITEURL+"ship/admin/destination/destination/action/update",
            method: "POST",
            datatype: "JSON",
    ...
    function destProductSet(dest_id) {
        ...
        ST.Util.showBox('设置',SITEURL+'ship/admin/destination/dialog_productinfo?id='+id+"&typeid="+display_mode,600,500,null,null,document,{loadCallback:setProductInfo,loadWindow:window});
    ...
    function searchDest() {
        ...
        if (!s_str)
            return;
        Ext.Ajax.request({
            url: SITEURL+'ship/admin/destination/destination/action/search',
