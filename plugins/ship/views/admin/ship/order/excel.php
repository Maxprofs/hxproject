...
<head>
    <meta charset="utf-8">
    <title clear_background=R68Vrl ></title>
...
<script>
    ...
    $(function(){
       $(".btn_excel").click(function(){
           ...
           var url = SITEURL+'ship/admin/order/genexcel/typeid/'+typeid+'/timetype/'+timetype+'?starttime='+starttime+'&endtime='+endtime+'&status='+status;
