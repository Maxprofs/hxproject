...
<body>
                ...
                <div class="product-add-div">
                  	...
                  	<ul class="info-item-block">
                  		...
                  		<li>
                  			...
                  			<div class="item-bd">
                  				<input type="text" name="weight" id="weight" class="input-text w70" value="{$info['weight']}" />
                  		...
                  		<li>
                  			...
                  			<div class="item-bd">
                  				<input type="text" name="seatnum" id="seatnum" class="input-text w70" value="{$info['seatnum']}"/>
                  		...
                  		<li>
                  			...
                  			<div class="item-bd">
                  				<input type="text" name="length" id="length" class="input-text w70" value="{$info['length']}" />
                  		...
                  		<li>
                  			...
                  			<div class="item-bd">
                  				<input type="text" name="width" id="width" class="input-text w70" value="{$info['width']}" />
                  				<span class="item-text ml-5">米</span>
                  			</div>
                  		</li>
                  		<li>
                  			...
                  			<div class="item-bd">
                  				<input type="text" name="floornum" id="floornum" class="input-text w70" value="{$info['floornum']}" />
                  		...
                  		<li>
                  			...
                  			<div class="item-bd">
                  				<input type="text" name="speed" id="speed" class="input-text w70" value="{$info['speed']}" />
                  		...
                  		<li>
                  			...
                  			<div class="item-bd">
                  				<input type="text" name="sailtime" id="sailtime" class="input-text w70" value="{$info['sailtime']}" />
    ...
    <script>
        Ext.onReady(
            function () {
                ...
                $("#schedule_add").click(function(){
                    var productid=$("#productid").val();
                    ST.Util.addTab('添加邮轮航次','{$cmsurl}ship/admin/ship/scheduleadd/shipid/'+productid+'/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/ship_linekind/itemid/{$itemid}',0);
                });
                //产品store
        ...
        {
            var url = SITEURL+'ship/admin/ship/scheduleedit/id/'+id+'/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/ship_linekind/itemid/{$itemid}';
...
<script>
    Ext.onReady(
        function () {
            ...
            $("#floor_add").click(function(){
                var productid=$("#productid").val();
                ST.Util.addTab('添加游轮楼层','{$cmsurl}ship/admin/ship/flooradd/shipid/'+productid+'/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/ship_linekind/itemid/{$itemid}',0);
            });
            //产品store
    ...
    {
        var url = SITEURL+'ship/admin/ship/flooredit/id/'+id+'/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/ship_linekind/itemid/{$itemid}';
...
<script>
    Ext.onReady(
        function () {
            ...
            $("#room_add").click(function(){
                var productid=$("#productid").val();
                ST.Util.addTab('添加游轮房型','{$cmsurl}ship/admin/ship/roomadd/shipid/'+productid+'/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/ship_linekind/itemid/{$itemid}',0);
            });
            //产品store
    ...
    {
        var url = SITEURL+'ship/admin/ship/roomedit/id/'+id+'/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/ship_linekind/itemid/{$itemid}';
...
<script>
    Ext.onReady(
        function () {
            ...
            $("#facility_add").click(function(){
                var productid=$("#productid").val();
                ST.Util.addTab('添加游轮设施','{$cmsurl}ship/admin/ship/facilityadd/shipid/'+productid+'/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/ship_linekind/itemid/{$itemid}',0);
            });
            //产品store
    ...
    {
        var url = SITEURL+'ship/admin/ship/facilityedit/id/'+id+'/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/ship_linekind/itemid/{$itemid}';
