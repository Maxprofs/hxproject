...
<div class="ship-show-block" id="comment_target">
    <div class="column-tit">客户点评</div>
    <div class="column-block">
        <div class="st-list-pl">
            <div class="st-pl-box">
                ...
                <span class="txt">回程归来发表点评即可获赠积分，积分根据线路而定，<br />获得的积分可在下次消费时抵用部分现金。</span>
                ...
                <div class="comment-con clearfix">
                    ...
                    <dl>
                        <dt>
                            ...
                            <em class="level">{Common::member_rank($c['memberid'],array('return'=>'current'))}</em>
                        </dt>
                        <dd>
                            <div class="zs">
