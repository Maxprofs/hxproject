        ...
        <div class="order-info-container">
            ...
            <div class="order-info-block">
                ...
                <table class="user-info-table mt-5">
                    ...
                    {loop $sublist $sub}
                    <tr>
                        <td><span class="cor_666">{$sub['title']}</span></td>
                        <td><span class="cor_666">{Currency_Tool::symbol()}
                                {if in_array($info['status'],array(0,1))}
                                <input type="text" class="set-text-xh wid_80 mt-4" name="price[{$sub['id']}]"  style="float: none;" value="{$sub['price']}" />
                                {else}
                                   {$sub['price']}
                                {/if}
                            </span>
                        ...
                        <td><span class="color_f60 adult_price_total_txt">{Currency_Tool::symbol()}{php echo $sub['dingnum']*$sub['price'];}</span></td>
                        <td>&nbsp;</td>
                    </tr>
                    {/loop}
                </table>
            ...
            <div class="order-info-block">
                <ul>
                    ...
                    <li>
                        ...
                        <div class="item-bd">
                            <span class="order-num">{$info['paytype_name']}  &nbsp;{if $info['paytype']==2}({$info['dingjin']}/间){/if}</span>
                        </div>
                    </li>
