...
<head>
    ...
    {Common::css('base.css')}
    {Common::css_plugin('refund.css','ship')}
...
<script type="text/javascript">
    ...
    function refund_status(data) {
        $.post('{$cmsurl}ship/member/ajax_order_refund', data, function (result) {
            parent.layer.open({
                content: result.message,
                btn: ['{__("OK")}'],
                end:function(){
                    window.location = '{$cmsurl}ship/member/orderview?ordersn={$info['ordersn']}';
                }
            });
        }, 'json');
    }
