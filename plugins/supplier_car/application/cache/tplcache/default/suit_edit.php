                        ...
                        <dd>
                            <select name="suittypeid" id="suittypeid_choose">
                                ...
                                <?php $n=1; if(is_array($suittypes)) { foreach($suittypes as $k => $v) { ?>
                                    <option value="<?php echo $v['id'];?>" <?php if($info['suittypeid']==$v['id']) { ?>selected="selected"<?php } ?>
><?php echo $v['kindname'];?></option>
                    ...
                    <dl>
                        <dt>套餐说明：</dt>
                        <dd>
                            <?php echo Common::get_editor('content',$info['content'],700,150,'Line');?>
                        </dd>
                    </dl>
                    <dl>
                        <dt>单位：</dt>
                        <dd>
                            <input type="text" name="unit"  id="roomnum" class="set-text-xh text_100 mt-2" value="<?php echo $info['unit'];?>" />
                        </dd>
                    </dl>
                </div>
                <div class="add-class">
                                ...
                                <div class="price_sub">
                                    <div>
                                        <table class="price_tb">
                                            <tr>
                                                <td class="tit">日期范围：</td><td><input type="text" name="starttime" class="set-text-xh text_100 choosetime" value="<?php echo $info['lastoffer']['starttime'];?>"/> <span class="fl">&nbsp;~&nbsp;</span> <input type="text" class="set-text-xh text_100 choosetime" name="endtime" value="<?php echo $info['lastoffer']['endtime'];?>"/></td>
                                            </tr>
                                            <tr>
...
<div class="opn-btn" style="padding-left: 10px; " id="hidevalue">
    ...
    <a class="normal-btn"  href="javascript:;" id="btn_view_more" style="<?php if($action=='add') { ?>display:none<?php } ?>
"  onclick="showMore()">查看报价</a>
</div>
</div>
</form>
</div>
