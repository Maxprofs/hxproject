            ...
            <div class="pm-tab-box">
              ...
              <div class="pm-tabcon-list">
                  ...
                  <tr class="pl-th">
                    ...
                    <th width="22%" scope="col">车辆名称</th>
                    <th width="14%" scope="col">报价有效期</th>
                    <th width="14%" scope="col">套餐类型</th>
                ...
                <table class="pm-table-list" width="100%" border="0">
                 {loop $list $row}
                  <tr class="pl-tr">
                    ...
                    <td width="22%"><div class="pm-table-boxs"><a class="pm-table-bt" href="{$row['url']}" target="_blank">{$row['title']}</a></div></td>
                    <td width="14%" align="center"><div class="pm-table-boxs"><span class="color-grey">{$row['expired_date']}</span></div></td>
                    <td width="14%" align="center"><div class="pm-table-boxs">&nbsp;</div></td>
                    <td width="14%" align="center"><div class="pm-table-boxs">&nbsp;</div></td>
                    <td width="14%" align="center"><div class="pm-table-boxs">&nbsp;</div></td>
                   ...
                   {loop $row['suit'] $suit}
                     <tr class="pl-tr pl-child-tr">
                        ...
                        <td width="22%"><div class="pm-table-boxs"><a class="pm-table-bt" href="#">{$suit['suitname']}</a></div></td>
                        <td width="14%" align="center"><div class="pm-table-boxs"><span class="color-grey">{$suit['expired_date']}</span></div></td>
                        <td width="14%" align="center"><div class="pm-table-boxs"><span class="color-grey">{$suit['suit_type']}</span></div></td>
                        <td width="14%" align="center"><div class="pm-table-boxs"><span class="color-grey">{$suit['min_price']}</span></div></td>
                        <td width="14%" align="center"><div class="pm-table-boxs"><span class="color-grey">{$suit['min_profit']}</span></div></td>
                        <td width="8%" align="center">
                          <div class="pm-table-boxs">
