...
<script>
  ...
  Ext.onReady(
    function() 
    {
        ...
        $("#addbtn").click(function(){
            ...
            ST.Util.addTab('赠送优惠券','{$cmsurl}coupon/admin/coupon/member_give/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}{/if}?action=add');
        });
 ...
 //删除
   ...
   function togStatus(ele)
   {
	...
	{
		var url=SITEURL+"coupon/admin/coupon/view/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}id/"+id;
