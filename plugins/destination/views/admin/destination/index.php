...
<body style="overflow:hidden" right_ul=MIACXC >
            ...
            <td valign="top" class="content-rt-td" style="overflow:hidden">
                ...
                <div class="cfg-search-bar">
                    <div class="cfg-header-search">
                        <input type="text" id="searchkey" value="目的地名称" datadef="目的地名称" class="search-text">
                        <a href="javascript:;" title="搜索" class="search-btn" onclick="searchDest()">搜索</a>
                    </div>
                    <span class="cfg-search-tab display-mod fr">
                       <a class="item on" href="javascript:void(0);" title="列表" class="on" onClick="togMod(this,1)">列表</a>
                       <a class="item" href="javascript:void(0);" title="高级" onClick="togMod(this,2)">高级</a>
                     </span>
                </div>
                        ...
                        tpl: new Ext.XTemplate(
                            '{[this.realName(values.id)]}',
                            {
                                realName: function (id) {
                                    var viewHtml = (window.display_mode ==1?'<a href="javascript:;" class="btn-link" title="优化设置" onclick="destProductSet(\'' + id + '\')">设置</a>':'')+'&nbsp;&nbsp;&nbsp;<a href="javascript:;" class="btn-link" title="预览" onclick="viewDestType(\'' + id + '\')">预览</a>';
                                    return viewHtml;
                                }
                            }
                        )
