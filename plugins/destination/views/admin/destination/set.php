...
<table class="content-tab" script_table=HIACXC >
    <tr>
            ...
            <div class="manage-nr">
                <div class="cfg-header-bar">
                    <div class="cfg-header-tab">
                        <span  data-rel="jieshao" class="item on">页面介绍{Common::get_help_icon('destination_basicinfo_jieshao',true)}</span>
                        <span data-rel="picture" class="item">图片管理{Common::get_help_icon('destination_basicinfo_images',true)}</span>
                        <span data-rel="seo" class="item">优化信息{Common::get_help_icon('destination_basicinfo_seo',true)}</span>
                        <span data-rel="template" class="item">模板设置{Common::get_help_icon('templates_name',true)}</span>  
                    </div>
                    ...
                    <div id="item_template" class="product-add-div item-one" style="display: none">
                        <ul class="info-item-block">
                            <li>
                                ...
                                <div class="item-bd">
                                    <a href="javascript:;" data-rel="" class="label-module-item mr-5 {if empty($info['templet'])}label-module-cur-item{/if}">标准</a>
                                    {loop $templetlist $tpl}
                                    <a href="javascript:;" data-rel="{$tpl['path']}" class="label-module-item mr-5 {if $info['templet']==$tpl['path']}label-module-cur-item{/if}">{$tpl['templetname']}</a>
                                    {/loop}
