      ...
      <div class="st-guide">
    	...
    	<div class="st-main-page">
		  ...
		  <div class="dest-sum-box">
            ...
            {st:destination action="query" flag="same" pid="$info['pid']" currentid="$info['id']" row="100" return="samedest"}
            {if !empty($samedest)}
        ...
        <div class="st-dest-cplist">
        	<div class="st-tabnav">
                ...
                {st:car action="query" flag="recommend" destid="$info['id']"  row="8" return="carlist"}
                {if $carlist}
                ...
                {if ST_Functions::is_system_app_install(114)}
                {st:outdoor action="query" flag="mdd" destid="$info['id']" row="8"  return="list"}
                {if $list}
                <span data-url="{$GLOBALS['cfg_basehost']}/outdoor/{$info['pinyin']}/">{$channel['outdoor']['channelname']}</span>
                {/if}
                {/if}
            ...
            {/if}
            {if ST_Functions::is_system_app_install(114)}
            {st:outdoor action="query" flag="mdd" destid="$info['id']" row="8" return="outdoor_list"}
            {if $outdoor_list}
            <div class="st-tabcon">
                <ul class="st-cp-list">
