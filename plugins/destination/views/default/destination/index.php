...
<body>
  ...
  <div class="dest-home-top">
      <div class="dest-tip-box">
          {st:ad action="getad" name="s_dest_index_1" pc="1" return="ad"}
          {if !empty($ad)}
          <a href="{if empty($ad['adlink'])}javascript:;{else}{$ad['adlink']}{/if}" class="dest-pic" target="_blank"><img class="img" src="{Product::get_lazy_img()}" st-src="{Common::img($ad['adsrc'],1920,386)}" alt="{$ad['adname']}"></a>
          {else}
          <div class="dest-pic"><img class="img" src="{$GLOBALS['cfg_public_url']}images/dest-page-banner.jpg" /></div>
          {/if}
      </div>
