...
<table class="content-tab">
    <tr>
       ...
       <form method="post" id="frm" name="frm" head_script=0GACXC >
            ...
            <div class="order-info-block">
                ...
                <table class="user-info-table mt-5">
                    ...
                    <tr id="group_adult">
                        ...
                        <td><span class="cor_666 adult_price_single_txt">{Currency_Tool::symbol()}
                    ...
                    <tr id="group_child">
                        ...
                        <td><span class="cor_666 child_price_single_txt">{Currency_Tool::symbol()}
                                {if in_array($info['status'],array(0,1))}
                                  <input type="text" class="set-text-xh wid_40 mt-4" name="childprice" id="childprice" style="float: none;" value="{$info['childprice']}" >
                                {else}
                                   {$info['childprice']}
                                {/if}
                            </span></td>
                        <td><span class="color_f60 child_price_total_txt">{Currency_Tool::symbol()}{php echo $info['childnum']*$info['childprice'];}</span></td>
                        <td>&nbsp;</td>
                    </tr>
                    {/if}
                    {if $info['oldnum']}
                    <tr id="group_old">
                        ...
                        <td><span class="cor_666 old_price_single_txt">{Currency_Tool::symbol()}
                                  {if in_array($info['status'],array(0,1))}
                                <input type="text" class="set-text-xh wid_40 mt-4" name="oldprice" id="oldprice" style="float: none;" value="{$info['oldprice']}" >
                                 {else}
                                   {$info['oldprice']}
                                {/if}
                            </span></td>
                        <td><span class="color_f60 old_price_total_txt">{Currency_Tool::symbol()}{php echo $info['oldnum']*$info['oldprice'];}</span></td>
                        <td>&nbsp;</td>
                    </tr>
                    {/if}
                    ...
                    <tr id="group_room">
                        ...
                        <td><span class="cor_666 room_balance_single_txt">{Currency_Tool::symbol()}
                                {php echo $info['roombalance']/$info['roombalancenum'];}</span></td>
                        <td><span class="color_f60 room_balance_total_txt">{Currency_Tool::symbol()}{$info['roombalance']}</span></td>
                        <td>&nbsp;</td>
                    </tr>
                    {/if}
                    ...
                    <tr id="group_room">
                        <td>
                            <span class="type wid_40">保险</span>
                            <span class="type">
                               {$new_insurs['dingnum']}
                            </span>
                        ...
                        <td><span class="cor_666 room_balance_single_txt">{Currency_Tool::symbol()}
                                {$new_insurs['price']}</span></td>
                        <td><span class="color_f60 room_balance_total_txt">{Currency_Tool::symbol()}{php echo $new_insurs['dingnum']*$new_insurs['price'];}</span></td>
                        <td>&nbsp;</td>
                    </tr>
                    {/if}
                    </tbody>
            ...
            <div class="order-info-block">
                <ul>
                    <li>
                        ...
                        <div class="item-bd">
                            <span class="order-num">{$info['paytype_name']}  &nbsp;{if $info['paytype']==2}({$info['dingjin']}/人){/if}</span>
                        </div>
                    </li>
