...
class Controller_Admin_Line_Attrid extends Stourweb_Controller
{
    ...
    public function action_list()
    {
        ...
        $this->assign('chooseid','attr_attr');//顶部选中
        if (empty($action))
        {
    ...
    public function action_extendlist()
    {
        ...
        else if ($action == 'delete')
        {
            ...
            if (is_numeric($id))
            {
                ...
                //清理line_content扩展字段
                DB::delete('line_content')->where('columnname','=',$fieldname)->execute();
            }
        }
