  ...
  <div class="print-mid-content">
    ...
    <div class="print-nrBox">
        <div class="product-code">
            <img class="img" src="/res/vendor/qrcode/make.php?param={$GLOBALS['cfg_basehost']}/lines/show_{$info['aid']}.html">
                ...
                {loop Model_Line_Jieshao::detail($line['content'],$info['lineday']) $v}
                    <div class="day-con">
                        ...
                        <dl class="day-attr">
                            ...
                            <dd>
                                {if $v['breakfirsthas'] }
                                  <span>早餐：{if !empty($v['breakfirst'])}{$v[breakfirst]}{else}含{/if}</span>
                                {else}
                                  <span>早餐：不含</span>
                                {/if}
                                {if $v['lunchhas']}
                                    <span>午餐：{if !empty($v['lunch'])}{$v[lunch]}{else}含{/if}</span>
                                {else}
                                    <span>午餐：不含</span>
                                {/if}
                                {if $v['supperhas']}
                                    <span>晚餐：{if !empty($v['supper'])}{$v['supper']}{else}含{/if}</span>
                                {else}
                                    <span>晚餐:不含</span>
                                {/if}
                               </dd>
