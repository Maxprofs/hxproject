...
<div class="order-refund-box order-box" style="display: none">
    <ul class="info-item-block">
        ...
        <li>
            ...
            <div class="item-bd">
                <span class="item-text c-f60">{Currency_Tool::symbol()}{$info['pay_price']}</span>
            </div>
        </li>
        <li class="offline_content" {if $info['online_transaction_no'] != ''}style="display:none;"{/if}>
        ...
        <li class="offline_content" {if $info['online_transaction_no'] != ''}style="display:none;"{/if}>
            <span class="item-hd">退款凭证{Common::get_help_icon('refund_proof')}：</span>
            <div class="item-bd">
                <div class="">
