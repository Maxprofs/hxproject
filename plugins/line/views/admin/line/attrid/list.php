            ...
            columns: [
                {
                    ...
                    renderer : function(value, metadata,record) {
                        ...
                        if(id.indexOf('add')==-1)
                            return "<input type='checkbox' "+disabled+" class='attr_check' value='" + id + "' style='cursor:pointer'/>";
                    }
                ...
                },
                {
                    ...
                    text: '<span class="grid_column_text">属性</span>'+ST.Util.getGridHelp('attr_list'),
                    dataIndex: 'attrname',
                    id: 'attr_name',
                    sortable:false,
                    locked: false,
                ...
                },
                {
                    ...
                    sortable:false,
                    renderer : function(value, metadata,record) {
                        value = value.substr(value.indexOf('_') + 1);
...
//                {
//                    text: '<span class="grid_column_text">显示个数</span>',
//                    dataIndex: 'shownum',
//                    width: '15%',
//                    xtype: 'actioncolumn',
//                    tdCls: 'attr-al-mid',
...
//                            return '';
//                        }
//                        return "<input type='text' value='"+value+"' class='row-edit-txt' onblur=\"updateField(this,'"+id+"','shownum',0,'input')\" onclick='ST.Util.prevPopup(event,this)'/>";
//                    }
//
//                },
            ],
...
function attrSet(id,typeid)
{
    ...
    ST.Util.showBox('属性配置',boxurl,'460','300',function(){ });
}
...
function front_view(id){
    id = Number(id)>0 ? id : 0;
    var url = BASEHOST+'/lines/'+'all-0-0-0-0-0-'+id+'-1';
    window.open(url);
}
</script>
</body>
