...
<head>
    ...
    {Common::js('jquery.min.js,lib-flexible.js,swiper.min.js')}
    {Common::css_plugin('line.css','line')}
</head>
<body>

{request "pub/header_new/typeid/$typeid/islistpage/1/definetitle/".urlencode($header_title)}
<!-- 公用顶部 -->
