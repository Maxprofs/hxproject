 ...
 */
//缓存目录,日志目录指定
$cache_dir = CACHE_DIR.'supplier/supplier_spot';
$logs_dir = LOGS_DIR.'supplier/supplier_spot';
...
Kohana::init(array(
    'base_url' => '/plugins/supplier_spot/',
    'index_file' => '',
    'cache_dir' => $cache_dir,
...
$cfg_res_url = "/plugins/supplier_spot/public";
