...
<table class="content-tab">
    <tr>
        ...
        <div class="order-info-container">
            ...
            <div class="order-info-block">
                <ul>
                  <li>
                    ...
                    <li>
                        ...
                        <div class="item-bd">
                            <span class="order-num">{$info['productname']}</span>
                    ...
                    <li>
                        <strong class="item-hd">返回日期：</strong>
                        <div class="item-bd">
                            <div class="order-num">
                                {$info['departdate']}
                            </div>
                ...
                <table class="user-info-table mt-5">
                    ...
                    <tr id="group_adult">
                        <td>
                            <span class="type">{$suit_info['suitname']}</span>
       ...
       {if !empty($info['usejifen'])|| !empty($info['cmoney'])}
       <div class="order-info-container">
...
<script>
    ...
    function refund_submit(type,description)
    {
        ...
        $.ajax({
            url : SITEURL+"campaign/admin/order/ajax_refund_submit",
            type:'post',
            dataType:'json',
    ...
    {
        $.ajaxform({
            url   :  SITEURL+"campaign/admin/order/ajax_save",
            method  :  "POST",
            form  : "#frm",
            dataType:'json',
            success  :  function(data)
