                ...
                <div class="pm-tabcon-list">
                    <table class="pm-table-hd" width="100%" border="0">
                        <tr class="pl-th">
                            ...
                            <th width="30%" scope="col">路线名称</th>
                            <th width="9%" scope="col">报价有效期</th>
                            <th width="8%" scope="col">预订积分</th>
                            <th width="7%" scope="col">评论积分</th>
                ...
                <div class="pm-tabcon-list" id="productList">
                    <table class="pm-table-list" width="100%" border="0">
                        ...
                        <tr class="pl-tr" id="product_<?php echo $row['id'];?>">
                            ...
                            <td width="30%"><div class="pm-table-boxs"><a class="pm-table-bt" href="<?php echo $row['url'];?>"><?php echo $row['title'];?></a></div></td>
                        ...
                        <tr class="pl-tr pl-child-tr sub_<?php echo $row['lineid'];?>" id="product_<?php echo $row['id'];?>">
                            <td width="8%" align="center"><div class="pm-table-boxs">&nbsp;</div></td>
                            <td width="30%"><div class="pm-table-boxs"><a class="pm-table-bt" href="#"><?php echo $row['title'];?></a></div></td>
                            <td width="10%" align="center"><div class="pm-table-boxs"><span class="color-grey"><?php echo $row['suitday'];?></span></div></td>
                            <td width="8%" align="center"><div class="pm-table-boxs"><input type="text" class="pm-jf-text" name="jifenbook" value="<?php echo $row['jifenbook'];?>" onblur="updateField(this,'jifenbook','<?php echo $row['id'];?>')" /></div></td>
                            <td width="8%" align="center"><div class="pm-table-boxs"><input type="text" class="pm-jf-text" name="jifencomment" value="<?php echo $row['jifencomment'];?>" onblur="updateField(this,'jifencomment','<?php echo $row['id'];?>')" /></div></td>
                            <td width="8%" align="center"><div class="pm-table-boxs"><input type="text" class="pm-jf-text" name="jifentprice" value="<?php echo $row['jifentprice'];?>" onblur="updateField(this,'jifentprice','<?php echo $row['id'];?>')" /></div></td>
                            <td width="8%" align="center"><div class="pm-table-boxs"><span class="color-grey"><?php echo $row['minprice'];?></span></div></td>
                            <td width="8%" align="center"><div class="pm-table-boxs"><span class="color-grey"><?php echo $row['minprofit'];?></span></div></td>
                            <td width="8%" align="center">
                                <div class="pm-table-boxs">
