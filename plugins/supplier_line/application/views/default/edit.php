...
<head ul_float=6cyt-j >
    <meta charset="utf-8">
    <title>线路管理</title>
    {Common::css('admin_base.css,admin_base2.css,admin_style.css,style.css,base_new.css')}
    {Common::js('jquery.min.js,jquery.colorpicker.js,common.js,choose.js,product.js,imageup.js,jquery.upload.js')}
...
{php Common::get_editor('jseditor','',700,300,'Sline','','print',true);}
    ...
    <div class="content-box">
            <div class="manage-nr">
                ...
                <form id="product_fm" method="post" action="{$cmsurl}index/ajax_linesave">
                <div id="content_basic" class="product-add-div content-show">
                    ...
                    <div class="add-class">
                        ...
                        <dl>
                            <dt>旅游天数：</dt>
                            <dd>
                                <input type="text" value="{$info['lineday']}"  id="travel_days" maxlength="2" class="set-text-xh text_60 mt-2 number_only" name="lineday"/>
                                <span class="fl ml-10">*天</span>
                                <input type="text" value="{$info['linenight']}" class="set-text-xh text_60 mt-2 ml-10 number_only" name="linenight"/>
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <input type="text" name="linebefore" value="{$info['linebefore']}" maxlength="2" class="set-text-xh text_60 mt-2 ml-10 number_only"/>
                    ...
                    <div class="add-class">
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <input type="text" name="recommendnum" maxlength="6" value="{$info['recommendnum']}"  class="set-text-xh text_60 mt-2 ml-10 mr-30 number_only" />
                                <span class="fl">满意度</span>
                                <input type="text" name="satisfyscore" maxlength="3" value="{if empty($info['satisfyscore'])}100{else}{$info['satisfyscore']}{/if}" data-regrex="number" data-msg="*必须为数字" class="set-text-xh text_60 mt-2 ml-10 mr-30"/>
                                <span class="fl">销量</span>
                                <input type="text" name="bookcount" maxlength="6" value="{$info['bookcount']}" class="set-text-xh text_60 mt-2 ml-10 number_only"/>
                            </dd>
                        </dl>
                    </div>
