...
//缓存目录,日志目录指定
$cache_dir = CACHE_DIR.'supplier/supplier_line';
$logs_dir = LOGS_DIR.'supplier/supplier_line';
...
Kohana::init(array(
    'base_url' => '/plugins/supplier_line/',
    'index_file' => '',
    'cache_dir' => $cache_dir,
...
if (file_exists($plugins_modules = BASEPATH . '/data/module.php')) {
    ...
    if (isset($supplier_plugins_modules['coupon'])) {
        $modules['coupon'] = BASEPATH . $supplier_plugins_modules['coupon'];
    }
    if (isset($supplier_plugins_modules['red_envelope'])) {
        $modules['red_envelope'] = BASEPATH . $supplier_plugins_modules['red_envelope'];
    }
}
