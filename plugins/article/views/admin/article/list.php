    ...
    <table class="content-tab">
        <tr>
            ...
            <div class="cfg-search-bar">
                ...
                <span class="cfg-select-box btnbox mt-3 ml-10" id="attrlist" data-url="box/index/type/attrlist/typeid/4" data-result="result_attrlist" >属性&nbsp;&gt;&nbsp;<span id="result_attrlist">全部</span><i class="arrow-icon"></i></span>
                <div class="cfg-header-search">
                    <input type="text" id="searchkey" placeholder="文章名称" datadef="文章名称" class="search-text">
