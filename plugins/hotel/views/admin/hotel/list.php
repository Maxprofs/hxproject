   ...
   <tr>
    ...
    <td valign="top" class="content-rt-td" style="overflow:hidden">
		<div class="cfg-header-bar">
           {loop $kindmenu $menu}
           <a href="javascript:;" class="fr btn btn-primary radius mt-6 mr-10" onclick="ST.Util.addTab('{$menu['name']}','{$menu['url']}',1);">{$menu['name']}</a>
           {/loop}
						 ...
						 if(id.indexOf('suit')!=-1)
						   {
                             ...
                             return '<a href="javascript:;"  class="btn-link" onclick="ST.Util.addTab(\'添加房型\',\'hotel/admin/hotel/room_op/menuid/{$_GET['menuid']}/parentkey/product/itemid/2/action/add/hotelid/'+id+'\')">添加房型</a>';
