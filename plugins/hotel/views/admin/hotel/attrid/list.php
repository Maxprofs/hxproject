...
<table class="content-tab" html_strong=QMQzDt >
    <tr>
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            ...
            <div id="line_grid_panel" class="content-nrt">
                ...
                <div class="st-bottom-console-bar clear clearfix">
                    <a class="btn btn-primary radius mr-10" href="javascript:;" onClick="chooseAll()">全选</a>
                    <a class="btn btn-primary radius mr-10" href="javascript:;" onClick="chooseDiff()">反选</a>
                    <a class="btn btn-primary radius mr-10" href="javascript:;" onClick="delattr()">删除</a>
                </div>
        </td>
    </tr>
</table>
                    ...
                    renderer : function(value, metadata,record) {
                        ...
                        if(value=='add')
                            ...
                            if(value==9999||value==999999||!value)
                                newvalue='';
                            return "<input type='text' value='"+newvalue+"' class='input-text' onblur=\"updateField(this,'"+id+"','displayorder',0,'input')\" onclick='ST.Util.prevPopup(event,this)'/>";
                        }
                    }
...
function front_view(id){
    id = Number(id)>0 ? id : 0;
    var url = BASEHOST+'/hotels/'+'all-0-0-0-0-'+id+'-1';
    window.open(url);
}
