        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            ...
            <div class="search-bar filter" id="search_bar">
                ...
                <div class="pro-search ml-10 mt-4 fl mt-4">
                    <input type="text" id="searchkey" value="订单号/产品名称/联系人/电子票号" datadef="订单号/产品名称/联系人/电子票号" class="sty-txt1 set-text-xh wid_300" />
...
$(function(){
    ...
    $(".btn_excel").click(function(){
        var url=SITEURL+"spot/admin/order/excel/typeid/"+typeid;
