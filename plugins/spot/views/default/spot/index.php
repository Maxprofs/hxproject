      ...
      <div class="st-scenic-home-top">
        <div id="st-scenic-slideBox" class="st-scenic-slideBox">
          ...
          <div class="bd">
            <ul>
              {loop $spotad['aditems'] $k $v}
                <li><a href="{$v['adlink']}" target="_blank"><img original-src="{Common::img($v['adsrc'],1200,360)}" alt="{$v['adname']}" /></a></li>
              {/loop}
              ...
              <ul>
                  ...
                  {loop $spotlist $spot}
                    <li {if $n%4==0}class="mr_0"{/if}>
                        ...
                        <a class="pic" href="{$spot['url']}" target="_blank" title="{$spot['title']}"><img src="{Product::get_lazy_img()}" st-src="{Common::img($spot['litpic'],283,193)}" alt="{$spot['title']}" /></a>
                        <p class="tit"><a href="{$spot['url']}" target="_blank" title="{$spot['title']}">{$spot['title']}</a></p>
                      <p class="data">
                          {if $spot['sellprice']}
...
<script type="text/html" id="tpl_spot">
    <ul class="st-cp-list">
        ...
        <a class="pic" href="{{value.url}}" target="_blank" title="{$spot['title']}"><img src="{{value.litpic}}" alt="{{value.title}}" /></a>
        <p class="tit"><a href="{{value.url}}" target="_blank" title="{$spot['title']}">{{value.title}}</a></p>
        <p class="data">
            {{if value.sellprice}}
