...
<head>
    <meta charset="utf-8">
    <title size_color=7ATBbm >{$search_title}</title>
    <meta name="apple-mobile-web-app-capable" content="yes" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    {Common::css('base.css,header.css,footer.css,swiper.min.css,reset-style.css')}
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $(".header_top a.back-link-icon").attr({'data-ajax':'false','href':'{$cmsurl}'}).removeAttr("onclick");
