                    ...
                    <div class="clear">
                        <ul class="info-item-block">
                            <li>
                                ...
                                <div class="item-bd">
                                    <div>
                                        <label class="radio-label"><input type="radio" name="isopen1" value="1" {if $order_msg1_open==1}checked="checked"{/if}/><label>开启</label></label>
                                        <label class="radio-label ml-20"><input type="radio" name="isopen1" value="0" {if $order_msg1_open==0}checked="checked"{/if}/><label>关闭</label></label>
                                    </div>
                            ...
                            <li>
                                ...
                                <div class="item-bd">
                                    <div>
                                        ...
                                        <label class="radio-label"><input type="radio" name="isopen2" value="0" {if $order_msg2_open==0}checked="checked"{/if}/>关闭</label>
                                    </div>
                            ...
                            <li>
                                ...
                                <div class="item-bd">
                                    <div>
                                        ...
                                        <label class="radio-label ml-20"><input type="radio" name="isopen4" value="0" {if $order_msg4_open==0}checked="checked"{/if}/>关闭</label>
                                    </div>
    ...
    <script>
       $(document).ready(function(){
           ...
           $("#btn_save").click(function(){
               $.ajax({
                   url:SITEURL+'spot/admin/spot/ajax_save_email_msg',
                   data: $('#frm').serialize(),
                   type: "POST",
                   dataType:'json',
