        ...
        <td valign="top" class="content-rt-td" style="overflow-y: hidden">
            ...
            <form method="post" id="frm" name="frm">
                <div class="order-show-container pd-10">
                    ...
                    <div class="order-show-wrap mb-10">
                        ...
                        <div class="order-show-block">
                            <ul class="info-item-block">
                                ...
                                <li>
                                    <span class="item-hd">门票类型：</span>
                                    <div class="item-bd">
                                        <span class="item-text">{$suit_info['tickettypeid_name']}</span>
                                    </div>
                                </li>
                    ...
                    <div class="order-show-wrap mb-10">
                        {include "admin/spot/order/status/status"}
...
<script>
    ...
    var pay_online = "{$info['pay_online']}";
    ...
    $(function(){
        ...
        $('#refund_allow').click(function () {
                ...
                var text = pay_online==1?'退款金额会原路退回，确定同意退款？':'确定同意退款？'
                ST.Util.confirmBox("退款提示", text, function () {
...
//        var inputvalue = obj.value.replace(/[^\d]/g,'');
    ...
    function refund_submit(type,description) {
        ...
        $.ajax({
            url : SITEURL+"spot/admin/order/ajax_refund_submit",
            type:'post',
            dataType:'json',
    ...
    function ajax_submit() {
        $.ajaxform({
            url   :  SITEURL+"spot/admin/order/ajax_save",
            method  :  "POST",
            form  : "#frm",
            dataType:'json',
            success  :  function(data)
