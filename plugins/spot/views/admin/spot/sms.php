                            ...
                            <li>
                                ...
                                <div class="item-bd">
                                    <div>
                                        ...
                                        <label class="radio-label"><input type="radio" name="isopen1" value="0" {if $order_msg1_open==0}checked="checked"{/if}/>关闭</label>
                                    </div>
                            ...
                            <li>
                                ...
                                <div class="item-bd">
                                    <div>
                                        ...
                                        <label class="radio-label"><input type="radio" name="isopen3" value="0" {if $order_msg3_open==0}checked="checked"{/if}/>关闭</label>
                                    </div>
    ...
    <script language="javascript">
        $(function(){
            ...
            $("#btn_save").click(function(){
                $.ajax({
                    url:SITEURL+'spot/admin/spot/ajax_save_sms_msg',
                    data: $('#frm').serialize(),
                    type: "POST",
                    dataType:'json',
