...
// 手机号码验证
jQuery.validator.addMethod("isMobile", function (value, element) { return this.optional(element) || /^1+\d{10}$/.test(value); }, "请正确填写您的手机号码！");
// 身份证号码验证
jQuery.validator.addMethod("isIDCard", function (value, element) { return this.optional(element) || checkCard(value); }, "身份证号码不正确！");
// 电话号码验证010-12345678
...
jQuery.validator.addMethod("isPhone", function (value, element) { var mobile = /^1+\d{10}$/; var tel = /^\d{3,4}-?\d{7,9}$/; return this.optional(element) || (tel.test(value) || mobile.test(value)); }, "请正确填写您的联系电话(手机/电话皆可)！");
// 邮政编码验证
