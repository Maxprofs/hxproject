...
ST.Util = {
    ...
    goClone: function (id, product) {
        ST.Util.confirmBox('克隆产品', '<div class="add-class"><span class="set-text-xh" style="border: none;padding-right: 5px;">克隆条数:</span><input type="text" id="cloneNum" class="set-text-xh text_60 mt-2 title-color" onkeyup="this.value=(function(val){var val=parseInt(val); return isNaN(val)|| val<0 ?0 :(val>20?20:val)})(this.value);"/><span style="line-height: 28px; color:#999; padding-left: 12px;"> *单次限20条</span></div>', function () {
